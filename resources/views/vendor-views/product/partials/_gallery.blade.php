    ...
    <div class="col-12">
        <div class="card mb-3">
                            ...
                            <div class="col-10">
                                <div class="table-responsive">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            <a target="_blank"
                                                href="{{ route('vendor.item.edit', ['id' => $item->id, 'product_gellary' => true]) }}"
                                        ...
                                        <thead>
                                            <tr>
                                                <th class="px-4 border-0">
                                                    <h4 class="m-0 text-capitalize">{{ translate('General_Information') }}
                                                    </h4>
                                                </th>
                                                <th class="px-4 border-0">
                                                    <h4 class="m-0 text-capitalize">{{ translate('Available_Variations') }}
                                                    </h4>
                                                </th>
                                                <th class="px-4 border-0">
            ...
            '...'
                                                ...
                                                <td class="px-4">
                                                    @if ($item->module->module_type == 'food')
                                                        @if ($item->food_variations && is_array($item->food_variations))
                                                            @foreach ($item->food_variations as $variation)
