    ...
    <div class="content container-fluid">
            ...
            <div class="mf-products mb-3">
                <div class="mf-welcome">
                    <div class="row align-items-center">
                        <div class="col-lg-7">
                            <h1>{{ translate('messages.items_bulk_import') }}</h1>
                            <p>{{ translate('Import items from Excel without breaking data rules') }}</p>
                            <div class="mf-chips">
                        ...
                        <div class="col-lg-5 mt-3 mt-lg-0">
                            <div class="mf-kpis">
                                <div class="mf-kpi">
                                    ...
                                    <div class="v">1</div>
                                    <div class="s">{{ translate('Download template') }}</div>
                                </div>
                                <div class="mf-kpi">
                                    <div class="t">{{ translate('Step') }}</div>
                                    <div class="v">2</div>
                                    <div class="s">{{ translate('Fill & validate') }}</div>
                                </div>
                                <div class="mf-kpi">
                                    <div class="t">{{ translate('Step') }}</div>
                                    <div class="v">3</div>
                                    <div class="s">{{ translate('Upload & import') }}</div>
                                </div>
                                <div class="mf-kpi">
                                    <div class="t">{{ translate('Mode') }}</div>
                                    <div class="v">{{ $store_data->module->module_type }}</div>
                                    <div class="s">{{ translate('Module type') }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="card {{ $productsRmsUi ? 'mf-products mf-card' : '' }}">
            <div class="card-body">
                ...
                <div class="jumbotron pt-1 mb-0 pb-4 bg-white {{ $productsRmsUi ? 'mf-products' : '' }}">
