                    ...
                    <div class="text-center">
                        ...
                        @if($campaign->store)
                            <div class="w-100 my-2">
                                <a href="{{route('admin.store.view', $campaign->store_id)}}"
                                ...
                                <tr>
                                    ...
                                    <td class="px-4">
                                        @if ($campaign->module->module_type == 'food')
                                            @if ($campaign->food_variations && is_array($campaign['food_variations']))
                                                @foreach ($campaign->food_variations as $variation)
                ...
                <tbody id="set-rows">
                    @foreach($orders as $key => $order)
                        ...
                        <tr class="status-{{$order['order_status']}} class-all">
                            ...
                            <td>
                                <label
                                    class="badge badge-soft-primary">{{Str::limit($order->order->store ? $order->order->store->name : translate('messages.store deleted!'), 20, '...')}}</label>
                            </td>
                            <td>
