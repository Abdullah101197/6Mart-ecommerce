            ...
            <form action="" method="get">
                <div class="card-body">
                    ...
                    <div class="row g-lg-3 g-2">
                        <div class="col-sm-6 col-md-3">
                            <div class="select-item">
                                <select name="store_id" id="store" data-url="{{route("admin.store.get-stores")}}"
                    ...
                    <div class="btn--container justify-content-end mt-xl-4 mt-3">
                        <button type="reset" data-url="{{ url()->current() }}"
                            class="btn btn--reset redirect-url">{{ translate('messages.reset') }}</button>
                    ...
                    <form class="search-form">
                        ...
                        <div class="input-group input--group">
                            <input id="datatableSearch" name="search" value="{{ request()?->search ?? null }}" type="search"
                                class="form-control h--40px" placeholder="{{translate('ex_:_search_item_by_name')}}"
                    ...
                    @if (Config::get('module.current_module_type') != 'food')
                        <div>
                            <a href="{{ route('admin.report.stock-report') }}"
                                class="btn btn--primary font-regular">{{translate('messages.Low_Stock_List')}}</a>
                        </div>
                    @endif
                ...
                <table id="datatable"
                    ...
                    <thead class="bg-table-head">
                        <tr>
                            ...
                            <th class="text-title border-0">{{translate('SKU / EAN')}}</th>
                            @if (Config::get('module.current_module_type') != 'food')
                    ...
                    <tbody id="set-rows">
                        @foreach($items as $key => $item)
                            <tr>
                                ...
                                <td>
                                    <div>{{$item->sku}}</div>
                                    <div style="font-size: 11px; color: grey;">{{$item->ean}}</div>
                                </td>
                                @if (Config::get('module.current_module_type') != 'food')
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <h5 class="text-hover-primary fw-medium mb-0">{{$item->stock}}</h5>
                                            <span data-toggle="modal" data-id="{{ $item->id }}" data-target="#update-quantity"
                                ...
                                <td>
                                    @if ($item->store)
                                        <a title="{{ $item?->store?->name }}" href="{{route('admin.store.view', $item->store->id)}}"
                                ...
                                <td>
                                    <div class="btn--container justify-content-center">
                                        ...
                                        <a class="btn  action-btn btn--danger btn-outline-danger form-alert" href="javascript:"
                                            ...
                                            title="{{translate('messages.delete_item')}}"><i class="tio-delete-outlined"></i>
                                        </a>
