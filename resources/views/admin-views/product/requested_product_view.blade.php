                ...
                <div class="w-70 flex-grow">
                    <div class="d-flex justify-content-end">
                        <div class="d-flex flex-wrap gap-2 align-items-start">
                            <a href="{{ route('admin.item.edit', [$product['id'], 'temp_product' => true]) }}"
                            ...
                            @if($product->is_rejected == 0)
                                <a data-toggle="tooltip" data-placement="top"
                                    data-original-title="{{ translate('messages.Reject') }}"
                                    data-url="{{ route('admin.item.deny', ['id' => $product['id']]) }}"
                                    data-message="{{ translate('you_want_to_deny_this_product') }}" href="javascript:"
