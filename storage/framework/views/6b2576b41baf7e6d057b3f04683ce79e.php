        ...
        <div class="modal-content pb-2 max-w-500">
            ...
            <div class="modal-body">
                <div class="text-center">
                    <img src="<?php echo e(asset('assets/admin/img/delete-confirmation.png')); ?>" alt="icon" class="mb-3">
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\test\components.blade.php ENDPATH**/ ?>