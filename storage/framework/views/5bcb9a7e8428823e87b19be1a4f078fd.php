...
<?php $__env->startSection('title',Request::is('admin/advertisement/copy-advertisement/*') ? translate('New_Advertisement')  : translate('Advertisement_Edit')); ?>
...
<div class="content container-fluid">
    ...
    <h1 class="page-header-title mb-3">
        <?php echo e(Request::is('admin/advertisement/copy-advertisement/*') ? translate('New_Advertisement')  : translate('Advertisement_Edit')); ?>
    ...
    <div class="card mb-20">
        <div class="card-body p-30">
            <form id="create-add-form"  method="post" enctype="multipart/form-data" >
                <?php echo csrf_field(); ?>
                <?php if(Request::is('admin/advertisement/copy-advertisement/*')): ?>
                ...
                <div class="row g-4">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <label class="form-label" for="exampleFormControlSelect1"><?php echo e(translate('messages.Select_Store')); ?> </label>
                        <div class="mb-20">
                            <select name="store_id" id="store_id"  data-placeholder="<?php echo e(translate('messages.select_store')); ?>"
                            class="js-data-example-ajax form-control">
                            <?php if(isset($advertisement->store)): ?>
                            <option value="<?php echo e($advertisement->store_id); ?>" selected="selected">
                                <?php echo e($advertisement->store->name); ?></option>
                            <?php endif; ?>
                            </select>
                        </div>

                        <label class="form-label"><?php echo e(translate('Select_Priority')); ?></label>
                        <div class="mb-20">
                            <select class="form-control w-100 js-select2-custom" name="priority">
                                <option value="<?php echo e($advertisement?->priority == null ||  $advertisement?->priority == 0 ?  '' : $advertisement?->priority); ?>"><?php echo e($advertisement?->priority == null ||  $advertisement?->priority == 0 ?  translate('N/A') : $advertisement?->priority); ?> </option>
                                <?php for($i = 1; $i <= $total_adds; $i++): ?>
                                <?php if($advertisement?->priority != $i ): ?>
                                ...
                                <div class="card-body p-3">
                                    <div class="w-100 d-flex flex-wrap gap-3">
                                        <label class="form-check form--check-2 me-3">
                                            <input type="checkbox"  id="is_review_checked" value='1' class="form-check-input" name="review" <?php echo e($advertisement?->is_review_active  == 1 ?  ' checked' :" "); ?> >
                                            <span class="form-check-label"><?php echo e(translate('Review')); ?></span>
                                        </label>
                                        <label class="form-check form--check-2">
                                            <input type="checkbox"  id="is_rating_checked" class="form-check-input"  value="1" name="rating"  <?php echo e($advertisement?->is_rating_active  == 1 ?  'checked' :" "); ?> >
                                ...
                                <div id="video-preview-box" class="video-preview-box">
                                    <div class="bg--secondary rounded">
                                        <div class="video h-200">
                                            <video src="<?php echo e($advertisement?->video_attachment ? $advertisement?->video_attachment_full_url :''); ?>" controls>
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex flex-column gap-2 flex-grow-1">
                                                    <div class="preview-title w-100">
                                                        ...
                                                        <h5  class="set-def-title main-text pe-4"> <?php echo e($advertisement?->getRawOriginal('title')); ?></h5>
                                                        
                                                    </div>
                                                    <div class="preview-description w-100">
                                                        <div   class="set-def-description main-text line-limit-2"><?php echo e($advertisement?->getRawOriginal('description')); ?>
                                                ...
                                                <div class="review-rating-demo">
                                                    <div class="rating-text static-text">
                                                        <div class="rating-number d-flex align-items-center">
                                                            <i class="tio-star"></i><span  id="rating_data" ><?php echo e(translate('4.7')); ?></span>
                                                        </div>
                                                    </div>
                                                    <span id="review_data" class="review--text static-text">(<?php echo e(translate('25+')); ?>)</span>
                                                </div>
...
<?php $__env->startPush('script_2'); ?>
    ...
    <script>
        ...
        $(window).on('load', function () {
            ...
            blobURL = "<?php echo e($advertisement?->video_attachment ?  $advertisement?->video_attachment_full_url : ''); ?>";
    ...
    <script>
        ...
        $('.promotion_type').on('change', function () {
            ...
            <?php if( $advertisement?->add_type == 'store_promotion'): ?>
...
<script>
            $(document).on('ready', function() {
                        ...
                        ajax: {
                            ...
                            data: function(params) {
                                return {
                                    ...
                                    page: params.page,
                                    module_id:<?php echo e(config('module')['current_module_id']); ?>
                    ...
                    $('#create-add-form').on('submit', function (event) {
                        ...
                        $.post({
                            url: `<?php echo e(Request::is('admin/advertisement/copy-advertisement/*') ? route('admin.advertisement.copyAddPost',$advertisement?->id) : route('admin.advertisement.update',$advertisement?->id)); ?>`,
                            ...
                            success: function (data) {
                                ...
                                if (data.errors) {
                                    ...
                                    setTimeout(function () {
                                        location.href = '<?php echo e(route('admin.advertisement.index')); ?>';
                                    }, 2000);
                                }
                            }
                        });
            ...
            function check_review_and_rating(store_id){
                ...
                $.ajax({
                    url: "<?php echo e(route('admin.store.get-store-ratings')); ?>",
                    method: 'get',
                    data: {
                        store_id: store_id,
                    },
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\advertisement\edit.blade.php ENDPATH**/ ?>