...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <form action="<?php echo e(env('APP_MODE') != 'demo' ? route('admin.settings') : 'javascript:'); ?>" method="post"
                    ...
                    <div class="card mb-3 mb-lg-5" id="generalDiv">
                        ...
                        <label class="avatar avatar-xxl avatar-circle avatar-border-lg avatar-uploader profile-cover-avatar"
                            for="avatarUploader">
                            <img id="viewer" data-onerror-image="<?php echo e(asset('assets/admin/img/160x160/img1.jpg')); ?>"
                ...
                <div id="passwordDiv" class="card mb-3 mb-lg-5">
                    ...
                    <div class="card-body">
                        ...
                        <form id="changePasswordForm"
                            action="<?php echo e(env('APP_MODE') != 'demo' ? route('admin.settings-password') : 'javascript:'); ?>"
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\settings.blade.php ENDPATH**/ ?>