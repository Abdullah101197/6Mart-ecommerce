    ...
    <div class="content container-fluid">
        ...
        <div class="page-header mb-20 pb-0">
            <h1 class="font-bold mb-0">
                <?php echo e(translate('messages.Send_Notification')); ?>
        ...
        <div class="fs-12 px-3 py-2 rounded bg-warning bg-opacity-10 text-title d-flex gap-2 align-items-baseline mb-20">
            ...
            <span class="fs-12 mb-0">
                ...
                <a target="_blank" href="<?php echo e(route('admin.business-settings.fcm-config')); ?>" class="font-semibold text-info"><?php echo e(translate('messages.Firebase Configuration')); ?> </a>
                <?php echo e(lcfirst(translate('messages.page to work notifications.'))); ?>
        ...
        <div class="card card-body mb-20">
            <div class="mb-20">
                <h3 class="mb-1">
                    <?php echo e(translate('messages.Send Notification')); ?>

                </h3>
                <p class="fs-12 mb-0">
                    <?php echo e(translate('messages.Configure settings to send push notifications to targeted users in specific zones.')); ?>
            ...
            <form action="<?php echo e(route('admin.notification.store')); ?>" method="post" enctype="multipart/form-data" id="notification">
                ...
                <div class="row g-3 mb-20">
                            ...
                            <div class="row g-3">
                                <div class="col-sm-6">
                                    <div class="form-group mb-0">
                                        <label class="input-label text-capitalize" for="exampleFormControlInput1"><?php echo e(translate('messages.zones')); ?></label>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-0">
                                        <label class="input-label text-capitalize" for="tergat"><?php echo e(translate('messages.Targeted user')); ?></label>

                                        <select name="tergat" class="form-control custom-select" id="tergat" data-placeholder="<?php echo e(translate('messages.select_tergat')); ?>" required>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-0">
                                        <label class="input-label text-capitalize d-flex gap-1 align-items-center" for="exampleFormControlInput1">
                                            <?php echo e(translate('messages.title')); ?>

                                            <span data-toggle="tooltip" data-title="<?php echo e(translate('messages.enter_notification_title')); ?>">
                                                <i class="tio-info text-light-gray"></i>
                                            </span>
                                        </label>
                                        <textarea name="notification_title" class="form-control" maxlength="100" rows="1" placeholder="<?php echo e(translate('messages.Type_Title')); ?>" required></textarea>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-0">
                                        <label class="input-label text-capitalize d-flex gap-1 align-items-center" for="exampleFormControlInput1">
                                            <?php echo e(translate('messages.description')); ?>

                                            <span data-toggle="tooltip" data-title="<?php echo e(translate('messages.enter_notification_description')); ?>">
                                                <i class="tio-info text-light-gray"></i>
                                            </span>
                                        </label>
                                        <textarea name="description" class="form-control" maxlength="200" rows="1" placeholder="<?php echo e(translate('messages.Type about the description')); ?>" required></textarea>
                    ...
                    <div class="col-lg-4">
                        <div class="__bg-F8F9FC-card h-100">
                                <div class="mb-20">
                                    <h5 class="mb-1"><?php echo e(translate('messages.Image')); ?> </h5>
                                    <p class="mb-0 fs-12">
                                        <?php echo e(translate('messages.Upload your cover Image')); ?>
                ...
                <div class="btn--container justify-content-end">
                    ...
                    <button type="submit" id="submit" class="btn btn--primary"><?php echo e(translate('messages.Save_&_Send')); ?></button>
                </div>
            </form>
        </div>
        ...
        <div class="card card-body">
            <div class="d-flex flex-wrap justify-content-lg-end align-items-center gap-3 mb-20">
                <h4 class="mb-0 flex-grow-1"><?php echo e(translate('Notification History')); ?><span class="badge badge-soft-dark ml-2"><?php echo e($notifications->total()); ?></span></h4>

                <select name="target" class="form-control custom-select max-w-200px min-w-100-mobile" id="filter_form" data-placeholder="<?php echo e(translate('messages.select_target')); ?>">
                    <option value="all" <?php echo e($target == 'all' ? 'selected' : ''); ?>><?php echo e(translate('messages.all')); ?></option>
                    <option value="customer" <?php echo e($target == 'customer' ? 'selected' : ''); ?>><?php echo e(translate('messages.customer')); ?></option>
                    <option value="deliveryman" <?php echo e($target == 'deliveryman' ? 'selected' : ''); ?>><?php echo e(translate('messages.deliveryman')); ?></option>
                    <option value="store" <?php echo e($target == 'store' ? 'selected' : ''); ?>><?php echo e(translate('messages.store')); ?></option>
                </select>
                ...
                <button type="reset" class="btn btn--primary ml-2 location-reload-to-base h--45px" data-url="<?php echo e(url()->full()); ?>"><?php echo e(translate('messages.reset')); ?></button>
                <?php endif; ?>
                ...
                <table id="columnSearchDatatable"
                    ...
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th class="border-0"><?php echo e(translate('messages.zones')); ?></th>
                    ...
                    <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <?php else: ?>
                                    <label class="badge badge-soft-warning mb-0"><?php echo e(translate('No Image')); ?></label>
                                <?php endif; ?>
                            </td>
                            <td>
                            <span data-toggle="tooltip" data-title="<?php echo e($notification['title']); ?>" class="d-block font-size-sm text-body">
                            ...
                            <td>
                                ...
                                <span class="max-w-280 line--limit-2" data-toggle="tooltip" data-title="<?php echo e($notification['description']); ?>"><?php echo e($notification['description']); ?></span>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="btn--container justify-content-center">
                                    <button type="button" class="btn action-btn btn--primary btn-outline-primary" data-toggle="modal"
                                     data-target="#notification-view-modal" title="<?php echo e(translate('messages.view_notification')); ?>"
                                     data-title="<?php echo e($notification['title']); ?>"
                                     data-description="<?php echo e($notification['description']); ?>"
                                     data-image="<?php echo e($notification['image_full_url']); ?>"
                                     data-zone="<?php echo e($notification->zone_id==null?translate('messages.all'):($notification->zone?$notification->zone->name:translate('messages.zone_deleted'))); ?>"
                                     data-tergat="<?php echo e($notification['tergat']); ?>"
                                     ><i class="tio-invisible"></i>
                                    </button>
                                    <button type="button" class="btn action-btn btn--primary btn-outline-primary offcanvas-trigger edit-btn"
                                     data-target="#notification-update-offcanvas" title="<?php echo e(translate('messages.edit_notification')); ?>"
                                     data-id="<?php echo e($notification['id']); ?>"
                                     data-title="<?php echo e($notification['title']); ?>"
                                     data-description="<?php echo e($notification['description']); ?>"
                                     data-image="<?php echo e($notification['image_full_url']); ?>"
                                     data-zone="<?php echo e($notification->zone_id); ?>"
                                     data-tergat="<?php echo e($notification['tergat']); ?>"
                                     ><i class="tio-edit"></i>
                                    </button>
        ...
        <form action="" method="post" enctype="multipart/form-data" id="update-notification-form">
            ...
            <div>
                    ...
                    <div class="mb-9">
                        ...
                        <div class="__bg-F8F9FC-card mb-20">
                            <div class="form-group mb-3">
                                ...
                                <textarea name="notification_title" id="notification_title_u" class="form-control" maxlength="100" rows="1" placeholder="<?php echo e(translate('messages.Type_Title')); ?>" required></textarea>
                                <span class="text-right text-counting color-A7A7A7 d-block mt-1">0/100</span>
                            </div>
                            <div class="form-group mb-3">
                                <label class="input-label text-capitalize d-flex gap-1 align-items-center" for="exampleFormControlInput1">
                                ...
                                <textarea name="description" id="description_u" class="form-control" maxlength="200" rows="3" placeholder="<?php echo e(translate('messages.Type about the description')); ?>" required></textarea>
                                <span class="text-right text-counting color-A7A7A7 d-block mt-1">0/200</span>
                            </div>
                            <div class="form-group mb-3">
                                <label class="input-label text-capitalize" for="exampleFormControlInput1"><?php echo e(translate('messages.zones')); ?></label>
                                <select name="zone" id="zone_u" class="form-control custom-select js-select2-custom" >
                                    <option value="all"><?php echo e(translate('messages.all_zone')); ?></option>
                                    <?php $__currentLoopData = $zones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($zone['id']); ?>"><?php echo e($zone['name']); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            ...
                            <div class="form-group mb-0">
                                <label class="input-label text-capitalize" for="tergat"><?php echo e(translate('messages.Targeted_user')); ?></label>

                                <select name="tergat" class="form-control custom-select" id="tergat_u" data-placeholder="<?php echo e(translate('messages.select_tergat')); ?>" required>
                                    <option value="customer"><?php echo e(translate('messages.customer')); ?></option>
                                    <option value="deliveryman"><?php echo e(translate('messages.deliveryman')); ?></option>
                                    <option value="store"><?php echo e(translate('messages.store')); ?></option>
                                </select>
                ...
                <div class="offcanvas-footer d-flex gap-3 justify-content-center align-items-center bg-white bottom-0 mt-auto p-3">
                    <button type="reset" id="reset_btn" class="btn btn--reset w-100"><?php echo e(translate('reset')); ?></button>
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header px-2 pt-2">
                        <h3 class="mb-0 px-2"><?php echo e(translate('messages.Send Notification Short view')); ?></h3>
                    ...
                    <div class="modal-body">
                        <div>
                            ...
                            <div class="card card-body mb-3">
                                <div class="mb-20">
                                    <h5 class="mb-1"><?php echo e(translate('messages.Tittle')); ?></h5>
                                    <p class="fs-12 mb-0" id="modal-title"></p>
                                </div>
                                <div>
                                    <h5 class="mb-1"><?php echo e(translate('messages.Description')); ?></h5>
                            ...
                            <div class="card card-body">
                                <div class="row g-3">
                                    <div class="col-sm-5">
                                        <div>
                                            <h5 class="mb-1"><?php echo e(translate('messages.Zones')); ?></h5>
                                    ...
                                    <div class="col-sm-5">
                                        <div>
                                            <h5 class="mb-1"><?php echo e(translate('messages.Targeted_user')); ?></h5>
                    ...
                    <div class="modal-footer border-0 shadow">
                        <div class="btn--container justify-content-end">
                            <button data-dismiss="modal"
                                class="btn btn--reset min-w-120"><?php echo e(translate("Close")); ?></button>
    ...
    <script>
        ...
        $('#notification').on('submit', function (e) {
            ...
            Swal.fire({
                ...
                imageUrl: '<?php echo e(asset('assets/admin/img/off-danger.png')); ?>',
                imageWidth: 80,
                imageHeight: 80,
            ...
            $('#filter_form').on('change', function () {
                let target = $(this).val();
                let url = '<?php echo e(route('admin.notification.add-new')); ?>?target=' + target;
            ...
            $('.edit-btn').on('click', function () {
                ...
                let action = '<?php echo e(route('admin.notification.update', 'temp_id')); ?>';
