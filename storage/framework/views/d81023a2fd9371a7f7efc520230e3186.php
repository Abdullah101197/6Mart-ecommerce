        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="<?php echo e(asset('assets/admin/img/banner.png')); ?>" class="w--26" alt="">
                </span>
                <span>
                                        ...
                                        <div class="h-100 d-flex flex-column">
                                            ...
                                            <div class="text-center py-3 my-auto">
                                                <img class="img--vertical" id="viewer"
                                                    src="<?php echo e(asset('assets/admin/img/900x400/img1.jpg')); ?>" alt="banner image"/>
                                            </div>
                            ...
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th class="border-0 text-center"><?php echo e(translate('messages.featured')); ?> <span class="input-label-secondary"
                                        data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('if_you_turn/off_on_this_featured,_it_will_effect_on_website_&_user_app')); ?>"><img src="<?php echo e(asset('assets/admin/img/info-circle.svg')); ?>"
...
<?php $__env->startPush('script_2'); ?>
    <script src="<?php echo e(asset('assets/admin')); ?>/js/view-pages/banner-index.js"></script>
    <script>
        "use strict";
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\banner\index.blade.php ENDPATH**/ ?>