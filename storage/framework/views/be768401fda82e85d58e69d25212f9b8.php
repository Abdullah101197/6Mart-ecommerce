    ...
    <div class="content container-fluid">
        ...
        <div class="card py-3 px-xxl-4 px-3 mb-20">
            <div class="d-flex flex-sm-nowrap flex-wrap gap-3 align-items-center justify-content-between">
                <div class="">
                    <h3 class="mb-1"><?php echo e(translate('FAQ Section')); ?></h3>
                    <p class="mb-0 gray-dark fs-12">
                        <?php echo e(translate('See how your FAQ Section will look to customers.')); ?>
        ...
        <div class="card py-3 px-xxl-4 px-3 mb-15 mt-4">
            <div class="row g-3 align-items-center justify-content-between">
                <div class="col-xxl-9 col-lg-8 col-md-7 col-sm-6">
                    <div class="">
                        <h3 class="mb-1"><?php echo e(translate('Show FAQ Section')); ?></h3>
                        <p class="mb-0 gray-dark fs-12">
                ...
                <div class="col-xxl-3 col-lg-4 col-md-5 col-sm-6">
                    <div class="py-2 px-3 rounded d-flex justify-content-between border align-items-center w-300">
                        ...
                        <form
                            action="<?php echo e(route('admin.business-settings.statusUpdate', ['type' => 'react_landing_page', 'key' => 'faq_section_status'])); ?>"
                        ...
                        <label class="toggle-switch toggle-switch-sm" for="CheckboxStatus">
                            <input type="checkbox" data-id="CheckboxStatus" data-type="status"
                                ...
                                <?php echo e($faq_section_status?->value ? 'checked' : ''); ?>>
        ...
        <div class="card mb-20">
            <div class="card-header">
                <div class="">
                    <h3 class="mb-1"><?php echo e(translate('FAQ Content Section ')); ?></h3>
                    <p class="mb-0 fs-12">
                        <?php echo e(translate('Manage the main title and subtitle for the Frequently Asked Questions section.	')); ?>
            ...
            <div class="card-body">
                <div class="card p-xxl-4 p-3 mb-20 border-0">
                    <form action="<?php echo e(route('admin.business-settings.react-landing-page-settings', 'faq-section')); ?>"
                                        ...
                                        <?php if($language): ?>
                                                ...
                                                <div class="row g-1">
                                                    <div class="col-12">
                                                        ...
                                                        <input id="faq_title" type="text" maxlength="100"
                                                               name="faq_title[]"
                                                               value="<?php echo e($faq_title?->getRawOriginal('value') ?? ''); ?>"
                                                               class="form-control"
                                            ...
                                            <?php $__currentLoopData = json_decode($language); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="col-md-12 d-none lang_form" id="<?php echo e($lang); ?>-form">
                                                    <div class="row g-1">
                                                        <div class="col-12">
                                                            <label for="faq_title<?php echo e($lang); ?>"
                                                                   class="form-label"><?php echo e(translate('Title')); ?>
                                                            ...
                                                            <input id="faq_title<?php echo e($lang); ?>" type="text"
                                                                   maxlength="100"
                                                                   name="faq_title[]"
                                                                   value="<?php echo e($faq_title_translate[$lang]['value'] ?? ''); ?>"
                                                                   class="form-control"
                                                                   placeholder="<?php echo e(translate('messages.title_here...')); ?>">
                                                            <span
                                                                class="text-right text-counting color-A7A7A7 d-block mt-1">0/100</span>
                ...
                <div class="card mb-20 border-0">
                    <div class="card-body p-xxl-4 p-3">
                        <div class="mb-20">
                            <h4 class="mb-1"><?php echo e(translate('FAQ Q&A Setup ')); ?></h4>
                            <p class="mb-0 fs-12">
                                <?php echo e(translate('Add and manage individual questions and answers for each user type.')); ?>

                            </p>
                        </div>
                        <form action="<?php echo e(route('admin.business-settings.react-landing-page-settings', 'faq-store')); ?>"
                              method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="row g-3">
                                <div class="col-lg-12">
                                    <div class="form-group mb-20">
                                        <label for=""
                                               class="mb-2 d-block text-title"><?php echo e(translate('messages.User Type')); ?></label>
                                        <select required name="user_type" class="custom-select" id="">
                                            <option disabled selected value="">
                                                <?php echo e(translate('Select user type')); ?>
                                            ...
                                            <?php if($language): ?>
                                                <div class="col-md-12 lang_form default-form">
                                                    <div class="row g-1">
                                                        <div class="col-12">
                                                            <label for="question"
                                                                   class="form-label"><?php echo e(translate('Question')); ?>

                                                                (<?php echo e(translate('messages.default')); ?>)
                                                                <span class="form-label-secondary" data-toggle="tooltip"
                                                                      data-placement="right"
                                                                      data-original-title="<?php echo e(translate('Write_the_title_within_150_characters')); ?>">
                        <i class="tio-info color-A7A7A7"></i>
                    </span><span class="form-label-secondary text-danger"
                                 data-toggle="tooltip" data-placement="right"
                                 data-original-title="<?php echo e(translate('messages.Required.')); ?>"> *
                                                            ...
                                                            <input id="question" type="text" maxlength="150"
                                                                   ...
                                                                   value=""
                                                                   class="form-control"
                                                                   placeholder="<?php echo e(translate('messages.Question Here...')); ?>" required>
                                                            <span
                                                                class="text-right text-counting color-A7A7A7 d-block mt-1">0/150</span>
                                                        </div>
                                                        <div class="col-12">
                                                            <label for="answer"
                                                                   class="form-label"><?php echo e(translate('Answer')); ?>

                                                                (<?php echo e(translate('messages.default')); ?>)
                                                                <span class="form-label-secondary" data-toggle="tooltip"
                                                                      data-placement="right"
                                                                      data-original-title="<?php echo e(translate('Write_the_title_within_500_characters')); ?>">
                        <i class="tio-info color-A7A7A7"></i>
                    </span><span class="form-label-secondary text-danger"
                                 data-toggle="tooltip" data-placement="right"
                                 data-original-title="<?php echo e(translate('messages.Required.')); ?>"> *
                                                            ...
                                                            <textarea id="answer" rows="1" maxlength="500"
                                                                      ...
                                                                      placeholder="<?php echo e(translate('messages.Answer Here...')); ?>" required></textarea>
                                                            <span
                                                ...
                                                <?php $__currentLoopData = json_decode($language); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="col-md-12 d-none lang_form" id="<?php echo e($lang); ?>-form">
                                                        <div class="row g-1">
                                                            <div class="col-12">
                                                                <label for="question<?php echo e($lang); ?>"
                                                                       class="form-label"><?php echo e(translate('Question')); ?>
                            ...
                            <i class="tio-info color-A7A7A7"></i>
                                                                ...
                                                                <input id="question<?php echo e($lang); ?>" type="text"
                                                                       maxlength="150"
                                                                       name="question[]"
                                                                       value=""
                                                                       class="form-control"
                                                                       placeholder="<?php echo e(translate('messages.Question Here...')); ?>">
                                                                <span
                                                                    class="text-right text-counting color-A7A7A7 d-block mt-1">0/150</span>
                                                            </div>
                                                            <div class="col-12">
                                                                <label for="answer<?php echo e($lang); ?>"
                                                                       class="form-label"><?php echo e(translate('Answer')); ?>
                            ...
                            <i class="tio-info color-A7A7A7"></i>
                                                                ...
                                                                <textarea id="answer<?php echo e($lang); ?>" rows="1" maxlength="500"
                                                                          name="answer[]"
                                                                          class="form-control min-h-45px"
                                                                          placeholder="<?php echo e(translate('messages.Answer Here...')); ?>"></textarea>
                                                                <span
                                                                    class="text-right text-counting color-A7A7A7 d-block mt-1">0/500</span>
                                                            </div>
                                                        </div>
                                            ...
                                            <?php else: ?>
                                                <div class="col-12">
                                                    <div class="mb-2">
                                                        <label for="question"
                                                               class="form-label"><?php echo e(translate('Question')); ?></label>
                                                    ...
                                                    <div class="mb-4">
                                                        <label for="answer"
                                                               class="form-label"><?php echo e(translate('Answer')); ?></label>
                                                        <textarea id="answer" rows="1" maxlength="500"
                                                                  name="answer[]"
                                                                  class="form-control min-h-45px"
                                                                  placeholder="<?php echo e(translate('messages.Answer Here...')); ?>"></textarea>
                                ...
                                <div class="input-group input--group">
                                    <form action="" method="get" class="d-flex align-items-center gap-2">
                                        <input type="text" name="search" class="form-control w-auto"
                                               placeholder="<?php echo e(translate('Search FAQs')); ?>"
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="table-responsive datatable-custom">
                            <table
                                ...
                                <tr>
                                    <th class="border-top-0"><?php echo e(translate('messages.sl')); ?></th>
                                    <th class="border-top-0"><?php echo e(translate('Question')); ?></th>
                                    <th class="border-top-0"><?php echo e(translate('Answer')); ?></th>
                                    <th class="border-top-0"><?php echo e(translate('User_Type')); ?></th>
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div
                                                class="text--title word-break min-w-100px line-limit-2 max-w-220px text-wrap">
                                                <?php echo e(translate($faq?->user_type)); ?>
                                        ...
                                        <td class="text-center">
                                            <label class="toggle-switch toggle-switch-sm">
                                                <input type="checkbox"
                                                       data-id="faq_status_<?php echo e($faq->id); ?>"
                                                       data-type="status"
                                                       data-image-on="<?php echo e(asset('/assets/admin/img/feature-status-on.png')); ?>"
                                                       data-image-off="<?php echo e(asset('/assets/admin/img/off-danger.png')); ?>"
                                                       data-title-on="<?php echo e(translate('Want_to_Enable_this')); ?> <strong><?php echo e(translate('faq')); ?></strong>"
                                                       data-title-off="<?php echo e(translate('Want_to_Disable_this')); ?> <strong><?php echo e(translate('faq')); ?></strong>"
                                                       data-text-on="<p><?php echo e(translate('If_enabled,_it_will_be_shown_on_the_React_Landing_page')); ?></p>"
                                                       data-text-off="<p><?php echo e(translate('If_disabled,_it_will_be_hidden_from_the_React_Landing_page')); ?></p>"
                                                       class="status toggle-switch-input dynamic-checkbox"
                                                       id="faq_status_<?php echo e($faq->id); ?>"
                                                    <?php echo e($faq->status ? 'checked' : ''); ?>>
                                                <span class="toggle-switch-label">
                                                        <span class="toggle-switch-indicator"></span>
                                                    </span>
                                            </label>
                                            <form
                                                action="<?php echo e(route('admin.business-settings.reactfaqStatus', [$faq->id, $faq->status ? 0 : 1])); ?>"
                                                method="get" id="faq_status_<?php echo e($faq->id); ?>_form">
                                            </form>
                                        </td>
                                        <td>
                                            <div class="btn--container justify-content-center">
                                                <a class="btn btn-sm text-end action-btn info--outline text--info info-hover offcanvas-trigger get_data data-info-show"
                                                   ...
                                                   data-url="<?php echo e(route('admin.business-settings.reactfaqEdit', [$faq['id']])); ?>"
                                                   href="javascript:" title="<?php echo e(translate('messages.edit_faq')); ?>">
                                                    <i class="tio-edit"></i>
                                                </a>
                                                <a class="btn action-btn btn--danger btn-outline-danger form-alert-faq"
                                                   href="javascript:"
                                                   data-id="faq-<?php echo e($faq->id); ?>"
                                                   data-message="<?php echo e(translate('Want_to_Delete_this_faq')); ?>"
                                                   data-message-2="<?php echo e(translate('If_yes,_the_faq_will_be_removed_from_this_list')); ?>"
                                                   title="<?php echo e(translate('messages.delete_faq')); ?>">
                                                    <i class="tio-delete-outlined"></i>
                                                </a>
                                                <form
                                                    action="<?php echo e(route('admin.business-settings.reactfaqDestroy',[$faq['id']])); ?>"
        ...
        <form action="<?php echo e(route('taxvat.store')); ?>" method="post">
            <div>
                <div
                    ...
                    <div class="py-1">
                        <h3 class="mb-0 line--limit-1"><?php echo e(translate('messages.Faq Section Preview')); ?></h3>
                    </div>
                    <button type="button"
                    ...
                    <section class="common-section-view bg-white border rounded-10 my-xl-2 mx-xl-2">
                        <div class="common-section-inner0">
                            <h2 class="mb-md-4 mb-3 fs-24 text-center">
                                <?php echo \App\CentralLogics\Helpers::highlightWords($faq_title?->value ?? 'Got Questions? We’ve Got $Answers$'); ?>
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="home" role="tabpanel"
                                    ...
                                    <div class="accordion d-flex flex-column gap-3 question-accordion"
                                         id="faqAccordion">
                                        <?php if(!empty($customerTab)): ?>
                                            <?php $__currentLoopData = $customerTab; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $customerFaq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php
                                                ...
                                                <div class="card <?php echo e($key == 4 ? 'disabled' : ''); ?>">
                                                    <div class="card-header-cus" id="<?php echo e($headingId); ?>">
                                                        <button class="btn btn-link text-wrap text-title <?php echo e($isActive ? '' : 'collapsed'); ?>"
                                                                type="button"
                                                                data-toggle="collapse"
                                                                data-target="#<?php echo e($collapseId); ?>"
                                                                aria-expanded="<?php echo e($isActive ? 'true' : 'false'); ?>"
                                                                aria-controls="<?php echo e($collapseId); ?>">
                                                            <?php echo e($customerFaq->question); ?>

                                                        </button>
                                                    </div>

                                                    <div id="<?php echo e($collapseId); ?>"
                                                         class="collapse <?php echo e($isActive ? 'show' : ''); ?>"
                                                         aria-labelledby="<?php echo e($headingId); ?>"
                                                         data-parent="#faqAccordion">
                                                        <div class="card-body max-w-700 pt-0">
                                                            <?php echo e($customerFaq->answer); ?>
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        <img
                                                            src="<?php echo e(asset('/assets/admin/img/icons/faq-question.png')); ?>"
                                ...
                                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                    <div class="accordion d-flex flex-column gap-3 question-accordion"
                                         id="faqAccordion2">
                                        <?php if(!empty($sellerTab)): ?>
                                            <?php $__currentLoopData = $sellerTab; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $sellerFaq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php
                                                    $headingId = 'heading' . $key;
                                                    $collapseId = 'collapse' . $key;
                                                    $isActive = $key == 0;
                                ...
                                <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                                    <div class="accordion d-flex flex-column gap-3 question-accordion"
                                         id="faqAccordion3">
                                        <?php if(!empty($riderTab)): ?>
                                            <?php $__currentLoopData = $riderTab; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $riderFaq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php
                                                    $headingId = 'heading' . $key;
                                                    $collapseId = 'collapse' . $key;
                                                    $isActive = $key == 0;
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\business-settings\landing-page-settings\react-landing-page-faq.blade.php ENDPATH**/ ?>