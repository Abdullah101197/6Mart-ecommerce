...
<?php $__env->startSection('title',translate('stock_Update')); ?>
...
<div class="content container-fluid">
    ...
    <div class="page-header">
        <h1 class="page-header-title">
            ...
            <span>
                <?php echo e(translate('stock update')); ?>
            ...
            <div class="search--button-wrapper justify-content-end">
                <form class="search-form theme-style">
                    ...
                    <div class="input-group input--group">
                        <input id="datatableSearch" name="search" type="search" class="form-control" placeholder="<?php echo e(translate('ex_:_search_name')); ?>" value="<?php echo e(request()?->search ?? null); ?>" aria-label="<?php echo e(translate('messages.search_here')); ?>">
                ...
                <?php endif; ?>
                <div class="min--200">
                    <select name="zone_id" class="form-control js-select2-custom set-filter theme-style" data-url="<?php echo e(url()->full()); ?>" data-filter="zone_id" id="zone">
                ...
                <div class="min--200">
                    <select name="store_id" data-placeholder="<?php echo e(translate('messages.select_store')); ?>" class="js-data-example-ajax form-control set-filter theme-style" data-url="<?php echo e(url()->full()); ?>" data-filter="store_id">
                        <?php if(isset($store)): ?>
                ...
                <div class="hs-unfold mr-2">
                    ...
                    <div id="usersExportDropdown"
                        ...
                        <a id="export-excel" class="dropdown-item" href="<?php echo e(route('admin.transactions.report.low-stock-wise-report-export', ['type'=>'excel',request()->getQueryString()])); ?>">
                        ...
                        <a id="export-csv" class="dropdown-item" href="<?php echo e(route('admin.transactions.report.low-stock-wise-report-export', ['type'=>'csv',request()->getQueryString()])); ?>">
                            <img class="avatar avatar-xss avatar-4by3 mr-2"
            ...
            <table id="datatable" class="table table-borderless table-thead-bordered table-nowrap card-table" data-hs-datatables-options='{
                ...
                <tbody id="set-rows">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo e($item->stock>=0?$item->stock:0); ?>
...
<script>
    ...
    $(document).on('ready', function() {
        ...
        $('#search-form').on('submit', function (e) {
            ...
            $.post({
                url: '<?php echo e(route('admin.transactions.report.low-stock-search')); ?>',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\report\low-stock-report.blade.php ENDPATH**/ ?>