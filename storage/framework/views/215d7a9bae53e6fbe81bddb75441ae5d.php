                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    <?php if(\App\CentralLogics\Helpers::module_permission_check('banner')): ?>
                        <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/banner*') ? 'active' : ''); ?>">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                               href="<?php echo e(route('admin.banner.add-new')); ?>" title="<?php echo e(translate('messages.banners')); ?>">
                    ...
                    <?php if(\App\CentralLogics\Helpers::module_permission_check('coupon')): ?>
                        <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/coupon*') ? 'active' : ''); ?>">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                               href="<?php echo e(route('admin.coupon.add-new')); ?>" title="<?php echo e(translate('messages.coupons')); ?>">
    ...
    \App\CentralLogics\Helpers::module_permission_check('item')): ?>
                        ...
                        <?php if(\App\CentralLogics\Helpers::module_permission_check('item')): ?>
                            <li class="navbar-vertical-aside-has-menu  <?php echo $__env->yieldContent('low_stock_list'); ?> <?php echo e(Request::is('admin/item*') ? 'active' : ''); ?>">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                   href="javascript:" title="<?php echo e(translate('Product Setup')); ?>">
                                    ...
                                    <li class="nav-item  <?php echo $__env->yieldContent('low_stock_list'); ?>">
                                        <a class="nav-link " href="<?php echo e(route('admin.report.stock-report')); ?>"
                                           title="<?php echo e(translate('messages.Low_Stock_List')); ?>">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span
                                                class="text-truncate"><?php echo e(translate('messages.Low_Stock_List')); ?></span>
                                        </a>
                                    </li>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views/layouts/admin/partials/_sidebar_grocery.blade.php ENDPATH**/ ?>