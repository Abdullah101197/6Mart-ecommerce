...
<?php $__env->startSection('content'); ?>
    <div class="content container-fluid">
        ...
        <div class="card py-3 px-xxl-4 px-3 mb-20">
            <div class="d-flex flex-sm-nowrap flex-wrap gap-3 align-items-center justify-content-between">
                <div class="">
                    <h3 class="mb-1"><?php echo e(translate('User App Download Section')); ?></h3>
                    <p class="mb-0 gray-dark fs-12">
                        <?php echo e(translate('See how your User App Download Section will look to customers.')); ?>
        ...
        <div class="card py-3 px-xxl-4 px-3 mb-15 mt-4">
            <div class="row g-3 align-items-center justify-content-between">
                <div class="col-xxl-9 col-lg-8 col-md-7 col-sm-6">
                    <div class="">
                        <h3 class="mb-1"><?php echo e(translate('Show User App Download Section')); ?></h3>
                        <p class="mb-0 gray-dark fs-12">
                ...
                <div class="col-xxl-3 col-lg-4 col-md-5 col-sm-6">
                    <div class="py-2 px-3 rounded d-flex justify-content-between border align-items-center w-300">
                        ...
                        <form
                            action="<?php echo e(route('admin.business-settings.statusUpdate', ['type' => 'react_landing_page', 'key' => 'download_user_app_section_status'])); ?>"
                        ...
                        <label class="toggle-switch toggle-switch-sm" for="CheckboxStatus">
                            <input type="checkbox" data-id="CheckboxStatus" data-type="status"
                                ...
                                <?php echo e($download_user_app_section_status?->value ? 'checked' : ''); ?>>
        ...
        <div class="card mb-20">
            <form class="custom-validation"
                  action="<?php echo e(route('admin.business-settings.react-landing-page-settings', 'download-app-section')); ?>"
                  method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="card-body">
                    <div class="mb-20">
                        <h3 class="mb-1"><?php echo e(translate('User App Download Section Content ')); ?></h3>
                        <p class="mb-0 fs-12">
                            <?php echo e(translate('Encourage users to download the app for a seamless experience and instant access.')); ?>
                                    ...
                                    <?php if($language): ?>
                                            ...
                                            <div class="row g-1">
                                                <div class="col-12">
                                                    ...
                                                    <input id="download_user_app_title" type="text" maxlength="100"
                                                           ...
                                                           value="<?php echo e($download_user_app_title?->getRawOriginal('value') ?? ''); ?>"
                                                           class="form-control"
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <input id="download_user_app_sub_title" type="text" maxlength="200"
                                                           ...
                                                           value="<?php echo e($download_user_app_sub_title?->getRawOriginal('value') ?? ''); ?>"
                                                           class="form-control"
                                        ...
                                        <?php $__currentLoopData = json_decode($language); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="col-md-12 d-none lang_form" id="<?php echo e($lang); ?>-form">
                                                <div class="row g-1">
                                                    <div class="col-12">
                                                        <label for="download_user_app_title<?php echo e($lang); ?>"
                                                               class="form-label"><?php echo e(translate('Title')); ?>
                                                        ...
                                                        <input id="download_user_app_title<?php echo e($lang); ?>" type="text"
                                                               maxlength="100"
                                                               name="download_user_app_title[]"
                                                               value="<?php echo e($download_user_app_title_translate[$lang]['value'] ?? ''); ?>"
                                                               class="form-control"
                                                               placeholder="<?php echo e(translate('messages.title_here...')); ?>">
                                                        <span
                                                            class="text-right text-counting color-A7A7A7 d-block mt-1">0/100</span>
                                                    ...
                                                    <div class="col-12">
                                                        <label for="download_user_app_sub_title<?php echo e($lang); ?>"
                                                               class="form-label"><?php echo e(translate('Sub Title')); ?>
                                                        ...
                                                        <input id="download_user_app_sub_title<?php echo e($lang); ?>" type="text"
                                                               maxlength="200"
                                                               name="download_user_app_sub_title[]"
                                                               value="<?php echo e($download_user_app_sub_title_translate[$lang]['value'] ?? ''); ?>"
                                                               class="form-control"
                                                               placeholder="<?php echo e(translate('messages.sub_title_here...')); ?>">
                                                        <span
                                                            class="text-right text-counting color-A7A7A7 d-block mt-1">0/200</span>
                                ...
                                <div class="text-center">
                                    <div class="mb-4">
                                        ...
                                        <p class="mb-0 fs-12 gray-dark">
                                            <?php echo e(translate('Upload your User App Download Section  Image')); ?></p>
                                    </div>
                                    <div class="mx-auto text-center error-wrapper">
                                        <div class="upload-file_custom ratio-1 h-100px">
                                            <input type="file" name="image"
                                                   class="upload-file__input single_file_input"
                                                   accept=".webp, .jpg, .jpeg, .png, .gif" <?php echo e($download_user_app_image?->value ? '' : 'required'); ?>>
                                            <label class="upload-file__wrapper w-100 h-100 m-0">
                                                ...
                                                <img class="upload-file-img" loading="lazy" src="<?php echo e($download_user_app_image?->value
    ...
    : ''); ?>" data-default-src="<?php echo e($download_user_app_image?->value
    ? \App\CentralLogics\Helpers::get_full_url('download_user_app_image', $download_user_app_image->value, $download_user_app_image->storage[0]?->value ?? 'public', 'aspect_1')
    : ''); ?>" alt="">
                                            </label>
                                            <div class="overlay">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                ...
                <form
                    action="<?php echo e(route('admin.business-settings.react-landing-page-settings', 'download-app-button-section')); ?>"
                    method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-20">
                                <h3 class="mb-1"><?php echo e(translate('User App Download Section Button ')); ?></h3>
                                <p class="mb-0 fs-12">
                                    <?php echo e(translate('Manage mobile app download area including QR codes and app store buttons.')); ?>
                                        ...
                                        <?php if($language): ?>
                                                ...
                                                <div class="row g-1">
                                                    <div class="col-12">
                                                        ...
                                                        <input id="download_user_app_button_title" type="text"
                                                               ...
                                                               value="<?php echo e($download_user_app_button_title?->getRawOriginal('value') ?? ''); ?>"
                                                               class="form-control"
                                                               placeholder="<?php echo e(translate('messages.title_here...')); ?>">
                                                        <span
                                                            class="text-right text-counting color-A7A7A7 d-block mt-1">0/100</span>
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <input id="download_user_app_button_sub_title" type="text"
                                                               ...
                                                               value="<?php echo e($download_user_app_button_sub_title?->getRawOriginal('value') ?? ''); ?>"
                                                               class="form-control"
                                                               placeholder="<?php echo e(translate('messages.sub_title_here...')); ?>">
                                                        <span
                                                            class="text-right text-counting color-A7A7A7 d-block mt-1">0/200</span>
                                            ...
                                            <?php $__currentLoopData = json_decode($language); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="col-md-12 d-none lang_form" id="<?php echo e($lang); ?>-form1">
                                                    <div class="row g-1">
                                                        <div class="col-12">
                                                            <label for="download_user_app_button_title<?php echo e($lang); ?>"
                                                                   class="form-label"><?php echo e(translate('Title')); ?>
                                                            ...
                                                            <input id="download_user_app_button_title<?php echo e($lang); ?>"
                                                                   type="text" maxlength="100"
                                                                   name="download_user_app_button_title[]"
                                                                   value="<?php echo e($download_user_app_button_title_translate[$lang]['value'] ?? ''); ?>"
                                                                   class="form-control"
                                                                   placeholder="<?php echo e(translate('messages.title_here...')); ?>">
                                                            <span
                                                                class="text-right text-counting color-A7A7A7 d-block mt-1">0/100</span>
                                                        ...
                                                        <div class="col-12">
                                                            <label for="download_user_app_button_sub_title<?php echo e($lang); ?>"
                                                                   class="form-label"><?php echo e(translate('Sub Title')); ?>
                                                            ...
                                                            <input type="text"
                                                                   id="download_user_app_button_sub_title<?php echo e($lang); ?>"
                                                                   maxlength="200"
                                                                   name="download_user_app_button_sub_title[]"
                                                                   value="<?php echo e($download_user_app_button_sub_title_translate[$lang]['value'] ?? ''); ?>"
                                                                   class="form-control"
                                                                   placeholder="<?php echo e(translate('messages.sub_title_here...')); ?>">
                                                            <span
                                                                class="text-right text-counting color-A7A7A7 d-block mt-1">0/200</span>
                                        ...
                                        <div class="bg-white rounded p-xxl-4 p-2">
                                            <div
                                                ...
                                                <label class="toggle-switch toggle-switch-sm m-0">
                                                    <input type="checkbox" name="playstore_url_status"
                                                           ...
                                                           value="1"
                                                        <?php echo e((isset($download_user_app_links) && $download_user_app_links['playstore_url_status']) ? 'checked' : ''); ?>>
                                            ...
                                            <div class="__bg-F8F9FC-card">
                                                <div class="form-group mb-md-0">
                                                    ...
                                                    <input type="url"
                                                           <?php echo e((isset($download_user_app_links) && $download_user_app_links['playstore_url_status']) ? 'required' : ''); ?>

                                                           id="playstore_url"
                                                           placeholder="<?php echo e(translate('Ex: https://play.google.com/store/apps')); ?>"
                                                           class="form-control h--45px" name="playstore_url"
                                                           value="<?php echo e($download_user_app_links['playstore_url'] ?? ''); ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="__bg-F8F9FC-card">
                                                <div class="form-group mb-md-0">
                                                    ...
                                                    <input type="url" id="apple_store_url"
                                                           <?php echo e((isset($download_user_app_links) && $download_user_app_links['apple_store_url_status']) ? 'required' : ''); ?>

                                                           placeholder="<?php echo e(translate('Ex: https://www.apple.com/app-store/')); ?>"
                                                           class="form-control h--45px" name="apple_store_url"
                                                           value="<?php echo e($download_user_app_links['apple_store_url'] ?? ''); ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <form action="<?php echo e(route('taxvat.store')); ?>" method="post">
            <div>
                <div
                    ...
                    <div class="py-1">
                        <h3 class="mb-0 line--limit-1"><?php echo e(translate('messages.User App Download Section Preview')); ?></h3>
                    </div>
                    <button type="button"
                        ...
                        <div
                            ...
                            <div>
                                <div class="mb-xl-4 mb-3">
                                    <h2 class="mb-1 fs-20">
                                        <?php echo \App\CentralLogics\Helpers::highlightWords($download_user_app_title?->value ?? 'Get $6amMart$ on Your Phone'); ?>

                                    </h2>
                                    <p class="text-title fs-12 mb-0">
                                        <?php echo e($download_user_app_sub_title?->value ?? 'Order groceries, food, medicine & more instantly — anytime, anywhere.'); ?>
                                ...
                                <div
                                    ...
                                    <div class="scan-wrap mb-xl-0 mb-3 w-xl-auto w-100">
                                        ...
                                        <p class="mb-0 fs-12 mt-1 text-center"><?php echo e(translate('messages.Scan to DownLoad')); ?>

                                        </p>
                                    </div>
                                    <div>
                                        <div class="mb-3 text-xl-start text-center">
                                            <h4 class="mb-0"><?php echo e($download_user_app_button_title?->value ?? 'Download the Customer App'); ?></h4>
                                            <p class="mb-0 fs-12"><?php echo e($download_user_app_button_sub_title?->value ?? 'Smart shopping starts here.'); ?>
                            ...
                            <div class="user-app-thumb max-w-280 d-center mt-xl-0 mt-3">
                                <img src="<?php echo e($download_user_app_image?->value ? \App\CentralLogics\Helpers::get_full_url(
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\business-settings\landing-page-settings\react-landing-download-apps.blade.php ENDPATH**/ ?>