                            ...
                            <div class="py-2">
                                <div class="row g-3 align-items-end">
                                        ...
                                        <div class="form-group mb-0">
                                            <label
                                                ...
                                                <input type="checkbox"
                                                       data-id="take_away"
                                                       data-type="toggle"
                                                       data-image-on="<?php echo e(asset('/assets/admin/img/modal/takeaway-on.png')); ?>"
                                                       data-image-off="<?php echo e(asset('/assets/admin/img/modal/takeaway-off.png')); ?>"
                                    ...
                                    <div class="mb-3 access_product_approval">
                                        ...
                                        <label class="mb-2 input-label text-capitalize d-flex alig-items-center" for=""> <img src="<?php echo e(asset('/assets/admin/img/icon-park_ad-product.png')); ?>" alt=""
                                ...
                                <div class="__bg-F8F9FC-card p-0 mt-4">
                                    ...
                                    <span class="toggle-switch toggle-switch-sm pr-sm-3">
                                        <input type="checkbox" data-id="admin_free_delivery_status" data-type="toggle"
                                               data-image-on="<?php echo e(asset('/assets/admin/img/modal/free-delivery-on.png')); ?>"
                                               data-image-off="<?php echo e(asset('/assets/admin/img/modal/free-delivery-off.png')); ?>"
