        ...
        <div class="card-body">
            <div class="row g-3 justify-content-between align-items-center">
                <div class="col-lg-8 col-md-7 col-sm-7">
                    <div>
                        <h3 class="mb-1"><?php echo e(translate('messages.Show Trust Section')); ?></h3>
    ...
    <div class="row g-3">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="w-100 d-flex align-items-center gap-2 flex-wrap justify-content-between">
                        <h5 class="mb-0"><?php echo e(translate('1st Card')); ?></h5>
                    ...
                    <div class="bg--secondary h-100 rounded p-md-4 p-3">
                        ...
                        <div class="row g-1 lang_form default-form">
                            <div class="col-sm-12">
                                ...
                                <input id="" type="text"  maxlength="20" name="[]" class="form-control" value="" placeholder="<?php echo e(translate('messages.title_here...')); ?>">
                            ...
                            <div class="col-sm-12">
                                ...
                                <input id="" type="text"  maxlength="30" name="" class="form-control" value="" placeholder="<?php echo e(translate('messages.sub_title_here...')); ?>">
                                <span class="text-right text-counting color-A7A7A7 d-block mt-1">0/30</span>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <div class="w-100 d-flex align-items-center gap-2 flex-wrap justify-content-between">
                        <h5 class="mb-0"><?php echo e(translate('2nd Card')); ?></h5>
                        <label class="toggle-switch h--45px toggle-switch-sm d-flex justify-content-between gap-4">
                            <span class="w-auto switch--label text-nowrap fs-14 text-title">
                                <?php echo e(translate('messages.Status')); ?>                                    
                            </span>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <div class="w-100 d-flex align-items-center gap-2 flex-wrap justify-content-between">
                        <h5 class="mb-0"><?php echo e(translate('3rd Card')); ?></h5>
                        <label class="toggle-switch h--45px toggle-switch-sm d-flex justify-content-between gap-4">
                            <span class="w-auto switch--label text-nowrap fs-14 text-title">
                                <?php echo e(translate('messages.Status')); ?>                                    
                            </span>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <div class="w-100 d-flex align-items-center gap-2 flex-wrap justify-content-between">
                        <h5 class="mb-0"><?php echo e(translate('4th Card')); ?></h5>
                        <label class="toggle-switch h--45px toggle-switch-sm d-flex justify-content-between gap-4">
                            <span class="w-auto switch--label text-nowrap fs-14 text-title">
                                <?php echo e(translate('messages.Status')); ?>                                    
                            </span>
                                ...
                                <div class="items__">
                                    <div class="px-3 py-4 shadow--card d-flex align-items-center gap-3">
                                        <div class="thumb-area bg-F5F5F5 rounded-pill w-60px h-60px min-w-60px d-center">
                                            <img wdith="28" height="28" src="<?php echo e(asset('/assets/admin/img/order-delivery-list.png')); ?>" alt="" class="min-w-28">
                                        </div>
                                        <div>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\test\React_Landing\trust-section.blade.php ENDPATH**/ ?>