...
<!-- Builder -->
<?php echo $__env->make('layouts.admin.partials._front-settings', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<!-- End Builder -->
...
<?php endif; ?>
    ...
    <?php if($module_type == 'rental'): ?>
        <?php echo $__env->make("rental::admin.partials._sidebar_{$module_type}", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php else: ?>
...
<!-- End Footer -->
    ...
    <div class="d-none" id="text-validate-translate"
        data-required="<?php echo e(translate('this_field_is_required')); ?>"
        data-something-went-wrong="<?php echo e(translate('something_went_wrong!')); ?>"
        data-max-limit-crossed="<?php echo e(translate('max_limit_crossed')); ?>"
        data-file-size-larger="<?php echo e(translate('file_size_is_larger')); ?>"
        data-passwords-do-not-match="<?php echo e(translate('passwords_do_not_match')); ?>"
        data-valid-email="<?php echo e(translate('please_enter_a_valid_email')); ?>"
        data-password-validation="<?php echo e(translate('password_must_be_8+_chars_with_upper,_lower,_number_&_symbol')); ?>"
    ></div>
...
"use strict";
    ...
    let messaging = null;
    <?php if(isset($fcm_credentials['projectId']) && $fcm_credentials['projectId']): ?>
        ...
        if(payload.data.order_id && payload.data.type == "order_request"){
                ...
                if(new_order_type === 'trip'){
                    ...
                    if (updateNotificationText) {
                        updateNotificationText.textContent = "<?php echo e(translate('messages.You have new trip, Check Please.')); ?>";
                    }
                }
                if(admin_role_id === '1'){
                    playAudio();
...
<?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\layouts\admin\app.blade.php ENDPATH**/ ?>