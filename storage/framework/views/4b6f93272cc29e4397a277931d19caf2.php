...
<head>
    ...
    <title><?php echo e(translate('Delivery Man Referral Earning Report Invoice')); ?></title>
     <style>
    ...
    <div class="invoice-space">
                    ...
                    <div class="text-left header-info-right header-info-inner">
                        ...
                        <table class="fs-10">
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <span class="datas"><?php echo e(\App\CentralLogics\Helpers::format_currency($earnings->sum('amount'))); ?></span>
                                </td>
                            </tr>
                        </table>
                    </div>
        ...
        <table dir="<?php echo e($site_direction); ?>" class="table w-100 main-table fs-10 text-clr">
            ...
            <tr>
                ...
                <th class="fs-10 text-right"><?php echo e(translate('Referral Earning')); ?></th>
            </tr>
            </thead>
            <tbody>
            ...
            <tr>
                ...
                <td class="text-left">
                    ...
                    <?php if($earning->refer_type == 'referrerBonus'): ?>
                        <div>
                ...
                <td class="text-right">
                    <span><?php echo e(\App\CentralLogics\Helpers::format_currency($earning->amount)); ?></span>
                </td>
...
<?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\invoice-pdf\referral-earning-report-invoice.blade.php ENDPATH**/ ?>