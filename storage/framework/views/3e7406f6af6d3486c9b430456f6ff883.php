<?php $__env->startSection('title', request()->product_gellary == 1 ? translate('Add item') : translate('Edit item')); ?>
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header d-flex flex-wrap __gap-15px justify-content-between align-items-center">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="<?php echo e(asset('public/assets/admin/img/edit.png')); ?>" class="w--22" alt="">
                </span>
                <span>
        ...
        <form id="product_form" enctype="multipart/form-data" class="custom-validation" data-ajax="true">
            ...
            <input type="hidden" class="route_url"
                value="<?php echo e($route ?? route('admin.item.update', [isset($temp_product) && $temp_product == 1 ? $product['item_id'] : $product['id']])); ?>">
            ...
            <div class="row g-2">
                                ...
                                <div class="flex-grow-1 mx-auto pb-2 flex-shrink-0">
                                    ...
                                    <label class="d-inline-block m-0 position-relative error-wrapper">
                                        <img class="img--176 border onerror-image" id="viewer"
                                            src="<?php echo e($product['image_full_url'] ?? asset('public/assets/admin/img/upload-img.png')); ?>"
                                            data-onerror-image="<?php echo e(asset('public/assets/admin/img/upload-img.png')); ?>"
                                            alt="thumbnail" />
                                ...
                                <div class="card shadow--card-2 border-0 bg-animate">
                                    ...
                                    <div class="card-body">
                                        <div id="add_new_option">
                                            <?php if(isset($product->food_variations) && count($product->food_variations) > 0): ?>
                                                <?php $__currentLoopData = $product->food_variations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key_choice_options => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <!-- Empty Variation -->
                                        <?php if(!isset($product->food_variations) || count($product->food_variations) < 1): ?>
                                            <div id="empty-variation">
                                                <div class="text-center">
                                                    <img src="<?php echo e(asset('/public/assets/admin/img/variation.png')); ?>"
                                                        alt="">
                                            ...
                                            <div class="col-md-12">
                                                <div class="table-responsive">
                                                    <div class="customer_choice_options d-flex __gap-24px"
                                                        ...
                                                        <?php echo $__env->make('admin-views.product.partials._choices', [
                ...
                <div class="col-md-12">
                    <div class="btn--container justify-content-end">
                        ...
                        <button type="submit"
                            class="btn btn--primary"><?php echo e(isset($temp_product) && $temp_product == 1 ? translate('Edit_&_Approve') : translate('messages.submit')); ?></button>
                    </div>
                </div>
            </div>
        </form>
...
<?php $__env->startPush('script_2'); ?>
    ...
    <script>
        ...
        $('#store_id').on('change', function() {
            let route = '<?php echo e(url('/')); ?>/admin/store/get-addons?data[]=0&store_id=';
        ...
        $(document).ready(function() {
            <?php if(count($product->add_ons ?: []) > 0): ?>
                getStoreData(
                    '<?php echo e(url('/')); ?>/admin/store/get-addons?<?php $__currentLoopData = $product->add_ons ?: []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $addon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>data[]=<?php echo e($addon); ?>& <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> store_id=',
                    '<?php echo e($product['store_id']); ?>', 'add_on');
            <?php else: ?>
                getStoreData('<?php echo e(url('/')); ?>/admin/store/get-addons?data[]=0&store_id=',
                    '<?php echo e($product['store_id']); ?>', 'add_on');
            <?php endif; ?>
        });

        let module_id = <?php echo e($product->module_id); ?>;
        let module_type = "<?php echo e($product->module->module_type); ?>";
        let parent_category_id = <?php echo e($category ? $category->id : 0); ?>;
        <?php
        $module_data = config('module.' . $product->module->module_type);
        unset($module_data['description']);
        ?>
        let module_data = <?php echo e(str_replace('"', '', json_encode($module_data))); ?>;
        let stock = <?php echo e($product->module->module_type == 'food' ? 'false' : 'true'); ?>;
        ...
        $('#category_id').on('change', function() {
            ...
            subCategoriesSelect.append(
                '<option value="" selected><?php echo e(translate('messages.select_sub_category')); ?></option>');
        });
        ...
        function initImagePicker() {
            $("#coba").spartanMultiImagePicker({
                ...
                maxFileSize: 1024 * 1024 * <?php echo e(MAX_FILE_SIZE); ?>,
                placeholderImage: {
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views/admin-views/product/edit.blade.php ENDPATH**/ ?>