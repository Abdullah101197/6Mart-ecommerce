...
<?php $__env->startSection('title',translate('messages.Category Bulk Export')); ?>
    ...
    <div class="content container-fluid">
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span>
                    <?php echo e(translate('messages.export_categories')); ?>
        ...
        <div class="card rest-part">
            <div class="card-body">
                ...
                <form class="product-form" action="<?php echo e(route('admin.category.bulk-export')); ?>" method="POST"
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="btn--container justify-content-end">
                                <button class="btn btn--reset" id="reset-btn" type="reset"><?php echo e(translate('messages.clear')); ?></button>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\category\bulk-export.blade.php ENDPATH**/ ?>