    ...
    <div class="content container-fluid">
            ...
            <div class="card-body">
                <div
                    ...
                    <h5 class="text-capitalize m-0">
                        <?php echo e(translate('admin_default_landing_page')); ?>

                        <i class="tio-info-outined" data-toggle="tooltip"
                            title="<?php echo e(translate('You_can_turn_off/on_system-provided_landing_page')); ?>"></i>
                    </h5>
        ...
        <div class="card">
            <div class="card-header flex-wrap border-0">
                <h3 class="card-title">
                    <?php echo e(translate('Want_to_Integrate_Your_Own_Customised_Landing_Page_?')); ?>
                ...
                <div class="text--primary d-flex align-items-center gap-3 font-weight-bolder cursor-pointer"
                    ...
                    <span class="mr-2"><?php echo e(translate('Read_Instructions')); ?></span>
            ...
            <form id="theme_form" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <label class="text-capitalize form-label form--label mb-3">
                        <?php echo e(translate('Integrate_Your_Landing_Page_Via')); ?>

                        <i class="tio-info-outined" data-toggle="tooltip"
                            title="<?php echo e(translate('You_can_upload_your_landing_page_either_using_URL_or_File_Upload')); ?>"></i>
                    </label>
                    <div class="mb-30">
                        <div class="resturant-type-group border d-inline-flex">
                            <label class="form-check form--check mr-2 mr-md-4">
                                <input class="form-check-input" type="radio" value="url" name="landing_integration_via"
                                    <?php echo e($landing_integration_type == 'url' ? 'checked' : ''); ?>>
                            ...
                            <label class="form-check form--check mr-2 mr-md-4">
                                <input class="form-check-input" type="radio" value="file_upload"
                                    ...
                                    <?php echo e($landing_integration_type == 'file_upload' ? 'checked' : ''); ?>>
                                <span class="form-check-label">
                            ...
                            <label class="form-check form--check mr-2 mr-md-4">
                                <input class="form-check-input" type="radio" value="none" name="landing_integration_via"
                                    <?php echo e($landing_integration_type == 'none' ? 'checked' : ''); ?>>
                                <span class="form-check-label">
                    ...
                    <div class="mb-30">
                        ...
                        <div class="__input-tab <?php echo e($landing_integration_type == 'file_upload' ? 'active' : ''); ?>"
                            id="file_upload">
                            <div class="__bg-F8F9FC-card">
                                <div class="form-group mb-0 pb-2">
                                    <div class="row g-3">
                                        <div class="col-sm-6 col-lg-5 col-xl-4 col-xxl-3">
                                            ...
                                            <div class="mt-5 card px-3 py-2 d--none" id="progress-bar">
                                                <div class="d-flex flex-wrap align-items-center gap-3">
                                                    <div class="">
                                                        <img width="24"
                                                            src="<?php echo e(asset('/public/assets/admin/img/zip.png')); ?>"
                                                            alt="">
                                                    </div>
                                        ...
                                        <div class="col-sm-6 col-lg-5 col-xl-4 col-xxl-9">
                                            <div class="pl-sm-5">
                                                <h3 class="mb-3 d-flex"><?php echo e(translate('instructions')); ?></h3>
                                                <ul class="pl-3 d-flex flex-column gap-2 instructions-list mb-0">
                                                    <li>
                                                        <?php echo e(translate('Upload_content_as_a_single_ZIP_file_and_the_file_name_must_be')); ?>
                                    ...
                                    <div class="card theme-card">
                                        <div class="card-body d-flex justify-content-between">
                                            ...
                                            <a class="btn action-btn btn--danger btn-outline-danger border-0 form-alert"  href="javascript:"
                                               data-id="index_page"
                                               data-message="<?php echo e(translate('Want to delete this index_page ?')); ?>" title="<?php echo e(translate('messages.delete_index_page')); ?>"><i class="tio-delete-outlined"></i>
                                        </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="__bg-F8F9FC-card">
                                ...
                                <?php if(isset($config) && $config): ?>
                                    <div class="text-center max-w-595 mx-auto py-4">
                                        <img src="<?php echo e(asset('/public/assets/admin/img/landing-icon-2.png')); ?>"
                                            class="mb-3" alt="">
                                        <p class="m-0">
                                            <?php echo e(translate('Currently_you_are_using_6amMart_Default_Admin_Landing_Page_Theme.')); ?>

                                            <a href="<?php echo e(route('home')); ?>"
                                                class="text--primary text-underline"><?php echo e(translate('Visit_Landing_Page')); ?></a>
                                        </p>
                                    </div>
                                <?php else: ?>
                                    <div class="text-center max-w-487 mx-auto py-4">
                                        <img src="<?php echo e(asset('/public/assets/admin/img/landing-icon-2.png')); ?>"
                                            class="mb-3" alt="">
                                        <p class="m-0">
                                            <?php echo e(translate('You_have_no_business_landing_page_to_show._If_user_search_landing_page_URL_they_will_see_404_page.')); ?>
                    ...
                    <div class="btn--container justify-content-end mt-20">
                        ...
                        <button type="button"  class="btn btn--primary <?php echo e(getEnvMode() == 'demo' ? 'call-demo' : 'zip-upload'); ?>" id="update_setting">
                        ...
                        <div class="item">
                            <div class="mb-20">
                                <div class="text-center">
                                    <img src="<?php echo e(asset('/public/assets/admin/img/read-instructions.png')); ?>"
                                        alt="" class="mb-20">
...
<?php $__env->startPush('script_2'); ?>
            <script src="<?php echo e(asset('public/assets/admin/js/view-pages/business-settings-landing-page.js')); ?>"></script>
            <script href="<?php echo e(asset('public/assets/admin/vendor/swiper/swiper-bundle.min.js')); ?>"></script>
