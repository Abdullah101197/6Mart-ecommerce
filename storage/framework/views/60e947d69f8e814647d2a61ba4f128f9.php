...
<?php $__env->startSection('title','Advertisement Create'); ?>


<?php $__env->startSection('advertisement'); ?>
active
<?php $__env->stopSection(); ?>
<?php $__env->startSection('advertisement_create'); ?>
active
<?php $__env->stopSection(); ?>
...
<div class="content container-fluid">
    ...
    <h1 class="page-header-title mb-3">
        <?php echo e(translate('Create_Advertisement')); ?>
                    ...
                    <div class="col-lg-6">
                        ...
                        <?php $__currentLoopData = $language; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="mb-20">
                                ...
                                <input type="text" class="form-control" id="title" name="title[]"
                                    value="<?php echo e(old('title.0')); ?>" placeholder="<?php echo e(translate('Exclusive_Offer')); ?>" maxlength="255"
                            ...
                            <div class="form-floating mb-20">
                                ...
                                <textarea class="form-control resize-none" id="description"
                                    ...
                                    data-preview-text="preview-description"><?php echo e(old('description.0')); ?></textarea>
                                </div>
                        ...
                        <div class="mb-20">
                            <select class="form-control w-100 js-select2-custom" name="priority">
                                <option value="" selected="" disabled=""><?php echo e(translate('Priority')); ?></option>
                                <option value=""><?php echo e(translate('messages.N/A')); ?></option>
                        ...
                        <div class="mb-20">
                            ...
                            <select class="js-select form-control w-100 promotion_type" name="advertisement_type">
                                <option value="video_promotion"><?php echo e(translate('Video_Promotion')); ?></option>
                                <option value="store_promotion" selected=""><?php echo e(translate('store_promotion')); ?></option>
                            </select>
                        </div>
                        <div class="mb-20">
                                ...
                                <div class="d-flex flex-column align-items-center gap-3 flex-shrink-0">
                                    ...
                                    <div class="upload-file">
                                        ...
                                        <div class="upload-file__img">
                                            <img src="<?php echo e(asset('assets/admin/img/media/upload-file.png')); ?>" alt="" >
                                        </div>
                                        <button class="remove-file-button" type="button">
                                            <i class="tio-clear"></i>
                                        </button>
                                ...
                                <div class="d-flex flex-column align-items-center gap-3">
                                    ...
                                    <div class="upload-file">
                                        ...
                                        <div class="upload-file__img upload-file__img_banner aspect-2-1">
                                            <img src="<?php echo e(asset('assets/admin/img/media/banner-upload-file.png')); ?>" alt="" >
                                        </div>
                                        <button class="remove-file-button" type="button">
                                            <i class="tio-clear"></i>
                                        </button>
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex flex-column gap-2 flex-grow-1">
                                                    <div class="preview-title w-100">
                                                        <h5 class="main-text pe-4"><?php echo e(translate('Title')); ?></h5>
                                                        <div class="placeholder-text bg--secondary p-2 w-50"></div>
                                                    </div>
                                                    <div class="preview-description w-100">
                                                        <div class="main-text line-limit-2"><?php echo e(translate('messages.Description')); ?>
...
<script>
            $(document).on('ready', function() {
                ...
                $('#create-add-form').on('submit', function (event) {
                    ...
                    $.post({
                        url: '<?php echo e(route('admin.advertisement.store')); ?>',
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\advertisement\create.blade.php ENDPATH**/ ?>