    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                <?php echo e(translate('Send Mail on Refund Order ?')); ?>

                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('Customers_will_get_an_automated_email_when_they_receive_a_refund_to_their_wallet_from_Admin_with_refund_details.')); ?>">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                ...
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-title-on="<?php echo e(translate('Want_to_enable_Refund_Order_mail?')); ?>"
                                       data-title-off="<?php echo e(translate('Want_to_disable_Refund_Order_mail?')); ?>"
                                       data-text-on="<p><?php echo e(translate('If_enabled,_Customers_will_get_an_automated_email_when_they_receive_a_refund.')); ?></p>"
                                       data-text-off="<p><?php echo e(translate('If_disabled,_Customers_will_not_receive_any_mail_on_Refund_Orders.')); ?></p>"
                        ...
                        <form action="<?php echo e(route('admin.business-settings.email-status',['user','refund-order',$mail_status == '1'?0:1])); ?>" method="get" id="mail-status_form">
                                            </form>
                    </div>
                </div>
                ...
                <form action="<?php echo e(route('admin.business-settings.email-setup', ['user','refund-order'])); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\business-settings\email-format-setting\user-email-formats\refund-order-format.blade.php ENDPATH**/ ?>