...
<?php $__env->startSection('title', translate('add_Offline_Payment_Method')); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content">
        <form action="<?php echo e(route('admin.business-settings.offline.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center gap-3 flex-wrap mb-3">
                    <div>
                        <h2 class="h1 mb-1 text-capitalize">
                            <?php echo e(translate('Add_Offline_Payment_Method')); ?>
                ...
                <div class="card card-body mb-20">
                    ...
                    <div class="__bg-F8F9FC-card mb-20">
                        ...
                        <input type="text" class="form-control text-break" id="method_name" placeholder="<?php echo e(translate('ex:_bkash')); ?>" name="method_name" required>
                    </div>
                ...
                <div class="card card-body">
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-20">
                        <div class="">
                            <h3 class="mb-1"><?php echo e(translate('messages.Information Required From Customer')); ?></h3>
                            <p class="fs-12 mb-0">
                                <?php echo e(translate('messages.Specify the data you need from customers when they choose this offline payment method.')); ?>
                    ...
                    <div class="__bg-F8F9FC-card mb-20">
                        <label for="payment_note" class="input-label text-capitalize d-flex gap-1 align-items-center"><?php echo e(translate('Payment Note')); ?> </label>
                        <div class="form-floating">
                            <textarea class="form-control" name="payment_note" id="payment_note"
                                placeholder="<?php echo e(translate('Ex: Miler')); ?>"  disabled></textarea>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row g-3">
                                <div class="col-md-4">
                                    <div class="form-group mb-0">
                                        <label><?php echo e(translate('Input field Name')); ?></label>
                                        <input type="text" class="form-control" name="customer_input[${counter}]"
                                        placeholder="<?php echo e(translate('ex')); ?>: <?php echo e(translate('payment_By')); ?>" value="" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group mb-0">
                                        <label><?php echo e(translate('Placeholder')); ?></label>
                                        <input type="text" class="form-control" name="customer_placeholder[${counter}]"
                                        placeholder="<?php echo e(translate('ex')); ?>: <?php echo e(translate('Enter Name')); ?>" value="" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group mb-0 h-100">
                                        <div class="d-flex justify-content-between gap-2 h-100">
                                            ...
                                            <label class="form-check-label" for="flexCheckDefault__${counter}">
                                                <?php echo e(translate('is_required_?')); ?>
                ...
                if(counterPayment < 14) {
                    ...
                    $('#custom-field-section-payment').append(
                        `<div id="field-row-payment--${counterPayment}" class="__bg-F8F9FC-card field-row-payment">
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-0">
                                    <label for="input_data" class="input-label"><?php echo e(translate('Input data')); ?></label>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\business-settings\offline-payment\new.blade.php ENDPATH**/ ?>