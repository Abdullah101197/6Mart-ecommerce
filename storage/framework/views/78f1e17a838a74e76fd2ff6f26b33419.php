          ...
          <div class="np-card">
            ...
            <div class="np-card-body">
              ...
              <label class="d-inline-block m-0 position-relative error-wrapper">
                ...
                <img class="img--176 border" id="viewer" src="<?php echo e($npThumb); ?>"
                  alt="thumbnail">
                <div class="icon-file-group">
                  <div class="icon-file">
                    <input type="file" name="image" id="customFileEg1" class="custom-file-input d-none"
                      accept="<?php echo e(IMAGE_EXTENSION); ?>" <?php echo e($isEdit && filled($product?->image) ? '' : 'required'); ?>>
                    <i class="tio-edit"></i>
                  </div>
                </div>
              </label>
            ...
            <div class="np-card-body">
              ...
              <div class="np-upload-zone" id="npUploadZone" onclick="document.getElementById('npFileInput').click()"
                ...
                <div class="np-upload-sub" style="margin-top:5px;font-size:11px;color:#b0bec5">First image = main
                  gallery image</div>
                <input type="file" id="npFileInput" name="images[]" multiple accept="<?php echo e(IMAGE_EXTENSION); ?>" style="display:none"
          ...
          <div class="np-card">
            ...
            <div class="np-card-body">
              <div class="np-form-group"><label class="np-label">Video URL (YouTube / Vimeo)</label><input type="url"
                  ...
                  value="<?php echo e(old('meta_data.video_url', data_get($npMeta,'video_url',''))); ?>"></div>
              <div class="np-form-group" style="margin-bottom:0"><label class="np-label">Video Title</label><input
                  ...
                  value="<?php echo e(old('meta_data.video_title', data_get($npMeta,'video_title',''))); ?>"></div>
            </div>
          </div>
          <div class="np-card">
            ...
            <div class="np-card-body">
              <div class="np-form-group"><label class="np-label">Product Datasheet URL</label><input type="url"
                  ...
                  value="<?php echo e(old('meta_data.datasheet_url', data_get($npMeta,'datasheet_url',''))); ?>"></div>
              <div class="np-form-group"><label class="np-label">Certificate of Analysis</label><input type="url"
                  ...
                  value="<?php echo e(old('meta_data.cert_url', data_get($npMeta,'cert_url',''))); ?>"></div>
              <div class="np-form-group" style="margin-bottom:0"><label class="np-label">User Manual / Recipe
                  ...
                  value="<?php echo e(old('meta_data.manual_url', data_get($npMeta,'manual_url',''))); ?>"></div>
            </div>
          </div>
        </div>
        <div>
          ...
          <div class="np-card">
            ...
            <div class="np-card-body">
              ...
              <div class="np-trow" style="padding-top:0">
                ...
                </div><label class="np-tog"><input type="checkbox" name="meta_data[enable_360]" value="1" <?php if($np360): echo 'checked'; endif; ?>><span
                    class="np-tog-track"></span></label>
              </div>
              <div class="np-trow">
                <div>
                ...
                </div><label class="np-tog"><input type="checkbox" name="meta_data[enable_ar]" value="1" <?php if($npAR): echo 'checked'; endif; ?>><span
                    class="np-tog-track"></span></label>
              </div>
              <div class="np-form-group" style="margin-top:14px;margin-bottom:0"><label class="np-label">3D Model File
                  ...
                  value="<?php echo e(old('meta_data.model_3d_url', data_get($npMeta,'model_3d_url',''))); ?>"></div>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="np-card-body">
              ...
              <div class="np-inco-grid">
                <?php $__currentLoopData = ['EXW' => 'Ex Works', 'FCA' => 'Free Carrier', 'CPT' => 'Carriage Paid To', 'CIP' => 'Carriage & Ins. Paid', 'FOB' => 'Free On Board', 'CFR' => 'Cost & Freight', 'CIF' => 'Cost, Ins. & Freight', 'DPU' => 'Delivered at Place Unloaded', 'DAP' => 'Delivered at Place', 'DDP' => 'Delivered Duty Paid', 'FAS' => 'Free Alongside Ship', 'DAT' => 'Delivered at Terminal']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <div class="np-inco-pill <?php echo e($v ? 'sel' : ''); ?>" onclick="npToggleIncoterm(this)"><?php echo e($code); ?><span
                      class="np-inco-sub"><?php echo e($label); ?></span>
                    <input type="hidden" name="meta_data[<?php echo e($k); ?>]" value="<?php echo e($vLegacy ? '1' : '0'); ?>">
                    <input type="checkbox" class="d-none" name="meta_data[incoterms][]" value="<?php echo e($code); ?>" <?php if($v): echo 'checked'; endif; ?>>
                  </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php $__currentLoopData = $npIncotermsCustom; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <?php ($code = is_string($code) ? strtoupper(trim($code)) : ''); ?>
                  <?php if(filled($code)): ?>
                    <?php ($v = in_array($code, $npIncoterms)); ?>
                    <div class="np-inco-pill <?php echo e($v ? 'sel' : ''); ?>" onclick="npToggleIncoterm(this)"><?php echo e($code); ?>

                      <input type="hidden" name="meta_data[incoterms_custom][]" value="<?php echo e($code); ?>">
                      <input type="checkbox" class="d-none" name="meta_data[incoterms][]" value="<?php echo e($code); ?>" <?php if($v): echo 'checked'; endif; ?>>
                    </div>
                  <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="np-card-body">
              <div class="np-chk-grid">
                <?php $__currentLoopData = [
                  ...
                  <label class="np-chk-item <?php echo e(in_array($key,$npShip) ? 'on' : ''); ?>"><input type="checkbox" name="meta_data[ship][]"
                      value="<?php echo e($key); ?>" <?php if(in_array($key,$npShip)): echo 'checked'; endif; ?>> <?php echo e($label); ?></label>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php $__currentLoopData = $npShipCustom; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <?php ($nm = is_string($nm) ? trim($nm) : ''); ?>
                  <?php if(filled($nm)): ?>
                    <?php ($val = 'custom:' . $nm); ?>
                    <label class="np-chk-item <?php echo e(in_array($val,$npShip) ? 'on' : ''); ?>"><input type="checkbox" name="meta_data[ship][]"
                        value="<?php echo e($val); ?>" <?php if(in_array($val,$npShip)): echo 'checked'; endif; ?>> <?php echo e($nm); ?></label>
                    <input type="hidden" name="meta_data[ship_custom][]" value="<?php echo e($nm); ?>">
                  <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </div>
              <div class="np-form-row" style="margin-top:12px;align-items:center">
              ...
              <div class="np-form-row">
                <div class="np-form-group" style="margin-bottom:0"><label class="np-label">Preferred
                    ...
                    placeholder="e.g. DHL, FedEx, Aramex" value="<?php echo e(old('meta_data.preferred_carrier', data_get($npMeta,'preferred_carrier',''))); ?>"></div>
                <div class="np-form-group" style="margin-bottom:0"><label class="np-label">Port of Loading</label><input
                    ...
                    value="<?php echo e(old('meta_data.port_of_loading', data_get($npMeta,'port_of_loading',''))); ?>">
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="np-form-row">
                <div class="np-form-group"><label class="np-label">Free Shipping Threshold</label>
                  <div class="np-iw"><span
                      ...
                      value="<?php echo e(old('meta_data.free_ship_threshold', data_get($npMeta,'free_ship_threshold',''))); ?>"></div>
                </div>
                <div class="np-form-group"><label class="np-label">Standard Shipping Fee</label>
                  <div class="np-iw"><span
                      ...
                      value="<?php echo e(old('meta_data.std_ship_fee', data_get($npMeta,'std_ship_fee',''))); ?>"></div>
                </div>
              </div>
              <div class="np-form-row">
                <div class="np-form-group" style="margin-bottom:0"><label class="np-label">Express Shipping Fee</label>
                  <div class="np-iw"><span
                      ...
                      value="<?php echo e(old('meta_data.exp_ship_fee', data_get($npMeta,'exp_ship_fee',''))); ?>"></div>
                </div>
                <div class="np-form-group" style="margin-bottom:0"><label class="np-label">International Shipping
                  ...
                  <div class="np-iw"><span
                      ...
                      value="<?php echo e(old('meta_data.intl_ship_fee', data_get($npMeta,'intl_ship_fee',''))); ?>"></div>
                </div>
              </div>
            </div>
          </div>
                ...
                <?php for($i=0;$i<$whRows;$i++): ?>
                  <div class="np-form-row" style="align-items:center;margin-bottom:10px">
                    ...
                    <select name="meta_data[wh_status][]" class="np-select"
                      ...
                      <option value="Active" <?php if($st==='Active'): echo 'selected'; endif; ?>>Active</option>
                      <option value="Inactive" <?php if($st==='Inactive'): echo 'selected'; endif; ?>>Inactive</option>
                    </select>
            ...
            <div class="np-card-body">
              <div class="np-form-group">
                ...
                <select name="meta_data[dangerous_goods]" id="npDangerousGoods" class="np-select js-select2-custom">
                  ...
                  <?php if(\Illuminate\Support\Facades\Schema::hasTable('product_select_options')): ?>
                    <?php $__currentLoopData = \App\Models\ProductSelectOption::where('type','dangerous_goods')->where(function($q){ $q->whereNull('module_id')->orWhere('module_id', \Illuminate\Support\Facades\Config::get('module.current_module_id')); })->orderBy('name')->get(['id','name']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($opt->name); ?>" <?php if($savedDG == $opt->name): echo 'selected'; endif; ?>><?php echo e($opt->name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  <?php else: ?>
                    <?php $__currentLoopData = ['Not Dangerous','Class 1 — Explosives','Class 2 — Gases','Class 3 — Flammable Liquids','Class 4 — Flammable Solids','Class 8 — Corrosives','Class 9 — Miscellaneous']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($v); ?>" <?php if($savedDG == $v): echo 'selected'; endif; ?>><?php echo e($v); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  <?php endif; ?>
                </select>
              </div>
              <div class="np-form-row">
                <div class="np-form-group" style="margin-bottom:0">
                  ...
                  <select name="meta_data[air_restriction]" id="npAirRestriction" class="np-select js-select2-custom">
                    ...
                    <?php if(\Illuminate\Support\Facades\Schema::hasTable('product_select_options')): ?>
                      <?php $__currentLoopData = \App\Models\ProductSelectOption::where('type','air_restriction')->where(function($q){ $q->whereNull('module_id')->orWhere('module_id', \Illuminate\Support\Facades\Config::get('module.current_module_id')); })->orderBy('name')->get(['id','name']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($opt->name); ?>" <?php if($savedAir == $opt->name): echo 'selected'; endif; ?>><?php echo e($opt->name); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php else: ?>
                      <?php $__currentLoopData = ['No restriction','Cargo aircraft only','Prohibited']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($v); ?>" <?php if($savedAir == $v): echo 'selected'; endif; ?>><?php echo e($v); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
                  </select>
                </div>
                <div class="np-form-group" style="margin-bottom:0">
                  ...
                  <select name="meta_data[temp_controlled]" id="npTempControlled" class="np-select js-select2-custom">
                    ...
                    <?php if(\Illuminate\Support\Facades\Schema::hasTable('product_select_options')): ?>
                      <?php $__currentLoopData = \App\Models\ProductSelectOption::where('type','temp_controlled')->where(function($q){ $q->whereNull('module_id')->orWhere('module_id', \Illuminate\Support\Facades\Config::get('module.current_module_id')); })->orderBy('name')->get(['id','name']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($opt->name); ?>" <?php if($savedTemp == $opt->name): echo 'selected'; endif; ?>><?php echo e($opt->name); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php else: ?>
                      <?php $__currentLoopData = ['Not required','Chilled (2–8°C)','Frozen (−18°C)']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($v); ?>" <?php if($savedTemp == $v): echo 'selected'; endif; ?>><?php echo e($v); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
                  </select>
                </div>
            ...
            <div class="np-card-body">
              <div class="np-form-group"><label class="np-label">Primary Export Regions</label>
                <div class="np-chk-grid">
                  <?php $__currentLoopData = [
                    ...
                    <label class="np-chk-item <?php echo e(in_array($key,$npExport) ? 'on' : ''); ?>"><input type="checkbox" name="meta_data[export][]"
                        value="<?php echo e($key); ?>" <?php if(in_array($key,$npExport)): echo 'checked'; endif; ?>> <?php echo e($label); ?></label>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  <?php $__currentLoopData = $npExportCustom; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php ($nm = is_string($nm) ? trim($nm) : ''); ?>
                    <?php if(filled($nm)): ?>
                      <?php ($val = 'custom:' . $nm); ?>
                      <label class="np-chk-item <?php echo e(in_array($val,$npExport) ? 'on' : ''); ?>"><input type="checkbox" name="meta_data[export][]"
                          value="<?php echo e($val); ?>" <?php if(in_array($val,$npExport)): echo 'checked'; endif; ?>> <?php echo e($nm); ?></label>
                      <input type="hidden" name="meta_data[export_custom][]" value="<?php echo e($nm); ?>">
                    <?php endif; ?>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                <div class="np-form-row" style="margin-top:12px;align-items:center">
              ...
              <div class="np-form-group" style="margin-bottom:0"><label class="np-label">Restricted Countries</label>
                <div class="np-tag-wrap" id="npRestrictWrap" onclick="this.querySelector('input').focus()">
                  <?php $__currentLoopData = $npRestricted; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php ($t = is_string($t) ? trim($t) : ''); ?>
                    <?php if(filled($t)): ?>
                      <span class="np-tag t-orange"><?php echo e($t); ?> <span class="np-tag-rm" onclick="this.parentElement.remove()">×</span><input type="hidden" name="meta_data[restricted_countries][]" value="<?php echo e($t); ?>"></span>
                    <?php endif; ?>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          ...
          <div class="np-card" data-np-section="np-tab-logistics.customs_import">
            ...
            <div class="np-card-body">
              <div class="np-form-group"><label class="np-label">HS Tariff Code</label><input type="text"
                  ...
                  value="<?php echo e(old('meta_data.hs_tariff', data_get($npMeta,'hs_tariff',''))); ?>"></div>
              <div class="np-form-group"><label class="np-label">Customs Description</label><input type="text"
                  ...
                  value="<?php echo e(old('meta_data.customs_desc', data_get($npMeta,'customs_desc',''))); ?>"></div>
              <div class="np-form-row">
                <div class="np-form-group" style="margin-bottom:0"><label class="np-label">Import Duty Rate</label>
                  <div class="np-iw sfx"><input type="number" name="meta_data[import_duty]" class="np-input"
                      placeholder="5" step="0.1" value="<?php echo e(old('meta_data.import_duty', data_get($npMeta,'import_duty',''))); ?>"><span class="np-isfx">%</span></div>
                </div>
                <div class="np-form-group" style="margin-bottom:0"><label class="np-label">VAT / GST Rate</label>
                  <div class="np-iw sfx"><input type="number" name="meta_data[vat_rate]" class="np-input"
                      placeholder="5" step="0.1" value="<?php echo e(old('meta_data.vat_rate', data_get($npMeta,'vat_rate',''))); ?>"><span class="np-isfx">%</span></div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="np-card-body">
              <div class="np-form-row">
                <div class="np-form-group"><label class="np-label">Units per Carton</label><input type="number"
                    ...
                    value="<?php echo e(old('meta_data.units_per_carton', data_get($npMeta,'units_per_carton',''))); ?>"></div>
                <div class="np-form-group"><label class="np-label">Cartons per Pallet</label><input type="number"
                    ...
                    value="<?php echo e(old('meta_data.cartons_per_pallet', data_get($npMeta,'cartons_per_pallet',''))); ?>"></div>
              </div>
              <div class="np-form-row">
                <div class="np-form-group"><label class="np-label">Carton Length</label>
                  <div class="np-iw sfx"><input type="number" name="meta_data[carton_l]" class="np-input"
                      placeholder="0.0" value="<?php echo e(old('meta_data.carton_l', data_get($npMeta,'carton_l',''))); ?>"><span class="np-isfx">cm</span></div>
                </div>
                <div class="np-form-group"><label class="np-label">Carton Width</label>
                  <div class="np-iw sfx"><input type="number" name="meta_data[carton_w]" class="np-input"
                      placeholder="0.0" value="<?php echo e(old('meta_data.carton_w', data_get($npMeta,'carton_w',''))); ?>"><span class="np-isfx">cm</span></div>
                </div>
              </div>
              <div class="np-form-row">
                <div class="np-form-group" style="margin-bottom:0"><label class="np-label">Carton Height</label>
                  <div class="np-iw sfx"><input type="number" name="meta_data[carton_h]" class="np-input"
                      placeholder="0.0" value="<?php echo e(old('meta_data.carton_h', data_get($npMeta,'carton_h',''))); ?>"><span class="np-isfx">cm</span></div>
                </div>
                <div class="np-form-group" style="margin-bottom:0"><label class="np-label">Carton Gross Weight</label>
                  <div class="np-iw sfx"><input type="number" name="meta_data[carton_kg]" class="np-input"
                      placeholder="0.0" value="<?php echo e(old('meta_data.carton_kg', data_get($npMeta,'carton_kg',''))); ?>"><span class="np-isfx">kg</span></div>
                </div>
              </div>
            </div>
          </div>
          <div class="np-card" data-np-section="np-tab-logistics.quality_inspection">
            ...
            <div class="np-card-body" style="padding:6px 20px 12px">
              ...
              <div class="np-trow" style="padding-top:8px">
                <div>
                  ...
                  <div class="np-tdsc">Third-party QC before dispatch</div>
                    ...
                    <?php if($preShip): echo 'checked'; endif; ?>><span class="np-tog-track"></span></label>
              </div>
              <div class="np-trow">
                <div>
                  <div class="np-tlbl">Lab Testing Available</div>
                  <div class="np-tdsc">SGS / Intertek / Bureau Veritas</div>
                </div><label class="np-tog"><input type="checkbox" name="meta_data[lab_testing]" value="1" <?php if($labTest): echo 'checked'; endif; ?>><span
                    class="np-tog-track"></span></label>
              </div>
              <div class="np-trow">
                <div>
                  ...
                  <div class="np-tdsc">Available on request</div>
                    ...
                    <?php if($factoryAudit): echo 'checked'; endif; ?>><span class="np-tog-track"></span></label>
              </div>
              <div class="np-form-group" style="margin-top:14px;margin-bottom:0"><label class="np-label">Inspection
                  ...
                  value="<?php echo e(old('meta_data.inspection_agency', data_get($npMeta,'inspection_agency',''))); ?>"></div>
            </div>
          </div>
        </div>
      </div>
  ...
  <script>
    ...
    $(document).ready(function () {
      ...
      try {
        const isEdit = <?php echo e($isEdit ? 'true' : 'false'); ?>;
        if (isEdit) {
          const existing = <?php echo json_encode(is_array($product?->images) ? $product->images : []); ?>;
          const existingUrls = <?php echo json_encode(is_array($product?->images_full_url) ? $product->images_full_url : []); ?>;
          const alts = <?php echo json_encode(is_array(old('alt_text', data_get($npMeta,'alt_text', []))) ? old('alt_text', data_get($npMeta,'alt_text', [])) : []); ?>;
          if (Array.isArray(existing) && existing.length) {
            npImgs = existing.map((v, idx) => {
              const img = (v && typeof v === 'object') ? (v.img || '') : (v || '');
              const url = (Array.isArray(existingUrls) && existingUrls[idx]) ? String(existingUrls[idx]) : ("<?php echo e(\App\CentralLogics\Helpers::get_full_url('product', '___IMG___', 'public')); ?>".replace('___IMG___', img));
