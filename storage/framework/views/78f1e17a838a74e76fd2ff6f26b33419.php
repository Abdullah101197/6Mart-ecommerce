          ...
          <div class="np-card">
            ...
            <div class="np-card-body">
              <div class="np-form-group">
                <label class="np-label"><?php echo e(translate('messages.item_name')); ?> (<?php echo e(translate('messages.default')); ?>)
              ...
              <div class="np-form-row">
                ...
                <div class="np-form-group">
                  ...
                  <select name="category_id" id="category_id" class="np-select js-select2-custom"
                    ...
                    <?php $__currentLoopData = \App\Models\Category::where('position', 0)->where('status', 1)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  ...
  <script>
    ...
    $(document).ready(function () {
      ...
      $('#category_id').on('change', function () {
        ...
        $.get('<?php echo e(url("admin/category/get-sub-categories/")); ?>/' + id, function (data) {
