                        ...
                        <div class="col-xxl-3 col-lg-4 col-md-5 col-sm-6">
                            <div
                                ...
                                <label class="toggle-switch toggle-switch-sm">
                                    <input type="checkbox" class="status toggle-switch-input maintenance-mode" <?php echo e(isset($config) && $config ? 'checked' : ''); ?>>
            ...
            <div class="row g-3">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="p-xxl-20 p-xl-3 p-2 bg-white">
                                        <div class="row g-3">
                                            <div class="col-sm-6 col-md-6">
                                                <div class="form-group mb-0">
                                                    <label class="form-label"
                                                        for="store_name"><?php echo e(translate('messages.company_name')); ?> <span
                                                            class="text-danger">*</span></label>
                                                    <input id="store_name" type="text" name="store_name"
                                                        value="<?php echo e($name->value ?? ''); ?>" class="form-control"
                                                        placeholder="<?php echo e(translate('messages.new_company')); ?>" required>
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-md-6">
                                                <?php ($email = \App\Models\BusinessSetting::where('key', 'email_address')->first()); ?>
                                                <div class="form-group mb-0">
                                                    <label class="form-label" for="email"><?php echo e(translate('messages.email')); ?>

                                                        <span class="text-danger">*</span></label>
                                                    <input id="email" type="email" value="<?php echo e($email->value ?? ''); ?>"
                                                        name="email" class="form-control"
                                                        placeholder="<?php echo e(translate('messages.Ex_:_ex@example.com')); ?>"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-md-6">
                                                ...
                                                <div class="form-group mb-0">
                                                    <label class="form-label" for="phone"><?php echo e(translate('messages.phone')); ?>

                                                    </label>
                                                    <input type="tel" value="<?php echo e($phone->value ?? ''); ?>" id="phone"
                                                        name="phone" class="form-control"
                                                        placeholder="<?php echo e(translate('messages.Ex: +3264124565')); ?>" required>
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-md-6">
                                                <div class="form-group mb-0">
                                                    <label class="form-label text-capitalize"
                                                        for="country"><?php echo e(translate('messages.country')); ?> <span
                                                            class="text-danger">*</span></label>
                                            ...
                                            <div class="col-sm-12 col-md-12">
                                                ...
                                                <div class="form-group mb-0">
                                                    <label class="form-label"
                                                        for="address"><?php echo e(translate('messages.address')); ?> <span
                                                    ...
                                                    <textarea type="text" id="address" name="address" class="form-control"
                                                        placeholder="<?php echo e(translate('messages.Ex: address')); ?>" rows="1"
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="form-group mb-0">
                                                                <input type="text" name="longitude"
                                                                    class="w-auto border-0 p-0 m-0 text-center"
                                                                    placeholder="<?php echo e(translate('messages.Ex:')); ?> 103.344322"
                                                                    id="longitude"
                                ...
                                <div class="col-lg-4 shadow-sm">
                                    <div class="d-flex flex-column gap-4 shadow-sm h--37px">
                                        <div class="bg-light2 rounded p-20">
                                            <div class="mb-15">
                                                <h4 class="mb-1"><?php echo e(translate('Upload Logo')); ?> </h4>
                                        ...
                                        <div class="bg-light2 rounded p-20">
                                            <div class="text-start">
                                                <div class="mb-15">
                                                    <h4 class="mb-1"><?php echo e(translate('Favicon')); ?> </h4>
                                                    <p class="mb-0 fs-12 gray-dark">
                            ...
                            <div class="info-notes-bg px-3 py-2 rounded fz-11  gap-2 align-items-center d-flex mt-20">
                                <img src="<?php echo e(asset('public/assets/admin/img/info-idea.svg')); ?>" alt="">
                                <span>
                        ...
                        <div class="card-body py-xxl-4 py-3 px-xxl-4 px-lg-3 px-0">
                            <div class="shadow-sm p-xxl-20 p-xl-3 p-2 bg-white mb-20">
                                <div class="mb-20">
                                    ...
                                    <p class="mb-0 fs-12">
                                        <?php echo e(translate('Vendor Logo & Covers')); ?>
                                        ...
                                        <div class="col-sm-6 col-md-4 col-xl-4">
                                            ...
                                            <div class="form-group mb-0">
                                                <label class="input-label d-flex align-items-center gap-1">
                                                    <?php echo e(translate('messages.time_zone')); ?>
                                        ...
                                        <div class="col-sm-6 col-md-4 col-xl-4">
                                            ...
                                            <div class="form-group mb-0">
                                                <label for="time_format"
                                                    class="form-label text-capitalize"><?php echo e(translate('messages.time_format')); ?>
                                                ...
                                                <div class="resturant-type-group bg-white border">
                                                    <label class="form-check form--check mr-2 mr-md-4">
                                                        <input class="form-check-input" type="radio" value="12"
                                                            name="time_format" <?php echo e($tf == '12' ? 'checked' : ''); ?>>
                                                    ...
                                                    <label class="form-check form--check mr-2 mr-md-4">
                                                        <input class="form-check-input" type="radio" value="24"
                                                            name="time_format" <?php echo e($tf == '24' ? 'checked' : ''); ?>>
                                                        <span class="form-check-label">
                                        ...
                                        <div class="col-sm-6 col-md-4 col-xl-4">
                                            ...
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="number" name="digit_after_decimal_point" class="form-control"
                                                    ...
                                                    placeholder="<?php echo e(translate('messages.ex_:_2')); ?>"
                                                        ...
                                                        <div class="form-group">
                                                            <div class="custom-control custom-checkbox">
                                                                ...
                                                                <label class="custom-control-label" for="subs">
                                                                    ...
                                                                    <p class="mb-0 fs-12">
                                                                        <?php echo e(translate('By selecting subscription based business model restaurants can run business with you based on subscription package.')); ?>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="custom-control custom-checkbox">
                                                                ...
                                                                <label class="custom-control-label" for="commission">
                                                                    ...
                                                                    <p class="mb-0 fs-12">
                                                                        <?php echo e(translate('By selecting commission based business model restaurants can run business with you based on commission based payment per order.')); ?>

                                                                    </p>
                                                                    <div
                                                                        class="info-notes-bg px-3 py-2 rounded fz-11  gap-2 d-flex mt-20">
                                                                        <img src="<?php echo e(asset('public/assets/admin/img/info-idea.svg')); ?>"
                                                                            alt="">
                                                                        <span>
                                                                            <?php echo e(translate('To set different commission for commission based restaurants.')); ?>

                                                                            <?php echo e(translate('Go to')); ?>: <span
                                                                                class="fz-12px font-semibold info-dark"><?php echo e(translate('Restaurant List')); ?>

                                                                                > <?php echo e(translate('Restaurant Details')); ?> >
                                                ...
                                                <div class="col-sm-6 col-lg-6">
                                                    ...
                                                    <div class="form-group mb-0">
                                                        <label class="form-label text-capitalize" for="admin_commission">
                                                            ...
                                                            <span class="form-label-secondary" data-toggle="tooltip"
                                                                data-placement="right"
                                                                data-original-title="<?php echo e(translate('messages.Set_up_‘Default_Commission_Rate’_on_every_Order._Admin_can_also_set_store-wise_different_commission_rates_from_respective_store_settings.')); ?>">
                                                                <i class="tio-info text-muted"></i>
                                                            </span>
                                                        </label>
                                                    ...
                                                    <div class="form-group mb-0">
                                                        <label class="input-label text-capitalize d-flex alig-items-center"
                                                            ...
                                                            <span class="form-label-secondary ml-1" data-toggle="tooltip"
                                                                data-placement="right"
                                                                data-original-title="<?php echo e(translate('messages.Set_a_default_‘Commission_Rate’_for_freelance_deliverymen_(under_admin)_on_every_deliveryman. ')); ?>">
                                                                <i class="tio-info text-muted"></i>
                                                            </span>
                                                        </label>
                                                        <input type="number" name="admin_comission_in_delivery_charge"
                                                            class="form-control" id="admin_comission_in_delivery_charge"
                                                            placeholder="<?php echo e(translate('messages.Ex:_10')); ?>" min="0"
                                                            max="100" step="0.01"
                                        ...
                                        <div class="col-sm-6 col-lg-6">
                                            ...
                                            <div class="form-group mb-0">
                                                <label
                                                    ...
                                                    <span
                                                        class="line--limit-1"><?php echo e(translate('messages.additional_charge_name')); ?>
                                                ...
                                                <input type="text" name="additional_charge_name" class="form-control"
                                                    ...
                                                    placeholder="<?php echo e(translate('messages.Ex:_Processing_Fee')); ?>"
                                        ...
                                        <div class="col-sm-6 col-lg-6">
                                            ...
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="number" name="additional_charge" class="form-control"
                                                    ...
                                                    step=".01" <?php echo e(isset($additional_charge_status) ? '' : 'readonly'); ?>>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-6 col-xl-6">
                                            ...
                                            <div class="form-group mb-0">
                                                <label class="form-label"
                                                    ...
                                                    <span class="form-label-secondary" data-toggle="tooltip"
                                                        data-placement="right"
                                                        data-original-title="<?php echo e(translate('messages.make_visitors_aware_of_your_business‘s_rights_&_legal_information.')); ?>">
                                                        <i class="tio-info text-muted"></i>
                                                    </span>
                                                </label>
                                                <textarea type="text" id="footer_text" maxlength="100" name="footer_text"
                                                    class="form-control" rows="3"
                                                    placeholder="<?php echo e(translate('messages.Ex_:_Copyright_Text')); ?>"
                                        ...
                                        <div class="col-md-6 col-xl-6">
                                            ...
                                            <div class="form-group mb-0">
                                                ...
                                                <textarea type="text" id="cookies_text" maxlength="100" name="cookies_text"
                                                    class="form-control " rows="3"
                                                    placeholder="<?php echo e(translate('messages.Ex_:_Cookies_Text')); ?>"
                ...
                <div class="col-lg-12">
                    <h4 class="card-title mb-3 d-flex align-items-center"> <span class="card-header-icon mr-2"><i
                        ...
                        <span><?php echo e(translate('messages.Business_Rules_setup')); ?> </span>
                    </h4>
                    <div class="card">
                        <div class="card-body">
                                                ...
                                                <div class="resturant-type-group border bg-white">
                                                    <label class="form-check form--check">
                                                        <input class="form-check-input" type="radio" value="cod"
                                                            name="partial_payment_method" <?php echo e($partial_payment_method ? ($partial_payment_method->value == 'cod' ? 'checked' : '') : ''); ?>>
                                                        <span class="form-check-label">
                                                    ...
                                                    <label class="form-check form--check">
                                                        <input class="form-check-input" type="radio" value="digital_payment"
                                                            name="partial_payment_method" <?php echo e($partial_payment_method ? ($partial_payment_method->value == 'digital_payment' ? 'checked' : '') : ''); ?>>
                                                        <span class="form-check-label">
                                                    ...
                                                    <label class="form-check form--check">
                                                        <input class="form-check-input" type="radio" value="both"
                                                            name="partial_payment_method" <?php echo e($partial_payment_method ? ($partial_payment_method->value == 'both' ? 'checked' : '') : ''); ?>>
                                                        <span class="form-check-label">
        ...
        <div class="mt-0 footer-sticky">
            <div class="container-fluid">
                <div class="btn--container justify-content-end py-3">
                    <button type="reset" class="btn btn--reset min-w-120px"><?php echo e(translate('messages.reset')); ?></button>
                ...
                <div class="max-349 mx-auto mb-20">
                    <div>
                        <div class="text-center">
                            <img width="80" src="<?php echo e(asset('public/assets/admin/img/modal/currency.png')); ?>"
                                class="mb-20">
                        ...
                        <div class="text-center">
                            ...
                            <div>
                                <p><?php echo e(translate('If_you_enable_this_currency,_you_must_active_at_least_one_digital_payment_method_that_supports_this_currency._Otherwise_customers_cannot_pay_via_digital_payments_from_the_app_and_websites._And_Also_restaurants_cannot_pay_you_digitally')); ?>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views/admin-views/business-settings/business-index.blade.php ENDPATH**/ ?>