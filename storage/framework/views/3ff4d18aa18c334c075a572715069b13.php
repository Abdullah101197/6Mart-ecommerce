            ...
            <div class="row align-items-center py-2">
                <div class="col-sm mb-2 mb-sm-0">
                    <div class="d-flex align-items-center">
                        <img src="<?php echo e(asset('/assets/admin/img/grocery.svg')); ?>" alt="img">
                        <div class="w-0 flex-grow pl-2">
                            <h1 class="page-header-title mb-0"><?php echo e(translate('messages.welcome')); ?>, <?php echo e(auth('admin')->user()->f_name); ?>.</h1>
                            <p class="page-header-text m-0"><?php echo e(translate('messages.welcome_message')); ?></p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row g-2">
                                ...
                                <a class="order--card h-100" href="<?php echo e(route('admin.order.list',['delivered'])); ?>">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                            <img src="<?php echo e(asset('/assets/admin/img/dashboard/food/unassigned.svg')); ?>" alt="dashboard" class="oder--card-icon">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <a class="order--card h-100" href="<?php echo e(route('admin.order.list',['refunded'])); ?>">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                            <img src="<?php echo e(asset('/assets/admin/img/dashboard/food/accepted.svg')); ?>" alt="dashboard" class="oder--card-icon">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <a class="order--card h-100" href="<?php echo e(route('admin.order.list',['canceled'])); ?>">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                            <img src="<?php echo e(asset('/assets/admin/img/dashboard/food/packaging.svg')); ?>" alt="dashboard" class="oder--card-icon">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <a class="order--card h-100" href="<?php echo e(route('admin.order.list',['failed'])); ?>">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                            <img src="<?php echo e(asset('/assets/admin/img/dashboard/food/out-for.svg')); ?>" alt="dashboard" class="oder--card-icon">
        ...
        <div class="row g-2">
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="card h-100" id="top-customer-view">
                    <?php echo $__env->make('admin-views.partials._top-customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
                <!-- End Card -->
            </div>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\dashboard.blade.php ENDPATH**/ ?>