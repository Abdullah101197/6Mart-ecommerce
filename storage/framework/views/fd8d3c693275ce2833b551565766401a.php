    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="forget-pass-content">
            <img src="<?php echo e(asset('/assets/admin/img/send-mail.svg')); ?>" alt="">
            <!-- After Succeed -->
            <h4>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="forget-pass-content">
            <img src="<?php echo e(asset('/assets/admin/img/send-mail.svg')); ?>" alt="">
            <!-- After Succeed -->
            <!-- <img src="<?php echo e(asset('/assets/admin/img/sent-mail.svg')); ?>" alt=""> -->
            <h4>
...
<?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\auth\login.blade.php ENDPATH**/ ?>