...
<div class="content container-fluid">
    ...
    <div class="card py-3 px-xxl-4 px-3 mb-20">
        <div class="d-flex flex-sm-nowrap flex-wrap gap-3 align-items-center justify-content-between">
            <div class="">
                <h3 class="mb-1"><?php echo e(translate('High-light Section')); ?></h3>
                <p class="mb-0 gray-dark fs-12">
                    <?php echo e(translate('See how your High-light Section will look to customers.')); ?>
    ...
    <div class="card mb-20">
        <form action="#0">
            <div class="card-body">
                <div class="mb-20">
                    <h3 class="mb-1"><?php echo e(translate('High-light Content Section ')); ?></h3>
                    <p class="mb-0 fs-12"><?php echo e(translate('Showcase the key features or achievements of your platform to build trust and engagement.')); ?></p>
                </div>
                <div class="row g-3">
                    <div class="col-lg-8">
                        <div class="bg--secondary rounded h-100 p-xxl-4 p-3">
                            ...
                            <div class="row g-3">
                                <div class="col-md-12 lang_form default-form">
                                    <div class="row g-1">
                                        <div class="col-12">
                                            <label for="high_light_title" class="form-label"><?php echo e(translate('Title')); ?> (<?php echo e(translate('messages.default')); ?>)
                                                <span class="form-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('Write_the_title_within_50_characters')); ?>">
                                            ...
                                            <input id="high_light_title" type="text"  maxlength="50" name="high_light_title[]" value="" class="form-control" placeholder="<?php echo e(translate('messages.title_here...')); ?>">
                                            <span class="text-right text-counting color-A7A7A7 d-block mt-1">0/100</span>
                                        </div>
                                        <div class="col-12">
                                            <label for="high_light_sub_title" class="form-label"><?php echo e(translate('Sub Title')); ?> (<?php echo e(translate('messages.default')); ?>)
                                            ...
                                            <textarea id="high_light_sub_title" rows="2" type="text"  maxlength="200" name="high_light_sub_title[]" value="" class="form-control" placeholder="<?php echo e(translate('messages.sub_title_here...')); ?>"></textarea>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input id="download_button_name" type="text"  maxlength="20" name="download_button_name[]" value="" class="form-control" placeholder="<?php echo e(translate('messages.Button Name')); ?>">
                    ...
                    <div class="col-lg-4">
                        <div class="bg--secondary h-100 rounded p-md-4 p-3 d-center">
                            <div class="text-center">
                                <div class="mb-4">
                                    <h5 class="mb-1"><?php echo e(translate('Upload High-light Section Image')); ?></h5>
                                    <p class="mb-0 fs-12 gray-dark"><?php echo e(translate('Upload your High-light Section  Image')); ?></p>
                                </div>
    ...
    <form action="<?php echo e(route('taxvat.store')); ?>" method="post">
        <div>
            <div class="custom-offcanvas-header bg--secondary d-flex justify-content-between align-items-center px-3 py-3">
                <div class="py-1">
                    <h3 class="mb-0 line--limit-1"><?php echo e(translate('messages.High-light Section Preview')); ?></h3>
                </div>
                        ...
                        <div class="d-flex align-items-center gap-3 flex-wrap justify-content-xl-between justify-content-center text-xl-start text-center flex-xl-nowrap">
                            <div class="d-flex gap-xxl-20 align-items-center flex-xl-nowrap flex-wrap">
                                <div class="w-100px min-w-100px h-100px d-center mb-xl-0 mb-2 mx-auto">
                                    <img src="<?php echo e(asset('/assets/admin/img/400x400/high-light-car.png')); ?>" alt="" class="object-contain">
                                </div>
                                <div>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\test\React_Landing\high-light-section.blade.php ENDPATH**/ ?>