                            ...
                            <div class="row g-3">
                                <div class="col-md-4 col-sm-6">
                                    <div>
                                        ...
                                        <input id="f_name"  type="text"  name="f_name" class="form-control" placeholder="<?php echo e(translate('messages.first_name')); ?>"
                                                required>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-6">
                                    <div>
                                        ...
                                        <input id="l_name"  type="text" name="l_name" class="form-control" placeholder="<?php echo e(translate('messages.last_name')); ?>"
                                                required>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input id="email"  type="email" name="email" class="form-control" placeholder="<?php echo e(translate('messages.Ex:')); ?> ex@example.com"
                                                required>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-6">
                ...
                <div class="col-md-6">
                    <div class="card h-100">
                        <div class="card-header">
                            ...
                            <small class="text-danger">* ( <?php echo e(translate('messages.ratio')); ?> 1:1 )</small></h5>
                        </div>
                        <div class="card-body d-flex flex-column">
                            <div class="text-center my-auto py-3">
                                <img class="img--100" id="viewer" src="<?php echo e(asset('assets/admin/img/400x400/img2.jpg')); ?>" alt="delivery-man image"/>
                            </div>
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group mb-0">
                                        ...
                                        <div class="input-group">
                                            <input type="tel" name="phone" id="phone" placeholder="<?php echo e(translate('messages.Ex:')); ?> 017********" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
...
<script type="text/javascript">
    "use strict";
        ...
        $('#deliaveryman_form').on('submit', function () {
            ...
            $.post({
                url: '<?php echo e(route('vendor.delivery-man.store')); ?>',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
...
<?php echo $__env->make('layouts.vendor.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\vendor-views\delivery-man\index.blade.php ENDPATH**/ ?>