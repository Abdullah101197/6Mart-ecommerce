...
<div class="modal-body pt-0 pb-2">
    <h4 class="text-center mb-1"><?php echo e(translate('withdraw_Method_List')); ?></h4>
    <div class="d-flex justify-content-center  align-items-center gap-2">
        <span><?php echo e(translate('method_Name')); ?></span>
        :
        <span class="font-semibold text-dark"><?php echo e($withdrawal_method->method_name); ?></span>
    </div>
</div>
...
<div class="table-responsive">
    <table class="table table-align-middle text-dark">
        <tbody>
            ...
            <tr>
                <td class="px-4 <?php echo e(1+$key === 1 ? "border-top-0" : ""); ?>"><?php echo e(1+$key); ?></td>
                <td class="<?php echo e(1+$key === 1 ? "border-top-0" : ""); ?>">
                    <div>
                        <div><?php echo e(translate('messages.Name')); ?>: <?php echo e(translate($method_field['input_name'])); ?></div>
                        <div><?php echo e(translate('messages.Type')); ?>: <?php echo e(translate($method_field['input_type'])); ?></div>
                        <div><?php echo e(translate('messages.Placeholder')); ?>: <?php echo e($method_field['placeholder']); ?></div>
                    </div>
                </td>
                <td class="<?php echo e(1+$key === 1 ? "border-top-0" : ""); ?>">
                    <div class="d-flex gap-3 align-items-center">
                        <?php echo $method_field['is_required'] ?
...
<?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\withdraw-method\partials\_method_info.blade.php ENDPATH**/ ?>