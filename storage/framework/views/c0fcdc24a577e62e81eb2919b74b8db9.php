                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    <?php if(\App\CentralLogics\Helpers::module_permission_check('pos')): ?>
                        ...
                        <li class="nav-item">
                            <small class="nav-subtitle"
                                   title="<?php echo e(translate('messages.employee_handle')); ?>"><?php echo e(translate('pos section')); ?></small>
                    ...
                    <?php if(\App\CentralLogics\Helpers::module_permission_check('order')): ?>
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="nav-item <?php echo e(Request::is('admin/order/list/item_on_the_way') ? 'active' : ''); ?>">
                                    <a class="nav-link text-capitalize"
                                       href="<?php echo e(route('admin.order.list', ['item_on_the_way'])); ?>"
                                ...
                                <li class="nav-item <?php echo e(Request::is('admin/order/offline/payment/list*') ? 'active' : ''); ?>">
                                    <a class="nav-link "
                                       ...
                                       title="<?php echo e(translate('Offline_Payments')); ?>">
                                        ...
                                        <span class="badge badge-soft-danger bg-light badge-pill ml-1">
                                            <?php echo e(\App\Models\Order::where('payment_method', 'offline_payment')->whereHas('offline_payments')->StoreOrder()->module(Config::get('module.current_module_id'))->count()); ?>
                        ...
                        <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/flash-sale*') ? 'active' : ''); ?>">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                               href="<?php echo e(route('admin.flash-sale.add-new')); ?>"
                               title="<?php echo e(translate('messages.flash_sales')); ?>">
                        ...
                        <?php if(\App\CentralLogics\Helpers::module_permission_check('campaign')): ?>
                            <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/campaign') ? 'active' : ''); ?>">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                   href="javascript:" title="<?php echo e(translate('messages.campaigns')); ?>">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li class="nav-item <?php echo e(Request::is('admin/campaign/basic/*') ? 'active' : ''); ?>">
                                        <a class="nav-link " href="<?php echo e(route('admin.campaign.list', 'basic')); ?>"
                                           title="<?php echo e(translate('messages.basic_campaigns')); ?>">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span
                                                class="text-truncate"><?php echo e(translate('messages.basic_campaigns')); ?></span>
                                        </a>
                                    </li>
                                    <li class="nav-item <?php echo e(Request::is('admin/campaign/item/*') ? 'active' : ''); ?>">
                                        <a class="nav-link " href="<?php echo e(route('admin.campaign.list', 'item')); ?>"
                                           title="<?php echo e(translate('messages.item_campaigns')); ?>">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span
                                                class="text-truncate"><?php echo e(translate('messages.item_campaigns')); ?></span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                        ...
                        <?php if(\App\CentralLogics\Helpers::module_permission_check('banner')): ?>
                            ...
                            <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/promotional-banner*') ? 'active' : ''); ?>">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                   ...
                                   title="<?php echo e(translate('messages.other_banners')); ?>">
                                    <i class="tio-image nav-icon"></i>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate"><?php echo e(translate('messages.other_banners')); ?></span>
                                </a>
                            </li>
                        <?php endif; ?>
                        <!-- End Banner -->
                    ...
                    <li class="nav-item">
                        <small class="nav-subtitle"
                               title="<?php echo e(translate('messages.item_section')); ?>"><?php echo e(translate('messages.product_management')); ?></small>
                        <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                    </li>
                        ...
                        <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/category*') ? 'active' : ''); ?>">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="nav-item   <?php echo $__env->yieldContent('main_category'); ?> <?php echo e(request()->input('position') == 0 && Request::is('admin/category/add') ? 'active' : ''); ?>">
                                    <a class="nav-link " href="<?php echo e(route('admin.category.add',['position'=>0])); ?>"
                                ...
                                <li class="nav-item   <?php echo $__env->yieldContent('sub_category'); ?> <?php echo e(request()->input('position') == 1 && Request::is('admin/category/add') ? 'active' : ''); ?>">
                                    <a class="nav-link " href="<?php echo e(route('admin.category.add',['position'=>1])); ?>"
                    ...
                    <?php if(\App\CentralLogics\Helpers::module_permission_check('attribute')): ?>
                        <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/attribute*') ? 'active' : ''); ?>">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                               ...
                               title="<?php echo e(translate('messages.attributes')); ?>">
                                <i class="tio-apps nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                    ...
                    <?php if(\App\CentralLogics\Helpers::module_permission_check('unit')): ?>
                        <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/unit*') ? 'active' : ''); ?>">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                               href="<?php echo e(route('admin.unit.index')); ?>" title="<?php echo e(translate('messages.units')); ?>">
                    ...
                    <?php endif; ?>
                    <!-- End Unit -->
                    <?php if(\App\CentralLogics\Helpers::module_permission_check('brand')): ?>
                        <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/brand*') ? 'active' : ''); ?>">
                            <a class="js-navbar-vertical-aside-menu-link nav-link" href="<?php echo e(route('admin.brand.add')); ?>"
                               title="<?php echo e(translate('messages.Brands')); ?>">
                        ...
                        <li class="navbar-vertical-aside-has-menu  <?php echo $__env->yieldContent('low_stock_list'); ?> <?php echo e(Request::is('admin/item*')  ? 'active' : ''); ?>">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                               title="<?php echo e(translate('Product Setup')); ?>">
                                ...
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate text-capitalize"><?php echo e(translate('Product Setup')); ?></span>
                            </a>
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display:<?php echo e(Request::is('admin/item*') ||  Request::is('admin/report/stock-report*') ? 'block' : 'none'); ?>">
                                <li class="nav-item <?php echo e(Request::is('admin/item/add-new') || (Request::is('admin/item/edit/*') && strpos(request()->fullUrl(), 'product_gellary=1') !== false  )  ? 'active' : ''); ?>">
                                    <a class="nav-link " href="<?php echo e(route('admin.item.add-new')); ?>"
                                ...
                                <li class="nav-item <?php echo e(Request::is('admin/item/list') || (Request::is('admin/item/edit/*') && (strpos(request()->fullUrl(), 'temp_product=1') == false && strpos(request()->fullUrl(), 'product_gellary=1') == false  ) ) ? 'active' : ''); ?>">
                                    <a class="nav-link " href="<?php echo e(route('admin.item.list')); ?>"
                                ...
                                <li class="nav-item  <?php echo $__env->yieldContent('low_stock_list'); ?>">
                                    <a class="nav-link " href="<?php echo e(route('admin.report.stock-report')); ?>"
                                       title="<?php echo e(translate('messages.Low_Stock_List')); ?>">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                ...
                                <?php if(\App\CentralLogics\Helpers::get_mail_status('product_gallery')): ?>
                                    <li class="nav-item <?php echo e(Request::is('admin/item/product-gallery') ? 'active' : ''); ?>">
                                        <a class="nav-link " href="<?php echo e(route('admin.item.product_gallery')); ?>"
                                           title="<?php echo e(translate('messages.Product_Gallery')); ?>">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span
                                                class="text-truncate"><?php echo e(translate('messages.Product_Gallery')); ?></span>
                                        </a>
                                    </li>
                                <?php endif; ?>
                                ...
                                <?php if(\App\CentralLogics\Helpers::get_mail_status('product_approval')): ?>
                                    <li class="nav-item <?php echo e(Request::is('admin/item/requested/item/view/*') || Request::is('admin/item/new/item/list') || (Request::is('admin/item/edit/*') && strpos(request()->fullUrl(), 'temp_product=1') !== false  ) ? 'active' : ''); ?>">
                                        <a class="nav-link " href="<?php echo e(route('admin.item.approval_list')); ?>"
                                           title="<?php echo e(translate('messages.New_Item_Request')); ?>">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span
                                                class="text-truncate"><?php echo e(translate('messages.New_Item_Request')); ?></span>
                                        </a>
                                    </li>
                                <?php endif; ?>
                                <li class="nav-item <?php echo e(Request::is('admin/item/reviews') ? 'active' : ''); ?>">
                                    <a class="nav-link " href="<?php echo e(route('admin.item.reviews')); ?>"
                                ...
                                <li class="nav-item <?php echo e(Request::is('admin/item/bulk-import') ? 'active' : ''); ?>">
                                    <a class="nav-link " href="<?php echo e(route('admin.item.bulk-import')); ?>"
                                       title="<?php echo e(translate('messages.bulk_import')); ?>">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span
                                            class="text-truncate text-capitalize"><?php echo e(translate('messages.bulk_import')); ?></span>
                                ...
                                <li class="nav-item <?php echo e(Request::is('admin/item/bulk-export') ? 'active' : ''); ?>">
                                    <a class="nav-link " href="<?php echo e(route('admin.item.bulk-export-index')); ?>"
                                       title="<?php echo e(translate('messages.bulk_export')); ?>">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span
                                            class="text-truncate text-capitalize"><?php echo e(translate('messages.bulk_export')); ?></span>
                    ...
                    <?php if(\App\CentralLogics\Helpers::module_permission_check('store')): ?>
                        ...
                        <li class="nav-item">
                            <small class="nav-subtitle"
                                   title="<?php echo e(translate('messages.store_section')); ?>"><?php echo e(translate('messages.store_management')); ?></small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>
                        ...
                        <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/store/pending-requests') ? 'active' : ''); ?>">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                               href="<?php echo e(route('admin.store.pending-requests')); ?>"
                               title="<?php echo e(translate('messages.pending_requests')); ?>">
                        ...
                        <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/store/add') ? 'active' : ''); ?>">
                            <a class="js-navbar-vertical-aside-menu-link nav-link" href="<?php echo e(route('admin.store.add')); ?>"
                               title="<?php echo e(translate('messages.add_store')); ?>">
                        ...
                        <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/store/list') ||  Request::is('admin/store/view/*')  ? 'active' : ''); ?>">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                               href="<?php echo e(route('admin.store.list')); ?>" title="<?php echo e(translate('messages.stores_list')); ?>">
                        ...
                        <li class="navbar-item <?php echo e(Request::is('admin/store/recommended-store') ? 'active' : ''); ?>">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                               href="<?php echo e(route('admin.store.recommended_store')); ?>"
                               title="<?php echo e(translate('messages.pending_requests')); ?>">
                        ...
                        <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/store/bulk-import') ? 'active' : ''); ?>">
                            <a class="nav-link " href="<?php echo e(route('admin.store.bulk-import')); ?>"
                               title="<?php echo e(translate('messages.bulk_import')); ?>">
                        ...
                        <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/store/bulk-export') ? 'active' : ''); ?>">
                            <a class="nav-link " href="<?php echo e(route('admin.store.bulk-export-index')); ?>"
                               title="<?php echo e(translate('messages.bulk_export')); ?>">
...
<?php $__env->startPush('script_2'); ?>
    <script>
        ...
        $(document).ready(function () {
            ...
            const suggestions = ['<?php echo e(strtolower(translate('messages.order'))); ?>', '<?php echo e(strtolower(translate('messages.campaign'))); ?>', '<?php echo e(strtolower(translate('messages.category'))); ?>', '<?php echo e(strtolower(translate('messages.product'))); ?>', '<?php echo e(strtolower(translate('messages.store'))); ?>'];
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\layouts\admin\partials\_sidebar_ecommerce.blade.php ENDPATH**/ ?>