    ...
    <div class="content container-fluid">
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal mb-4">
            <ul class="nav nav-tabs border-0 nav--tabs nav--pills">
                <li class="nav-item">
                    <a href="<?php echo e(route('vendor.subscriptionackage.subscriberDetail',$id)); ?>" class="nav-link "><?php echo e(translate('Subscription_Details')); ?> </a>
                </li>
                <li class="nav-item">
        ...
        <div class="card mb-20">
            ...
            <form action="<?php echo e(route('vendor.subscriptionackage.subscriberTransactions',$id)); ?>" method="get">
                <div class="card-body">
                    <div class="row">
                ...
                <div class="search--button-wrapper justify-content-end">
                    ...
                    <form class="search-form">
                        <div class="input-group input--group">
                            <input name="search" type="search" value="<?php echo e(request()?->search); ?>" class="form-control h--40px" placeholder="<?php echo e(translate('Ex : Search by Transaction ID or store name')); ?>" aria-label="Search here">
                    ...
                    <div class="hs-unfold">
                        ...
                        <div id="usersExportDropdown"
                            ...
                            <a id="export-excel" class="dropdown-item"
                                href="<?php echo e(route('vendor.subscriptionackage.subscriberTransactionExport', ['export_type' => 'excel', request()->getQueryString()])); ?>">
                    ...
                    <table class="table table-borderless middle-align __txt-14px">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="px-4">
                                    <div class="w--120px text-title  "><?php echo e(\App\CentralLogics\Helpers::format_currency($transaction->paid_amount)); ?></div>
                                </td>
                                <td class="px-4">
                                    <div>
                                ...
                                <td class="px-4">
                                    <div class="btn--container justify-content-center">
                                        <button class="btn action-btn btn--warning btn-outline-warning printButton" data-url=<?php echo e(route('vendor.subscriptionackage.invoice',$transaction->id)); ?> >
                                            <i class="tio-print"></i>
                                    </div>
                                </td>
                            </tr>
...
<?php echo $__env->make('layouts.vendor.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\vendor-views\subscription\subscriber\transaction.blade.php ENDPATH**/ ?>