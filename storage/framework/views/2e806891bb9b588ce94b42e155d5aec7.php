            ...
            <div class="card-body">
                                ...
                                <div class="form-group m-0">
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <label class="custom-control-label" for="Offline_payment">
                                            <h5 class="mb-1"><?php echo e(translate('Offline payment')); ?></h5>
                                            <p class="mb-0 fs-12">
               ...
               <div class="bg-light rounded p-xxl-20 p-3">
                    <div class="fs-12 text-dark px-3 py-2 rounded bg-warning-10 mb-20">
                        ...
                        <ul class="mb-0">
                            <li>
                                <?php echo e(translate('Customer Wallet from the')); ?> <a href="#" class="font-semibold text-primary"><?php echo e(translate('Customer Wallet')); ?></a>  <?php echo e(translate('page.')); ?>

                            </li>
                            <li>
                                <?php echo e(translate('messages.At least one payment method from the payment options above')); ?> 
                            </li>
                        </ul>
                    </div>
                    <div class="row g-3 align-items-center">
                        <div class="col-xxl-9 col-lg-8 col-md-7 col-sm-6">
                            <div>
                                ...
                                <p class="mb-0 fs-12">
                                    <?php echo e(translate('By switching this feature ON, Customer can pay with wallet balance & partially pay from other payment gateways. ')); ?>
                    ...
                    <div class="fs-12 text-dark px-3 py-2 rounded bg-danger-10 mt-20">
                        <div class="d-flex gap-2 ">
                            ...
                            <span>
                                <?php echo e(translate('Here')); ?> <strong><?php echo e(translate('Cash on Delivery(COD)')); ?></strong> <?php echo e(translate('is disable because this is not activated in the')); ?> <strong><?php echo e(translate('Payment Option setup')); ?></strong>
                            </span>
                        </div>
                    </div>
                    <div class="fs-12 text-dark px-3 py-2 rounded bg-danger-10 mt-20">
                        <div class="d-flex gap-2 ">
                            ...
                            <span>
                                <?php echo e(translate('Here')); ?> <strong><?php echo e(translate('Digital Payment')); ?></strong> <?php echo e(translate('is disable because this is not activated in the')); ?> <strong><?php echo e(translate('Payment Option setup')); ?></strong>
                            </span>
                        </div>
                    </div>
               </div>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\test\business-setting\business-settins-payment.blade.php ENDPATH**/ ?>