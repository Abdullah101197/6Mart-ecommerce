<form action="<?php echo e(route('admin.addon.update', [$addon['id']])); ?>" method="post" class="d-flex flex-column h-100">
        ...
        <div class="custom-offcanvas-body p-20">
            <div class="bg--secondary rounded p-20 mb-20">
                <div class="mb-15">
                    ...
                    <p class="fz-12px"><?php echo e(translate('If_you_turn_off_this_status_this_addon_will_not_be_available')); ?>
                ...
                <label class="border d-flex align-items-center bg-white-n justify-content-between rounded p-10px px-3">
                    ...
                    <div class="toggle-switch ml-auto justify-content-end toggle-switch-sm" for="status">
                        <input type="checkbox" name="status" value="1" <?php echo e($addon['status'] ? 'checked' : ''); ?>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <select name="store_id" id="store_id1" class="form-control  js-data-example-ajax"
                                data-placeholder="<?php echo e(translate('messages.select_store')); ?>" required>
                                <?php if($addon->store): ?>
                                    <option value="<?php echo e($addon->store_id); ?>" selected="selected">
                                        <?php echo e($addon->store->name); ?></option>
                                <?php endif; ?>
                            </select>
                        </div>
                    </div>
...
<?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\addon\edit.blade.php ENDPATH**/ ?>