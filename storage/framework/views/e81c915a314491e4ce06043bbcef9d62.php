<div class="">
    <div>
        ...
        <form action="<?php echo e(route('admin.business-settings.subscriptionackage.packageBuy')); ?>" method="post">
            <?php echo csrf_field(); ?>
            ...
            <div class="col-md-6">
                <label class="payment-item">
                    ...
                    <div class="payment-item-inner">
                        ...
                        <span><?php echo e(translate('manually_pay')); ?></span>
...
<?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\subscription\subscriber\partials\_package_selected.blade.php ENDPATH**/ ?>