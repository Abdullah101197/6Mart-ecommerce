    ...
    <div class="card mb-20">
        <div class="card-header">
            <div class="">
                ...
                <p class="mb-0 fs-12"><?php echo e(translate('Manage the main title and subtitle for the Frequently Asked Questions section.	')); ?></p>
            </div>
        </div>
        <div class="card-body"> 
            ...
            <div class="card mb-20 border-0">
                <div class="card-body p-xxl-4 p-3">
                    <div class="mb-20">
                        ...
                        <p class="mb-0 fs-12"><?php echo e(translate('Add and manage individual questions and answers for each user type.')); ?></p>
                    </div>
                    <form action="#0">
                        <div class="row g-3">
                            <div class="col-lg-12">
                                ...
                                <div class="bg--secondary rounded p-xxl-4 p-3">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-12 lang_form default-form">
                                            <div class="row g-1">
                                                <div class="col-12">
                                                    <label for="high_light_title" class="form-label"><?php echo e(translate('Question')); ?> (<?php echo e(translate('messages.default')); ?>)
                                                        <span class="form-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('Write_the_title_within_150_characters')); ?>">
                                                            <i class="tio-info color-A7A7A7"></i>
                                                        </span><span class="form-label-secondary text-danger"
                                                        data-toggle="tooltip" data-placement="right"
                                                        data-original-title="<?php echo e(translate('messages.Required.')); ?>"> 
                                                    ...
                                                    <input id="high_light_title" type="text"  maxlength="150" name="high_light_title[]" value="" class="form-control" placeholder="<?php echo e(translate('messages.Question Here...')); ?>">
                                                    <span class="text-right text-counting color-A7A7A7 d-block mt-1">0/150</span>
                                                </div>
                                                <div class="col-12">
                                                    <label for="high_light_sub_title" class="form-label"><?php echo e(translate('Answer')); ?> (<?php echo e(translate('messages.default')); ?>)
                                                    ...
                                                    <textarea id="high_light_sub_title" rows="1" type="text"  maxlength="500" name="high_light_sub_title[]" value="" class="form-control min-h-45px" placeholder="<?php echo e(translate('messages.Answer Here...')); ?>"></textarea>
                                        ...
                                        <div class="d-flex align-items-center gap-3 flex-wrap justify-content-xl-between justify-content-center text-xl-start text-center flex-xl-nowrap">
                                            <div class="d-xl-flex gap-xxl-20 align-items-center flex-xl-nowrap flex-wrap">
                                                <div class="w-50px bg-white h-50px min-h-50 rounded-circle d-center mx-auto mb-xl-0 mb-2">
                                                    <img src="<?php echo e(asset('/assets/admin/img/icons/faq-question.png')); ?>" alt="" class="object-contain">
                                                </div>
                                                <div>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\test\React_Landing\faq-section.blade.php ENDPATH**/ ?>