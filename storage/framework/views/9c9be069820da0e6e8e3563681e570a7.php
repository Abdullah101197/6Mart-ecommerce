    ...
    <tbody>
        ...
        <tr>
            <td class="main-table-td">
                ...
                <img class="mb-2 mail-img-3 onerror-image" id="bannerViewer" data-onerror-image="<?php echo e(asset('/assets/admin/img/blank2.png')); ?>"
                ...
                <div class="mb-1" >
                    ...
                    <h6>
                        <?php echo e(translate('messages.Email')); ?> : abc@mail.com

                    </h6>
                    <h6>

                        <?php echo e(translate('messages.Password')); ?> : password
                    </h6>


                </div>
                <div class="mb-1" id="mail-body2"><?php echo $data['body_2']?? translate('Your_account_credential:'); ?></div>
        ...
        <tr>
            ...
            <span class="privacy">
                ...
                <span class="copyright" id="mail-copyright">
                    <?php echo e($data['copyright_text']?? translate('Copyright_2023_Stackfood._All_right_reserved')); ?>
...
<?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\business-settings\email-format-setting\templates\email-format-10.blade.php ENDPATH**/ ?>