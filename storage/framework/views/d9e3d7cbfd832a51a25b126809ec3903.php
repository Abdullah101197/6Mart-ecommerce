                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group lang_form" id="default-form">
                                    ...
                                    <input type="text" name="type[]" class="form-control h--45px"
                                        ...
                                        value="<?php echo e($vehicle?->getRawOriginal('type')); ?>" required>
                                </div>
                                ...
                                <div class="form-group d-none lang_form" id="<?php echo e($lang); ?>-form">
                                    ...
                                    <input type="text" name="type[]" class="form-control h--45px"
                                        placeholder="<?php echo e(translate('messages.ex_:_bike')); ?>" maxlength="191"
                                        value="<?php echo e($translate[$lang]['type']??''); ?>">
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.001" id="extra_charges" class="form-control h--45px"
                                        value="<?php echo e($vehicle->extra_charges); ?>" min="0" required name="extra_charges">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="form-group">
                                    <label class="input-label text-capitalize"
                                        for="title"><?php echo e(translate('messages.starting_coverage_area')); ?> (<?php echo e(translate('messages.km')); ?>)<span class="input-label-secondary"
                                            data-toggle="tooltip" data-placement="right"
                                            data-original-title="<?php echo e(translate('messages.the_starting_coverage_area_represents_the_location_where_deliveries_are_made')); ?>"><img
                                                src="<?php echo e(asset('assets/admin/img/info-circle.svg')); ?>"
                                                alt="public/img"></span><span class="form-label-secondary text-danger"
                                            data-toggle="tooltip" data-placement="right"
                                            data-original-title="<?php echo e(translate('messages.Required.')); ?>"> *
                                    ...
                                    <input type="number" step="0.001" id="starting_coverage_area"
                                        class="form-control h--45px" value="<?php echo e($vehicle->starting_coverage_area); ?>"
                                ...
                                <div class="form-group">
                                    <label class="input-label text-capitalize"
                                        for="title"><?php echo e(translate('messages.maximum_coverage_area')); ?> (<?php echo e(translate('messages.km')); ?>)<span class="input-label-secondary"
                                            data-toggle="tooltip" data-placement="right"
                                            data-original-title="<?php echo e(translate('messages.the_maximum_coverage_area_represents_the_farthest_or_widest_extent_to_which_deliveries_can_be_made')); ?>"><img
                                                src="<?php echo e(asset('assets/admin/img/info-circle.svg')); ?>"
                                                alt="public/img"></span><span class="form-label-secondary text-danger"
                                            data-toggle="tooltip" data-placement="right"
                                            data-original-title="<?php echo e(translate('messages.Required.')); ?>"> *
                                    ...
                                    <input type="number" step="0.001" id="maximum_coverage_area"
                                        class="form-control h--45px" value="<?php echo e($vehicle->maximum_coverage_area); ?>"
...
<script src="<?php echo e(asset('assets/admin')); ?>/js/view-pages/dm-vehichle.js"></script>
<script>
    "use strict";
        $('#vehicle-form').on('submit', function (e) {
            ...
            $.post({
                url: '<?php echo e(route('admin.users.delivery-man.vehicle.update',$vehicle->id)); ?>',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
                success: function (data) {
                    if (data.errors) {
                        ...
                        toastr.success('<?php echo e(translate('messages.Vehicle_category_updated')); ?>', {
                            CloseButton: true,
                            ProgressBar: true
                        });
                        setTimeout(function () {
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\dm-vehicle\edit.blade.php ENDPATH**/ ?>