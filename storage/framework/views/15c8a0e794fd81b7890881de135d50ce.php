<?php $__env->startSection('title', translate('messages.Tax_Setup')); ?>
    ...
    block
    <?php $__env->stopSection(); ?>
    <?php $__env->startSection('tax_setup'); ?>
    show active
    <?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content container-fluid">
        <h3 class="mb-20"><?php echo e(translate('All Taxes')); ?></h3>
        <div class="mt-5">

            <?php if(count($taxVats) > 0): ?>
                <div class="d-flex align-items-center justify-content-between gap-2 flex-wrap mb-20">
                    <h4 class="mb-0"><?php echo e(translate('List of Taxes')); ?>


                        <span class="badge badge-soft-dark ml-2" id="itemCount"><?php echo e($taxVats->count()); ?></span>
                    </h4>
                    <div class="search--button-wrapper justify-content-end">
                        ...
                        <div class="hs-unfold mr-2">
                            ...
                            <div id="usersExportDropdown"
                                ...
                                <a id="export-excel" class="dropdown-item"
                                    href="<?php echo e(route('taxvat.export', ['type' => 'excel', request()->getQueryString()])); ?>">
                                    <img class="avatar avatar-xss avatar-4by3 mr-2"
                                        src="<?php echo e(asset('Modules/TaxModule/public/assets/admin/img/excel.svg')); ?>"
                                        alt="Image Description">
                                    <?php echo e(translate('messages.excel')); ?>

                                </a>
                                <a id="export-csv" class="dropdown-item"
                                    href="<?php echo e(route('taxvat.export', ['type' => 'csv', request()->getQueryString()])); ?>">
                                    <img class="avatar avatar-xss avatar-4by3 mr-2"
                                        src="<?php echo e(asset('Modules/TaxModule/public/assets/admin/img/placeholder-csv-format.svg')); ?>"
                                        alt="Image Description">
                        ...
                        <button type="button" class="btn btn--primary offcanvas-trigger"
                            data-target="#offcanvas__customBtn"><?php echo e(translate('messages.create_tax')); ?></button>
                    </div>
                </div>
                <!-- Table -->
                    ...
                    <table id="datatable"
                        ...
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="border-0 text-end"><?php echo e(translate('messages.action')); ?></th>
                            </tr>
                        </thead>

                        <tbody id="set-rows">

                            <?php $__currentLoopData = $taxVats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $taxVat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($key + $taxVats->firstItem()); ?></td>
                                    <td>
                                        <?php echo e($taxVat->name); ?>
                                    ...
                                    <td>
                                        <label
                                            ...
                                            data-url="<?php echo e(route('taxvat.status', $taxVat->id)); ?>"
                                            data-id="<?php echo e($taxVat->id); ?>" data-is_active="<?php echo e($taxVat->is_active); ?>"
                                            ...
                                            for="status_<?php echo e($taxVat->id); ?>">
                                            <input type="checkbox" <?php echo e($taxVat->is_active == 1 ? 'checked' : ''); ?>

                                                class="toggle-switch-input" id="status_<?php echo e($taxVat->id); ?>">
                                    ...
                                    <td class="text-end">
                                        <a class="btn btn-sm ml-auto text-end action-btn info--outline text--info info-hover offcanvas-trigger get_data"
                                            data-target="#editTaxData" data-id="<?php echo e($taxVat->id); ?>"
                                            data-name="<?php echo e($taxVat->name); ?>" data-tax_rate="<?php echo e($taxVat->tax_rate); ?>"
                                            data-is_active="<?php echo e($taxVat->is_active); ?>"
                                            data-action="<?php echo e(route('taxvat.update', $taxVat->id)); ?>" href="#0">
                                            <i class="tio-edit"></i>
                                        </a>
                                    </td>
                                </tr>
            ...
            <?php else: ?>
                <div class="bg--F6F6F6 tax-error__table w-100 h225-vh py-5">
                    <div class="max-349 text-center mx-auto my-5">
                        <img src="<?php echo e(asset('Modules/TaxModule/public/assets/admin/img/tax-error.png')); ?>" alt="img"
                            class="mb-20">
                        <h4 class="mb-2"><?php echo e(translate('Currently you don’t have any Tax')); ?></h4>
                        <p class="mb-20">
                            <?php echo e(translate('In this page you see all the Tax you added. Please create new tax to collect tax')); ?>
    ...
    <div id="offcanvas__customBtn" class="custom-offcanvas d-flex flex-column justify-content-between">
        <div>
            <form action="<?php echo e(route('taxvat.store')); ?>" method="post">
                ...
                <div
                    ...
                    <h3 class="mb-0"><?php echo e(translate('messages.create_tax')); ?></h2>
                        <button type="button"
                ...
                <div class="custom-offcanvas-body p-20">
                    ...
                    <div class="bg--secondary rounded p-20 mb-20">
                        <div class="mb-15">
                            ...
                            <p class="fz-12px">
                                <?php echo e(translate('If you turn off this status your tax calculation will effect.')); ?></p>
                        </div>
                        <label
                            ...
                            <div class="toggle-switch ml-auto justify-content-end toggle-switch-sm" for="status">
                                <input type="checkbox" name="status" value="1"
                                    <?php echo e(old('status') == 1 ? 'checked' : ''); ?> class="toggle-switch-input" id="status">
                                <span class="toggle-switch-label">
                                    <span class="toggle-switch-indicator"></span>
                                </span>
                            </div>
                    ...
                    <div class="bg--secondary rounded p-20 mb-20">
                        <div class="form-group">
                            <label class="mb-2 fz--14px d-block"><?php echo e(translate('messages.tax_name')); ?> <span class="text-danger">*</span></label>
                            <input type="text" name="name" class="form-control h--45px border-0 pl-unset" required
                                placeholder="<?php echo e(translate('Type tax name')); ?>" value="<?php echo e(old('name')); ?>" maxlength="50">
                        </div>
                        <div class="form-group mb-0">
                            <label class="mb-2 fz--14px d-block"><?php echo e(translate('messages.tax_rate')); ?> <span class="text-danger">*</span></label>
                            <div class="custom-group-btn border">
                                <div class="flex-sm-grow-1">
                                    <input type="number" value="<?php echo e(old('tax_rate')); ?>" required name="tax_rate"
                                        min="0.001" step="0.001" max="100"
                                        class="form-control h--45px border-0 pl-unset" placeholder="<?php echo e(translate('Ex: 5')); ?>">
                                </div>
        ...
        <div class="offcanvas-footer p-3 d-flex align-items-center justify-content-center gap-3">
            <button type="reset" class="btn w-100 btn--secondary h--40px"><?php echo e(translate('messages.reset')); ?></button>
            <button type="submit" class="btn w-100 btn--primary h--40px"><?php echo e(translate('messages.Submit')); ?></button>
        </div>
        </form>
    </div>
    ...
    <div id="editTaxData" class="custom-offcanvas d-flex flex-column justify-content-between">
        <div>
            <form action="" method="post">
                ...
                <div
                    class="custom-offcanvas-header bg--secondary d-flex justify-content-between align-items-center px-3 py-3">
                    <h3 class="mb-0"><?php echo e(translate('messages.edit_tax')); ?></h2>
                        <button type="button"
                            class="btn-close w-25px h-25px border rounded-circle d-center bg--secondary text-dark offcanvas-close fz-15px p-0"
                            aria-label="Close">&times;</button>
                </div>
                <div class="custom-offcanvas-body p-20">
                    ...
                    <div class="bg--secondary rounded p-20 mb-20">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" readonly class="form-control h--45px border-0 pl-unset"
                                placeholder="<?php echo e(translate('VAT')); ?>" id="tax_name">
                        </div>
                        <div class="form-group mb-0">
                            <label class="mb-2 fz--14px d-block"><?php echo e(translate('messages.tax_rate')); ?> <span class="text-danger">*</span></label>
                            <div class="custom-group-btn border">
                    ...
                    <div class="d-flex p-15 rounded gap-2 bg-opacity-warning-10">
                        ...
                        <p class="fz-12px mb-0">
                            <?php echo e(translate('Recheck your changes & make sure before update. When you change it will effect on all related')); ?>

                            <span class="fz-12px font-semibold title-clr"><?php echo e(translate('Tax Calculation.')); ?></span>
                        </p>
                    </div>
                </div>
        </div>
        <div class="offcanvas-footer p-3 d-flex align-items-center justify-content-center gap-3">
            <button type="button" class="btn w-100 btn--secondary h--40px reset"><?php echo e(translate('Reset')); ?></button>
                    ...
                    <div class="py-3 px-3 bg-light rounded mb-3">
                        <div class="d-flex gap-3 align-items-center justify-content-between overflow-hidden">
                            <button class="btn-collapse line--limit-1 d-flex gap-3 align-items-center bg-transparent border-0 p-0 collapse show" type="button"
                                ...
                                <span class="font-semibold text-left fs-14 text-title line--limit-1"><?php echo e(translate('What is Tax ?')); ?></span>
                            </button>
                        ...
                        <div class="collapse mt-3 show" id="collapseGeneralSetup_01">
                            <div class="card rounded border p-3 card-body">
                                ...
                                <div class="mb-3">
                                    <h6 class="mb-2 fs-12 color-656566"><?php echo e(translate('Common types include')); ?></h6>
                                    <ul class="mb-0 list-group pl-3 d-flex flex-column gap-1px">
                                        <li class="fs-12 color-656566"><?php echo e(translate('VAT (Value Added Tax)')); ?></li>
                                        <li class="fs-12 color-656566"><?php echo e(translate('GST (Goods & Services Tax)')); ?></li>
                                        <li class="fs-12 color-656566"><?php echo e(translate('Service Tax')); ?></li>
                                        <li class="fs-12 color-656566"><?php echo e(translate('Sales Tax')); ?></li>
                                    </ul>
                                </div>
                                <p class="m-0 fs-12 color-656566">
                    ...
                    <div class="p-12 p-sm-20 bg-light rounded mb-3">
                        <div class="d-flex gap-3 align-items-center justify-content-between overflow-hidden">
                            <button class="btn-collapse line--limit-1 d-flex gap-3 align-items-center bg-transparent border-0 p-0 collapsed" type="button"
                                ...
                                <span class="font-semibold text-left fs-14 text-title line--limit-1"><?php echo e(translate('Why Set Up Taxes ?')); ?></span>
                            </button>
                        </div>
                        <div class="collapse mt-3" id="collapseGeneralSetup_032">
                            <div class="card rounded border p-3 card-body">                                
                                <div class="mb-3">
                                    <h6 class="mb-2 fs-12 color-656566"><?php echo e(translate('Enabling tax in your system helps you:')); ?></h6>
                                    <ul class="mb-0 list-group pl-3 d-flex flex-column gap-1px">
                                        <li class="fs-12 color-656566"><?php echo e(translate('Stay legally compliant with local tax laws')); ?></li>
                                        <li class="fs-12 color-656566"><?php echo e(translate('Automatically calculate and apply the correct tax during checkout')); ?></li>
                                        <li class="fs-12 color-656566"><?php echo e(translate('Show clear and accurate pricing to customers')); ?></li>
                                        <li class="fs-12 color-656566"><?php echo e(translate('Show clear and accurate pricing to customers')); ?></li>
                                        <li class="fs-12 color-656566"><?php echo e(translate('Generate ready-to-use VAT/GST reports')); ?></li>
                                    </ul>
                                </div>
                                <p class="m-0 fs-12 color-656566">
                                    <?php echo e(translate('Once you set up your tax correctly, the system will automatically handle calculations for every order.')); ?>
                    ...
                    <div class="p-12 p-sm-20 bg-light rounded mb-3">
                        <div class="d-flex gap-3 align-items-center justify-content-between overflow-hidden">
                            <button class="btn-collapse line--limit-1 d-flex gap-3 align-items-center bg-transparent border-0 p-0 collapsed" type="button"
                                ...
                                <span class="font-semibold text-left fs-14 text-title line--limit-1"><?php echo e(translate('Follow these steps to add a new tax rate:')); ?></span>
                            </button>
                        </div>
                        <div class="collapse mt-3" id="collapseGeneralSetup_033">
                            <div class="card rounded border p-3 card-body">   
                                <div class="mb-3">
                                    <h6 class="mb-2 fs-12 color-656566"><?php echo e(translate('Activate the Tax Status')); ?></h6>
                                    <ul class="mb-0 list-group pl-3 d-flex flex-column gap-1px">
                                        <li class="fs-12 color-656566"><?php echo e(translate('Turn ON the Status toggle to make the tax active.')); ?></li>
                                        <li class="fs-12 color-656566"><?php echo e(translate('If it’s OFF, the tax will be saved but not applied to any transaction.')); ?></li>
                                    </ul>
                                </div>
                                <div class="mb-3">
                                    <h6 class="mb-2 fs-12 color-656566"><?php echo e(translate('Enter a Tax Name')); ?></h6>
                                    <ul class="mb-0 list-group pl-3 d-flex flex-column gap-1px">
                                        <li class="fs-12 color-656566"><?php echo e(translate('Go to the Tax Name field and enter your preferred name.')); ?></li>
                                        <li class="fs-12 color-656566"><?php echo e(translate('Example: Service Tax, VAT, GST, Sales Tax, etc.')); ?></li>
                                    </ul>
                                </div>
                                <div class="mb-3">
                                    <h6 class="mb-2 fs-12 color-656566"><?php echo e(translate('Set the Tax Rate')); ?></h6>
                                    <ul class="mb-0 list-group pl-3 d-flex flex-column gap-1px">
                                        <li class="fs-12 color-656566"><?php echo e(translate('In the Tax Rate box, enter the percentage (e.g., 10%).')); ?></li>
                                        <li class="fs-12 color-656566"><?php echo e(translate('This is the rate that will be applied to all taxable items or services.')); ?></li>
                                    </ul>
                                </div>
                                <div class="mb-3">
                                    <h6 class="mb-2 fs-12 color-656566"><?php echo e(translate('Save the Tax')); ?></h6>
                                    <ul class="mb-0 list-group pl-3 d-flex flex-column gap-1px">
                                        <li class="fs-12 color-656566"><?php echo e(translate('Click Submit to add the new tax.')); ?></li>
                                        <li class="fs-12 color-656566"><?php echo e(translate('Click Reset if you need to clear the form before saving.')); ?></li>
                                    </ul>
                                </div>
                                <p class="m-0 fs-12 color-656566">
                                    <?php echo e(translate('You can create multiple taxes for different purposes — for example, separate ones for product, service, and delivery.')); ?>
                    ...
                    <div class="p-12 p-sm-20 bg-light rounded mb-3">
                        <div class="d-flex gap-3 align-items-center justify-content-between overflow-hidden">
                            <button class="btn-collapse line--limit-1 d-flex gap-3 align-items-center bg-transparent border-0 p-0 collapsed" type="button"
                                ...
                                <span class="font-semibold text-left fs-14 text-title line--limit-1"><?php echo e(translate('Edit or Manage Existing Taxes')); ?></span>
                            </button>
                        </div>
                        <div class="collapse mt-3" id="collapseGeneralSetup_044">
                            <div class="card rounded border p-3 card-body">   
                                <div class="mb-3">
                                    <h6 class="mb-2 fs-12 color-656566"><?php echo e(translate('Edit or Manage Existing Taxes')); ?></h6>
                                    <ul class="mb-0 list-group pl-3 d-flex flex-column gap-1px">
                                        <li class="fs-12 color-656566"><?php echo e(translate('Once a tax is created, you cannot change its name or delete it (for data integrity).')); ?></li>
                                        <li class="fs-12 color-656566"><?php echo e(translate('However, you can update the tax rate anytime if your government updates the tax percentage.')); ?></li>
                                        <li class="fs-12 color-656566"><?php echo e(translate('Manage all your created taxes easily from the Tax List page.')); ?></li>
                                        <li class="fs-12 color-656566"><?php echo e(translate('Use the Export button to download a copy for backup or accounting records.')); ?></li>
                                        <li class="fs-12 color-656566"><?php echo e(translate('Toggle the Status on or off to quickly enable or disable a tax.')); ?></li>
                                    </ul>
                                </div>                                
                            </div>
                        </div>
...
<?php $__env->startPush('script_2'); ?>
    ...
    <script src="<?php echo e(asset('Modules/TaxModule/public/assets/js/admin/taxvat.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\Modules\TaxModule\Resources\views\tax\tax_list.blade.php ENDPATH**/ ?>