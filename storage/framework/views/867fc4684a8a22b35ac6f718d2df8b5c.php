            ...
            <div class="row g-xxl-4 g-3">
                    ...
                    <div class="card_earning-box card--bg-4 rounded-10 h-100">
                        <div class="box d-flex align-items-center">
                            <div class="icon w-60px h-60px rounded-circle d-center bg-white">
                                <img src="<?php echo e(asset('assets/admin/img/e-referral-code.png')); ?>" class="w--26" alt="">
                            </div>
                            <div>
                                <div class="mb-1 d-flex align-items-center gap-2">
                                    <h3 class=" text-danger-dark mb-0 fs-18 code__copy max-w-150 line--limit-1"><?php echo e(translate('messages.H9FJ8F7KJ')); ?></h3>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card_earning-box card--bg-3 rounded-10 h-100">
                        <div class="box d-flex align-items-center">
                            <div class="icon w-60px h-60px rounded-circle d-center bg-white">
                                <img src="<?php echo e(asset('assets/admin/img/e-referred-total.png')); ?>" class="w--26" alt="">
                            </div>
                            <div>
                                <h3 class="text-00AA6D mb-1 fs-26"><?php echo e(translate('messages.20')); ?></h3>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card_earning-box color-card color-5 rounded-10 h-100">
                        <div class="box d-flex align-items-center">
                            <div class="icon w-60px h-60px rounded-circle d-center bg-white">
                                <img src="<?php echo e(asset('assets/admin/img/e-referral-earned.png')); ?>" class="w--26" alt="">
                            </div>
                            <div>
                                <h3 class="title mb-1 fs-26"><?php echo e(translate('messages.$15.00')); ?></h3>
                                <p class="text-dark fs-14 mb-0"><?php echo e(translate('messages.Referral Earned')); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
...
<div id="transaction__list" class="custom-offcanvas d-flex flex-column justify-content-between">
    ...
    <div class="offcanvas-footer p-3 d-flex align-items-center justify-content-center gap-3">
        <button type="reset" class="btn w-100 btn--reset h--40px"><?php echo e(translate('messages.reset')); ?></button>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\test\deliveryman-details\refer-earn.blade.php ENDPATH**/ ?>