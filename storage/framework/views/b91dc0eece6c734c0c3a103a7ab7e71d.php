...
<?php $__env->startSection('title',translate('Addon Bulk Export')); ?>
    ...
    <div class="content container-fluid">
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span>
                    <?php echo e(translate('messages.addons_bulk_export')); ?>
        ...
        <div class="card mt-2 rest-part">
            <div class="card-body">
                ...
                <form class="product-form" action="<?php echo e(route('admin.addon.bulk-export')); ?>" method="POST"
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\addon\bulk-export.blade.php ENDPATH**/ ?>