            ...
            <div class="row align-items-center py-2">
                <div class="col-sm mb-2 mb-sm-0">
                    <div class="d-flex align-items-center">
                        <img class="onerror-image" data-onerror-image="<?php echo e(asset('/assets/admin/img/eshop.svg')); ?>" src="<?php echo e($mod->icon_full_url); ?>"
                        width="38" alt="img">
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-end">
                    <div class="status-filter-wrap">
                        <div class="statistics-btn-grp">
                            <label>
                                <input type="radio" name="statistics" class="order_stats_update" value="this_year" <?php echo e($params['statistics_type'] == 'this_year'?'checked':''); ?> hidden>
                                <span><?php echo e(translate('This_Year')); ?></span>
                            </label>
                            <label>
                                <input type="radio" name="statistics" class="order_stats_update" value="this_month" <?php echo e($params['statistics_type'] == 'this_month'?'checked':''); ?> hidden>
                                <span><?php echo e(translate('This_Month')); ?></span>
                            </label>
                            <label>
                                <input type="radio" name="statistics" class="order_stats_update" value="this_week" <?php echo e($params['statistics_type'] == 'this_week'?'checked':''); ?> hidden>
                ...
                <div class="row g-2" id="order_stats">
                    <div class="col-sm-6 col-lg-3">
                        <div class="__dashboard-card-2">
                            <img src="<?php echo e(asset('/assets/admin/img/dashboard/stats/products.svg')); ?>" alt="dashboard/stats">
                            <h6 class="name"><?php echo e(translate('messages.products')); ?></h6>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="__dashboard-card-2">
                            <img src="<?php echo e(asset('/assets/admin/img/dashboard/stats/orders.svg')); ?>" alt="dashboard/stats">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="__dashboard-card-2">
                            <img src="<?php echo e(asset('/assets/admin/img/dashboard/stats/stores.svg')); ?>" alt="dashboard/stats">
                            <h6 class="name"><?php echo e(translate('messages.stores')); ?></h6>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="__dashboard-card-2">
                            <img src="<?php echo e(asset('/assets/admin/img/dashboard/stats/customers.svg')); ?>" alt="dashboard/stats">
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\dashboard-ecommerce.blade.php ENDPATH**/ ?>