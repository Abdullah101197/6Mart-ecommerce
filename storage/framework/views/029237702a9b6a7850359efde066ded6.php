...
<?php $__env->startSection('title',translate('messages.Add Surge Price')); ?>
...
<div class="content container-fluid">
    ...
    <h3 class="mb-20"><?php echo e(translate('Create New Surge Price')); ?></h3>
      <form action="<?php echo e(route('admin.business-settings.zone.surge-price.store')); ?>" method="post" id="surge_form">
        <?php echo csrf_field(); ?>
        <input autocomplete="off" type="hidden" name="zone_id" value="<?php echo e($zone->id); ?>">
                        ...
                        <div>
                            ...
                            <select name="module_ids[]" id="module_selected" class="form-control h--45px js-select2-custom" multiple="multiple" placeholder="Module Select" data-placeholder="Module">
                                ...
                                <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($module->id); ?>"><?php echo e(translate($module->module_name)); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
                                    ...
                                    <div class="bg-white p-sm-3 d-flex flex-column gap-3">
                                        <div>
                                            ...
                                            <div class="position-relative date-range__custom">
                                                ...
                                                <input autocomplete="off" type="text" class="form-control h-45 position-relative bg-transparent no-type"  name="daily_date_range" placeholder="<?php echo e(translate('messages.Select_Date')); ?>">
                                            </div>
                                        </div>
                                        <div class="time-range-wrapper">
                                            ...
                                            <div class="position-relative cursor-pointer">
                                                <i class="tio-time icon-absolute-on-right"></i>
                                                 <input autocomplete="off" type="text" class="form-control h-45 position-relative bg-transparent time-range-picker no-type" name="daily_time_range" placeholder="<?php echo e(translate('messages.Select_Time')); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                 ...
                                 <div class="shedule_item">
                                     <div class="bg-white p-sm-3 d-flex flex-column gap-3">
                                         <div class="cursor-pointer" data-toggle="modal" data-target="#weeklySelectDays_btn">
                                             ...
                                             <div class="position-relative date-range__custom">
                                                 ...
                                                 <input autocomplete="off" type="text" class="form-control h-45 position-relative bg-transparent date-range-input-demo no-type"
                                                     name="weekly_date_range" placeholder="<?php echo e(translate('messages.Select_Date')); ?>">
                                             </div>
                                         </div>
                                         ...
                                         <div class="time-range-wrapper">
                                             ...
                                             <div class="position-relative cursor-pointer">
                                                 <i class="tio-time icon-absolute-on-right"></i>
                                                  <input autocomplete="off" type="text" class="form-control h-45 position-relative bg-transparent time-range-picker no-type" name="weekly_time_range" placeholder="<?php echo e(translate('messages.Select_Time')); ?>">
                                             </div>
                                         </div>
                                     ...
                                     <div class="bg-white p-sm-3 d-flex flex-column gap-3">
                                         <div class="cursor-pointer" data-toggle="modal" data-target="#surgeCustom_sheduleBtn">
                                             ...
                                             <div class="position-relative">
                                                 <i class="tio-calendar-month icon-absolute-on-right"></i>
                                                 <input autocomplete="off" type="text" id="custom_schedule_input" class="form-control h-45 position-relative bg-transparent no-type" name="" placeholder="<?php echo e(translate('messages.Select Date & Time')); ?>">
                                             </div>
                                         </div>
        ...
        <div class="modal-body-inner">
            ...
            <div class="bg-light rounded p-3">
                ...
                <div class="mb-20">
                    ...
                    <div class="position-relative date-range__custom">
                        <i class="tio-calendar-month icon-absolute-on-right"></i>
                        <input autocomplete="off" type="text" class="form-control h-45 position-relative no-type" id="weekly_modal_date"  name="dates" placeholder="<?php echo e(translate('messages.Select_Date')); ?>">
                    </div>
                </div>
                <label class="form-check form--check mr-2 mr-md-4">
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        if (res.status) {
                            ...
                            setTimeout(() => {
                                window.location.href = "<?php echo e(route('admin.business-settings.zone.surge-price.list', [$zone['id']])); ?>";
                            }, 1500);
                        }
                    },
                    error: function (xhr) {
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\zone\surge-price\index.blade.php ENDPATH**/ ?>