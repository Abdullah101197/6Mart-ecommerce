                    ...
                    <div class="modal-body pb-5 pt-0">
                        <div class="single-item-slider owl-carousel">
                            <div class="item">
                                <div class="mb-20">
                                    <div class="text-center">
                                        <img src="<?php echo e(asset('/assets/admin/img/firebase/slide-1.png')); ?>" alt="" class="mb-20">
                            ...
                            <div class="item">
                                <div class="mb-20">
                                    <div class="text-center">
                                        <img src="<?php echo e(asset('/assets/admin/img/firebase/slide-2.png')); ?>" alt="" class="mb-20">
                            ...
                            <div class="item">
                                <div class="mb-20">
                                    <div class="text-center">
                                        <img src="<?php echo e(asset('/assets/admin/img/firebase/slide-3.png')); ?>" alt="" class="mb-20">
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\business-settings\fcm-config.blade.php ENDPATH**/ ?>