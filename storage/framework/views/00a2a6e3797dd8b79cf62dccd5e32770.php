                                ...
                                <div class="d-flex gap-40px">
                                    <div>
                                        ...
                                        <label class="upload-img-3 m-0 d-block">
                                            <div class="img">
                                                ...
                                                data-onerror-image="<?php echo e(asset("/assets/admin/img/aspect-1.png")); ?>" class="img__aspect-1 min-w-187px max-w-187px onerror-image" alt="">
                                            </div>
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <label class="upload-img-4 m-0 d-block my-auto">
                                            <div class="img">
                                                <img src="<?php echo e(asset("/assets/admin/img/aspect-3-1.png")); ?>" data-onerror-image="<?php echo e(asset("/assets/admin/img/aspect-3-1.png")); ?>" class="vertical-img max-w-187px onerror-image" alt="">
                                            </div>
                            ...
                            <table class="table table-borderless table-thead-bordered table-align-middle table-nowrap card-table m-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img   src="<?php echo e($review?->reviewer_image_full_url ?? asset('/assets/admin/img/upload-3.png')); ?>"

                                            data-onerror-image="<?php echo e(asset('/assets/admin/img/upload-3.png')); ?>" class="__size-105 onerror-image" alt="">
                                        </td>
                                        <td>
                                            <img
                                            src="<?php echo e($review?->company_image_full_url ?? asset('/assets/admin/img/upload-3.png')); ?>"
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\business-settings\landing-page-settings\admin-landing-testimonial.blade.php ENDPATH**/ ?>