                        ...
                        <?php if($product->store): ?>
                            <a class="resturant--information-single"
                                ...
                                <img class="img--120 rounded mx-auto mb-3 onerror-image"
                                    ...
                                    src="<?php echo e($product->store->logo_full_url ?? asset('public/assets/admin/img/160x160/img1.jpg')); ?>"
                                    alt="Image Description">
                                        ...
                                        <a class="d-flex align-items-center"
                                            ...
                                            <div class="avatar avatar-circle">
                                                <img class="avatar-img onerror-image"
                                                    data-onerror-image="<?php echo e(asset('public/assets/admin/img/160x160/img1.jpg')); ?>"
                                                    width="75" height="75"
                                                    src="<?php echo e($review->customer->image_full_url ?? asset('public/assets/admin/img/160x160/img1.jpg')); ?>"
                                                    alt="Image Description">
                                            </div>
                                            <div class="ml-3">
                                                <span
