        ...
        <div class="card-body">
            <div class="row g-3 justify-content-between align-items-center">
                <div class="col-lg-8 col-md-7 col-sm-7">
                    <div>
                        <h3 class="mb-1"><?php echo e(translate('messages.Popular Clients Section')); ?></h3>
                        <p class="m-0 fs-12 color-656566"><?php echo e(translate('If you turn of the availability status, this section will not show in the website')); ?></p>
                    </div>
                </div>
        ...
        <div class="card-body">
            ...
            <div class="bg--secondary h-100 rounded p-md-4 p-3 mb-20">
                ...
                <div class="row g-1 lang_form default-form">
                    <div class="col-sm-12">
                        <label for=""  class="form-label"><?php echo e(translate('Title')); ?> (<?php echo e(translate('messages.default')); ?>)
                        ...
                        <textarea id="" type="text"  maxlength="100" name="[]" class="form-control min-h-45px" value="" rows="1" placeholder="<?php echo e(translate('messages.title_here...')); ?>"></textarea>
                        <span class="text-right text-counting color-A7A7A7 d-block mt-1">0/100</span>
                    </div>
                    <div class="col-sm-12">
                        <label for=""  class="form-label"><?php echo e(translate('Sub Title')); ?> (<?php echo e(translate('messages.default')); ?>)
                        <span class="form-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('Write_the_sub_title_within_30_characters')); ?>">
                                    <i class="tio-info color-A7A7A7"></i>
                        ...
                        <textarea id="" type="text"  maxlength="200" name="" class="form-control min-h-45px" value="" rows="1" placeholder="<?php echo e(translate('messages.sub_title_here...')); ?>"></textarea>
                    ...
                    <div class="row g-3">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="w-100 d-flex align-items-center gap-2 flex-wrap justify-content-between">
                                        <h3 class="mb-0"><?php echo e(translate('Client 1')); ?></h3>                                
                                    </div>
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="text-center py-1">                            
                                            <div class="mx-auto text-center">
                                                <div class="mb-30">
                                                    ...
                                                    <p class="mb-0 fs-12 gray-dark"><?php echo e(translate('Upload 1st Card  Image')); ?></p>
                                                </div>
                                            ...
                                            <p class="fs-10 text-center mb-0 mt-lg-4 mt-3">
                                                <span class="font-medium color-656566"><?php echo e(translate('Ratio (1:1)')); ?></span>
                                            </p>
                                        </div>
                                    </div>                            
                                </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4 col-xxl-3">
                            <div class="card">
                                <div class="card-header">
                                    <div class="w-100 d-flex align-items-center gap-2 flex-wrap justify-content-between">
                                        <h3 class="mb-0"><?php echo e(translate('Client 2')); ?></h3>                                
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="bg--secondary h-100 rounded p-4">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4 col-xxl-3">
                            <div class="card">
                                <div class="card-header">
                                    <div class="w-100 d-flex align-items-center gap-2 flex-wrap justify-content-between">
                                        <h3 class="mb-0"><?php echo e(translate('Client 3')); ?></h3>                                
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="bg--secondary h-100 rounded p-4">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4 col-xxl-3">
                            <div class="card">
                                <div class="card-header">
                                    <div class="w-100 d-flex align-items-center gap-2 flex-wrap justify-content-between">
                                        <h3 class="mb-0"><?php echo e(translate('Client 4')); ?></h3>                                
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="bg--secondary h-100 rounded p-4">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4 col-xxl-3">
                            <div class="card">
                                <div class="card-header">
                                    <div class="w-100 d-flex align-items-center gap-2 flex-wrap justify-content-between">
                                        <h3 class="mb-0"><?php echo e(translate('Client 5')); ?></h3>                                
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="bg--secondary h-100 rounded p-4">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4 col-xxl-3">
                            <div class="card">
                                <div class="card-header">
                                    <div class="w-100 d-flex align-items-center gap-2 flex-wrap justify-content-between">
                                        <h3 class="mb-0"><?php echo e(translate('Client 6')); ?></h3>                                
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="bg--secondary h-100 rounded p-4">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4 col-xxl-3">
                            <div class="card">
                                <div class="card-header">
                                    <div class="w-100 d-flex align-items-center gap-2 flex-wrap justify-content-between">
                                        <h3 class="mb-0"><?php echo e(translate('Client 7')); ?></h3>                                
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="bg--secondary h-100 rounded p-4">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4 col-xxl-3">
                            <div class="card">
                                <div class="card-header">
                                    <div class="w-100 d-flex align-items-center gap-2 flex-wrap justify-content-between">
                                        <h3 class="mb-0"><?php echo e(translate('Client 8')); ?></h3>                                
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="bg--secondary h-100 rounded p-4">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4 col-xxl-3">
                            <div class="card">
                                <div class="card-header">
                                    <div class="w-100 d-flex align-items-center gap-2 flex-wrap justify-content-between">
                                        <h3 class="mb-0"><?php echo e(translate('Client 9')); ?></h3>                                
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="bg--secondary h-100 rounded p-4">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4 col-xxl-3">
                            <div class="card">
                                <div class="card-header">
                                    <div class="w-100 d-flex align-items-center gap-2 flex-wrap justify-content-between">
                                        <h3 class="mb-0"><?php echo e(translate('Client 10')); ?></h3>                                
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="bg--secondary h-100 rounded p-4">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4 col-xxl-3">
                            <div class="card">
                                <div class="card-header">
                                    <div class="w-100 d-flex align-items-center gap-2 flex-wrap justify-content-between">
                                        <h3 class="mb-0"><?php echo e(translate('Client 11')); ?></h3>                                
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="bg--secondary h-100 rounded p-4">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4 col-xxl-3">
                            <div class="card">
                                <div class="card-header">
                                    <div class="w-100 d-flex align-items-center gap-2 flex-wrap justify-content-between">
                                        <h3 class="mb-0"><?php echo e(translate('Client 12')); ?></h3>                                
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="bg--secondary h-100 rounded p-4">
                        ...
                        <div class="clients-preview-slide owl-theme owl-carousel">
                            <div class="items__">
                                <div class="p-xxl-3 p-2 d-center h-135px bg--secondary rounded">
                                    <img wdith="110" height="100" src="<?php echo e(asset('/assets/admin/img/400x400/react-new-slide1.jpg')); ?>" alt="" class="rounded">                                                                       
                                </div>
                            </div>
                            <div class="items__">
                                <div class="p-xxl-3 p-2 d-center h-135px bg--secondary rounded">
                                    <img wdith="110" height="100" src="<?php echo e(asset('/assets/admin/img/400x400/react-new-slide2.jpg')); ?>" alt="" class="rounded">                                                                       
                                </div>
                            </div>
                            <div class="items__">
                                <div class="p-xxl-3 p-2 d-center h-135px bg--secondary rounded">
                                    <img wdith="110" height="100" src="<?php echo e(asset('/assets/admin/img/400x400/react-new-slide3.jpg')); ?>" alt="" class="rounded">                                                                       
                                </div>
                            </div>
                            <div class="items__">
                                <div class="p-xxl-3 p-2 d-center h-135px bg--secondary rounded">
                                    <img wdith="110" height="100" src="<?php echo e(asset('/assets/admin/img/400x400/react-new-slide4.jpg')); ?>" alt="" class="rounded">                                                                       
                                </div>
                            </div>
                            <div class="items__">
                                <div class="p-xxl-3 p-2 d-center h-135px bg--secondary rounded">
                                    <img wdith="110" height="100" src="<?php echo e(asset('/assets/admin/img/400x400/react-new-slide5.jpg')); ?>" alt="" class="rounded">                                                                       
                                </div>
                            </div>
                            <div class="items__">
                                <div class="p-xxl-3 p-2 d-center h-135px bg--secondary rounded">
                                    <img wdith="110" height="100" src="<?php echo e(asset('/assets/admin/img/400x400/react-new-slide6.jpg')); ?>" alt="" class="rounded">                                                                       
                                </div>
                            </div>
                            <div class="items__">
                                <div class="p-xxl-3 p-2 d-center h-135px bg--secondary rounded">
                                    <img wdith="110" height="100" src="<?php echo e(asset('/assets/admin/img/400x400/react-new-slide7.jpg')); ?>" alt="" class="rounded">                                                                       
                                </div>
                            </div>
                            <div class="items__">
                                <div class="p-xxl-3 p-2 d-center h-135px bg--secondary rounded">
                                    <img wdith="110" height="100" src="<?php echo e(asset('/assets/admin/img/400x400/react-new-slide8.jpg')); ?>" alt="" class="rounded">                                                                       
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\test\React_Landing\popular-clients.blade.php ENDPATH**/ ?>