                ...
                <div class="col-lg-12">
                    <div class="fs-12 color-656565 px-3 py-2 bg-opacity-10 rounded bg-info mb-20">
                        <div class="d-flex align-items-center gap-2 mb-0">
                            ...
                            <span>
                                <?php echo e(translate('See all customer & manage them from')); ?> <a target="_blank" href="<?php echo e(route('admin.users.customer.list')); ?>" class="text-primary text-underline fw-semibold"><?php echo e(translate('All Customer List ')); ?></a> <?php echo e(translate('page.')); ?>
                            ...
                            <div class="row g-3 align-items-center">
                                <div class="col-xxl-9 col-lg-8 col-md-7 col-sm-6">
                                    <div>
                                        ...
                                        <p class="mb-0 fs-12">
                                            <?php echo e(translate('Customers can order as guests when this feature is enabled.')); ?>
                                            ...
                                            <label
                                                ...
                                                <span class="pr-1 d-flex align-items-center switch--label">
                                                    ...
                                                    <input type="checkbox" data-id="vnv1" data-type="toggle"
                                                        ...
                                                        class="status toggle-switch-input dynamic-checkbox-toggle" value="1"
                                                        name="toggle_veg_non_veg" id="vnv1" <?php echo e($vnv == 1 ? 'checked' : ''); ?>>
                                                <span class="toggle-switch-label text">
                                                    <span class="toggle-switch-indicator"></span>
                                                </span>
                                            </label>
                    ...
                    <div class="card mb-20 card-container" id="customer-wallet">
                        <div class="card-body">
                                        ...
                                        <label class="toggle-switch toggle-switch-sm mb-0">
                                            <input type="checkbox"
                                                     ...
                                                     data-id="wallet_status" data-type="toggle"
                                                        ...
                                                        data-title-on="<?php echo e(translate('messages.Want_to_enable')); ?> <strong><?php echo e(translate('messages.Wallet_feature?')); ?></strong>"
                                                        data-title-off="<?php echo e(translate('messages.Want_to_disable')); ?> <strong><?php echo e(translate('messages.Wallet_feature?')); ?></strong>"
                                                        data-text-on="<p><?php echo e(translate('messages.If_you_enable_this,_Customers_will_have_the_wallet_feature.')); ?></p>"
                                                        data-text-off="<p><?php echo e(translate('messages.If_you_disable_this,_the_Wallet_feature_will_be_hidden_from_the_Customer_App_and_Website.')); ?></p>"
                            ...
                            <div class="card-details-body <?php echo e(!isset($data['wallet_status']) || $data['wallet_status'] != 1  ? 'd-none' : ''); ?>">
                                <div class="bg-light2  rounded p-xxl-20 p-3 mt-20">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-sm-6 col-lg-6">
                                            <div class="form-group mb-0">
                                                <span class="mb-2 d-flex align-items-center text-title"><?php echo e(translate('Add Fund to Wallet')); ?>
                                ...
                                <div class="fs-12 color-656565 px-3 py-2 bg-opacity-10 rounded bg-info mt-20">
                                    <div class="d-flex align-items-center mb-0">
                                        ...
                                        <ul class="mb-0 fs-12">
                                                <li><?php echo e(translate('You can see customer wallet from Customers details page. Go to this path')); ?> <strong><?php echo e(translate('Customers')); ?> > <?php echo e(translate('Customer List')); ?> > <?php echo e(translate('View Details')); ?></strong></li>
                                                <li>
                                                    <p class="mb-0 mt-2 fs-12 color-656565"><?php echo e(translate('To add fund for a customer visit')); ?> <a target="_blank" href="<?php echo e(route('admin.users.customer.wallet.add-fund')); ?>" class="text-primary text-underline fw-semibold"><?php echo e(translate('Add Fund')); ?></a> <?php echo e(translate('page.')); ?></p>
                                                </li>
                                            </ul>
                     ...
                     <div class="card mb-20 card-container" id="loyalty_point_section">
                        <div class="card-body">
                            ...
                            <div class="card-details-body <?php echo e(!isset($data['loyalty_point_status']) || $data['loyalty_point_status'] != 1  ? 'd-none' : ''); ?>">
                                <div class="bg-light2  rounded p-xxl-20 p-3 mt-20">
                                        ...
                                        <div class="col-sm-6 col-lg-4">
                                            <div class="form-group mb-0">
                                                <label class="input-label gap-0" for="loyalty_point_item_purchase_point">
                                                    ...
                                                    <span class="input-label-secondary"
                                                        data-toggle="tooltip" data-placement="right"
                                                        data-original-title="<?php echo e(translate('Specify the percentage of the total order amount that a customer will earn as loyalty points.')); ?>"><i class="tio-info text-muted"></i>
                                                    </span>
                                                     <span class="text-danger"> *</span>
                                                </label>
                                                <input <?php echo e(isset($data['loyalty_point_status']) && $data['loyalty_point_status'] == 1 ? 'required' : 'readonly'); ?> id="item_purchase_point"
                                                    type="number" class="form-control" name="loyalty_point_item_purchase_point"  min="0" value="<?php echo e($data['loyalty_point_item_purchase_point'] ?? '0'); ?>">
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-lg-4">
                                            <div class="form-group mb-0">
                                                <label class="input-label" for="minimum_transfer_point">
                                                    ...
                                                    <span class="input-label-secondary"
                                                        data-toggle="tooltip" data-placement="right"
                                                        data-original-title="<?php echo e(translate('Enter the minimum number of points a customer must collect before they can convert them into a wallet balance.')); ?>"><i class="tio-info text-muted"></i>
                                                    </span>
                                                     <span class="text-danger"> *</span>
                                                </label>
                                                <input <?php echo e(isset($data['loyalty_point_status']) && $data['loyalty_point_status'] == 1 ? 'required' : 'readonly'); ?> id="minimum_transfer_point"
                                                    type="number" class="form-control" name="loyalty_point_minimum_point" min="0" value="<?php echo e($data['loyalty_point_minimum_point'] ?? '0'); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="fs-12 color-656565 px-3 py-2 bg-opacity-10 rounded bg-info mt-20">
                                    <div class="d-flex align-items-center gap-2 mb-0">
                                        ...
                                        <span>
                                            <?php echo e(translate('To see customer loyalty point report visit')); ?> <a target="_blank" href="<?php echo e(route('admin.users.customer.loyalty-point.report')); ?>" class="text-primary text-underline fw-semibold"><?php echo e(translate('Loyalty Point Report.')); ?></a>
                                        </span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card card-container" id="referral_earning_section">
                        <div class="card-body">
                            ...
                            <div class="card-details-body <?php echo e(!isset($data['ref_earning_status']) || $data['ref_earning_status'] != 1  ? 'd-none' : ''); ?> mt-20">
                                <div class="bg-light rounded p-xxl-20 p-3">
                                    <div class="py-0">
                                            ...
                                            <div class="align-self-center  col-md-4">
                                                <div class="text-left">
                                                    ...
                                                    <p class="fs-12 color-656565">
                                                        <?php echo e(translate('Customers earn wallet rewards for sharing their referral code. Rewards are given when friends sign up and complete their first order using the code.')); ?>
                                                    ...
                                                    <div class="card-body p-0">
                                                        <div class="form-group mb-0">
                                                            <label class="input-label" for="ref_earning_exchange_rate">
                                                                ...
                                                                <span class="input-label-secondary" data-toggle="tooltip"
                                                                    data-placement="right"
                                                                    data-original-title="<?php echo e(translate('Refer amount add to wallet option is disabled. Kindly turn on the option from Customer Wallet section to complete this settings')); ?>">
                                                            ...
                                                            id="ref_earning_exchange_rate" type="number" step="<?php echo e(Helpers::getDecimalPlaces()); ?>" min="0" max="99999999999"
                                        ...
                                        <div class="row g-3 align-items-end">
                                            <div class="align-self-center col-md-4 text-center">
                                                <div class="text-left">
                                                    ...
                                                    <p class="fs-12 color-656565">
                                                        <?php echo e(translate('Customers get a signup and first purchase discount when they use the referral code for a limited time.')); ?>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group mb-0">
                                                                    ...
                                                                    <div class="d-flex align-items-center gap-0 border rounded overflow-hidden">
                                                                        <input id="new_customer_discount_amount" type="number" step="<?php echo e(Helpers::getDecimalPlaces()); ?>" min="0"
    ...
    <div id="global_guideline_offcanvas" style="overflow-y: auto;"
        ...
        <div>
            <div class="custom-offcanvas-header bg--secondary d-flex justify-content-between align-items-center px-3 py-3">
                <h3 class="mb-0"><?php echo e(translate('Customer Settings Guideline')); ?></h3>
                <button type="button"
            ...
            <div class="py-3 px-3 bg-light rounded mb-3 mb-sm-20">
                <div class="d-flex gap-2 align-items-center justify-content-between overflow-hidden">
                    <button class="btn-collapse d-flex gap-2 align-items-center bg-transparent border-0 p-0 collapsed"
                        ...
                        <span class="font-semibold text-left fs-14 text-title"><?php echo e(translate('Guest Checkout')); ?></span>
                    </button>
                ...
                <div class="collapse mt-3 show" id="guest_checkout_guide">
                    <div class="card card-body">
                        <div class="">
                            <h5 class="mb-3"><?php echo e(translate('Guest Checkout')); ?></h5>
                            <p class="fs-12 mb-0">
                                <?php echo e(translate('The Guest Checkout feature allows customers to place orders without creating a full account or logging in. This streamlines the purchase process, improves user experience, and can increase order completion rates, especially for first-time or infrequent users.')); ?>
            ...
            <div class="py-3 px-3 bg-light rounded mb-3 mb-sm-20">
                <div class="d-flex gap-2 align-items-center justify-content-between overflow-hidden">
                    <button class="btn-collapse d-flex gap-2 align-items-center bg-transparent border-0 p-0 collapsed"
                        ...
                        <span class="font-semibold text-left fs-14 text-title"><?php echo e(translate('Customer Food Preference')); ?></span>
                    </button>
                ...
                <div class="collapse mt-3" id="food_preference_guide">
                    <div class="card card-body">
                        <div class="">
                            <h5 class="mb-3"><?php echo e(translate('Customer Food Preference')); ?></h5>
                            <p class="fs-12 mb-0">
                                <?php echo e(translate('Enabling this option allows customers to view Veg/Non-Veg food preferences on the website and app.')); ?>
            ...
            <div class="py-3 px-3 bg-light rounded mb-3 mb-sm-20">
                <div class="d-flex gap-2 align-items-center justify-content-between overflow-hidden">
                    <button class="btn-collapse d-flex gap-2 align-items-center bg-transparent border-0 p-0 collapsed"
                        ...
                        <span class="font-semibold text-left fs-14 text-title"><?php echo e(translate('Customer Wallet')); ?></span>
                    </button>
                ...
                <div class="collapse mt-3" id="customer_wallet_guide">
                    <div class="card card-body">
                        <div class="">
                            <h5 class="mb-3"><?php echo e(translate('Customer Wallet')); ?></h5>
                            <p class="fs-12 mb-0">
                                <?php echo e(translate('The Customer Wallet is a digital wallet feature that allows customers to store funds within the platform for quick and convenient transactions. Customers can add money to their wallet, make payments for orders, and even request or receive refunds directly through the wallet.')); ?>

                            </p>
                            <br>
                            <ul class="fs-12">
                                <li>
                                    <strong><?php echo e(translate('Refund to Wallet')); ?>:</strong> <?php echo e(translate('When the wallet feature is enabled, customers can use their wallet balance to pay for orders. Refunds can also be sent directly to the wallet of the customer for easy use in future purchases.')); ?>

                                </li>
                                <li>
                                    <strong><?php echo e(translate('Add funds to wallet')); ?>:</strong> <?php echo e(translate('If this option is enabled, customers can add money to their wallet using digital payment methods like bank transfer, mobile wallets, etc.')); ?>

                                </li>
                                <li>
                                    <strong><?php echo e(translate('Minimum add Amount')); ?>:</strong> <?php echo e(translate('The smallest amount a customer can add to their wallet at one time.')); ?>
            ...
            <div class="py-3 px-3 bg-light rounded mb-3 mb-sm-20">
                <div class="d-flex gap-2 align-items-center justify-content-between overflow-hidden">
                    <button class="btn-collapse d-flex gap-2 align-items-center bg-transparent border-0 p-0 collapsed"
                        ...
                        <span class="font-semibold text-left fs-14 text-title"><?php echo e(translate('Customer Loyalty Point')); ?></span>
                    </button>
                ...
                <div class="collapse mt-3" id="loyalty_point_guide">
                    <div class="card card-body">
                        <div class="">
                            <h5 class="mb-3"><?php echo e(translate('Customer Loyalty Point')); ?></h5>
                            <p class="fs-12 mb-0">
                                <?php echo e(translate('Define how many loyalty points equal 1 unit of currency(Ex: $1 if the system default currency is dollars). It helps customers understand the value of their points when they want to convert them to wallet money.')); ?>
            ...
            <div class="py-3 px-3 bg-light rounded mb-3 mb-sm-20">
                <div class="d-flex gap-2 align-items-center justify-content-between overflow-hidden">
                    <button class="btn-collapse d-flex gap-2 align-items-center bg-transparent border-0 p-0 collapsed"
                        ...
                        <span class="font-semibold text-left fs-14 text-title"><?php echo e(translate('Customer Referral Earning Settings')); ?></span>
                    </button>
                ...
                <div class="collapse mt-3" id="referral_earning_guide">
                    <div class="card card-body">
                        <div class="">
                            <h5 class="mb-3"><?php echo e(translate('Customer Referral Earning Settings')); ?></h5>
                            <ul class="fs-12">
                                <li><?php echo e(translate('Customer referral earning settings allow you to specify the wallet balance reward that customers will receive for successfully sharing their unique referral code with new customers who then make a purchase.')); ?></li>
                                <li><?php echo e(translate('This setting allows the admin to set the amount (in the default currency) that a referring customer will earn. The reward is added to their wallet when someone they refer places and completes their first order on the platform.')); ?></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\business-settings\settings\customer-index.blade.php ENDPATH**/ ?>