    ...
    <div class="card">
        <div class="card-header flex-wrap pt-3 pb-3 border-0 gap-2">
            <div class="search--button-wrapper mr-1">
                <h4 class="card-title fs-16 text-dark"><?php echo e(translate('messages.SEO Setup List')); ?> <span class="badge badge-soft-dark ml-2 rounded-circle fs-12" id="itemCount">12</span></h4>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\test\seo-setting\seo-setup-list.blade.php ENDPATH**/ ?>