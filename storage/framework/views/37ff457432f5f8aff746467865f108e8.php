...
<div class="content container-fluid">
    <div class="page-header">
        <h1 class="page-header-title">
            ...
            <span><?php echo e(translate('Store_Disbursement')); ?></span>
        </h1>
        <ul class="nav nav-tabs mb-4 border-0 pt-2">
            <li class="nav-item">
                <a class="nav-link <?php echo e($status == 'all'?'active':''); ?>" href="<?php echo e(route('admin.transactions.store-disbursement.list', ['status' => 'all'])); ?>" ><?php echo e(translate('all')); ?></a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?php echo e($status == 'pending'?'active':''); ?>" href="<?php echo e(route('admin.transactions.store-disbursement.list', ['status' => 'pending'])); ?>"><?php echo e(translate('pending')); ?></a>
            </li>



            <li class="nav-item">
                <a class="nav-link <?php echo e($status == 'completed'?'active':''); ?>" href="<?php echo e(route('admin.transactions.store-disbursement.list', ['status' => 'completed'])); ?>"><?php echo e(translate('completed')); ?></a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?php echo e($status == 'partially_completed'?'active':''); ?>" href="<?php echo e(route('admin.transactions.store-disbursement.list', ['status' => 'partially_completed'])); ?>"><?php echo e(translate('partially_completed')); ?></a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?php echo e($status == 'canceled'?'active':''); ?>" href="<?php echo e(route('admin.transactions.store-disbursement.list', ['status' => 'canceled'])); ?>"><?php echo e(translate('canceled')); ?></a>
            </li>
        </ul>
    </div>
    <!-- Reports -->
            ...
            <div class="card">
                <div class="card-header border-0 flex-wrap justify-content-between gap-4">
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-2">
                        ...
                        <div>
                            <a href="<?php echo e(route('admin.transactions.store-disbursement.view', ['id' => $disbursement->id])); ?>" class="btn btn--primary"><?php echo e(translate('view_details')); ?></a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views/admin-views/store-disbursement/index.blade.php ENDPATH**/ ?>