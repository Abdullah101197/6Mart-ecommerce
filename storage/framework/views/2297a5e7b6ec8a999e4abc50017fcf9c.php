...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card mt-4 position-relative">
        <div class="d-flex justify-content-end mb-2 position-absolute top-end">
            <a href="#" class="d-flex align-items-center gap-1">
                        <span data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip"
                            ...
                            <img src="<?php echo e(asset('assets/installation')); ?>/assets/img/svg-icons/info.svg" alt=""
                                 class="svg">
                        </span>
            </a>
        </div>
        <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
            ...
            <form method="POST" action="<?php echo e(route('system_settings',['token'=>bcrypt('step_6')])); ?>">
                <?php echo csrf_field(); ?>
                            ...
                            <div class="col-md-12">
                                <div class="from-group">
                                    ...
                                    <input type="text" id="first-name" class="form-control" name="business_name"
                                           required placeholder="Ex: 6amMart">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="from-group">
                                ...
                                <div class="from-group">
                                    ...
                                    <div class="number-input-wrap">
                                        <select name="phone-number" id="phone-number" class="form-select">
                                            <?php $__currentLoopData = TELEPHONE_CODES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="from-group">
                                    ...
                                    <div class="input-inner-end-ele position-relative">
                                        ...
                                        <div class="togglePassword">
                                            <img
                                                src="<?php echo e(asset('assets/installation')); ?>/assets/img/svg-icons/eye.svg"
                                                alt="" class="svg eye">
                                            <img
                                                src="<?php echo e(asset('assets/installation')); ?>/assets/img/svg-icons/eye-off.svg"
...
<?php echo $__env->make('layouts.blank', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\installation\step5.blade.php ENDPATH**/ ?>