...
?>
    <section class="about-section py-5 position-relative">
        <div class="container">
            ...
            <!-- End Page Header -->
                <form class="validate-form" action="<?php echo e(route('deliveryman.store')); ?>" method="post" enctype="multipart/form-data" id="form-id">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-12">
                                    <div class="form-group mb-3">
                                        <label class="input-label"
                                            for="exampleFormControlInput1"><?php echo e(translate('messages.zone')); ?>
                                ...
                                <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                      <label class="input-label"
                                                for="exampleFormControlInput1"><?php echo e(translate('messages.Vehicle')); ?>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-3">
                                        <label class="input-label"
                                            for="exampleFormControlInput1"><?php echo e(translate('messages.identity_type')); ?>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-3">
                                        <label class="input-label"
                                            for="exampleFormControlInput1"><?php echo e(translate('messages.identity_number')); ?>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group mb-0">
                                        <label class="input-label"><?php echo e(translate('messages.identity_image')); ?>
        ...
        data-original-title="<?php echo e(translate('messages.Must_contain_at_least_one_number_and_one_uppercase_and_lowercase_letter_and_symbol,_and_at_least_8_or_more_characters')); ?>"><img src="<?php echo e(asset('/assets/admin/img/info-circle.svg')); ?>" alt="<?php echo e(translate('messages.Must_contain_at_least_one_number_and_one_uppercase_and_lowercase_letter_and_symbol,_and_at_least_8_or_more_characters')); ?>"></span></label>
                                        <input type="password" name="password" class="form-control __form-control" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="<?php echo e(translate('messages.Must_contain_at_least_one_number_and_one_uppercase_and_lowercase_letter_and_symbol,_and_at_least_8_or_more_characters')); ?>"
                                        ...
                                        <label class="position-relative">
                                            ...
                                            <div class="icon-file-group">
                                                <div class="icon-file">
                                                    ...
                                                    <img src="<?php echo e(asset('/assets/admin/img/pen.png')); ?>" alt="">
                                                </div>
                                            </div>
                                        </label>
                                    </div>
        ...
        (function () {
            ...
            class FileUploadValidator {
                ...
                removePreview() {
                    ...
                    if (viewer) {
                        viewer.src = '<?php echo e(asset('assets/admin/img/upload-img.png')); ?>';
                    }
                }
                ...
                validate() {
                    ...
                    if (!this.input.files || this.input.files.length === 0) {
                        if (this.config.required) {
                            return this.showError('<?php echo e(translate('messages.please_select_image')); ?>');
                        }
                        return true;
                    }
                    ...
                    if (!this.config.allowedTypes.includes(fileExtension)) {
                        return this.showError(`<?php echo e(translate('messages.invalid_file_type')); ?> ${this.config.allowedTypes.join(', ')}`);
                    }

                    const fileSizeMB = file.size / (1024 * 1024);
                    if (fileSizeMB > this.config.maxSize) {
                        return this.showError(`<?php echo e(translate('messages.file_size_too_big. ')); ?><?php echo e(translate('messages.max_file_size_is')); ?> ${this.config.maxSize}MB.`);
                    }
...
<?php echo $__env->make('layouts.landing.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\dm-registration.blade.php ENDPATH**/ ?>