            ...
            <div class="bg--secondary h-100 rounded p-md-4 p-3">
                ...
                <div class="row g-1 lang_form default-form">
                    <div class="col-sm-12">
                        ...
                        <textarea id="" type="text"  maxlength="50" name="[]" class="form-control min-h-45px" value="" rows="1" placeholder="<?php echo e(translate('messages.title_here...')); ?>"></textarea>
                ...
                <div class="row g-3">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="w-100 d-flex align-items-center gap-2 flex-wrap justify-content-between">
                                    <h3 class="mb-0"><?php echo e(translate('1st Card')); ?></h3>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <div class="w-100 d-flex align-items-center gap-2 flex-wrap justify-content-between">
                                    <h3 class="mb-0"><?php echo e(translate('2nd Card')); ?></h3>
                                    <label class="toggle-switch h--45px toggle-switch-sm d-flex justify-content-between gap-4">
                                        <span class="w-auto switch--label text-nowrap fs-14 text-title">
                                            <?php echo e(translate('messages.Status')); ?>                                    
                                        </span>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <div class="w-100 d-flex align-items-center gap-2 flex-wrap justify-content-between">
                                    <h3 class="mb-0"><?php echo e(translate('3rd Card')); ?></h3>
                                    <label class="toggle-switch h--45px toggle-switch-sm d-flex justify-content-between gap-4">
                                        <span class="w-auto switch--label text-nowrap fs-14 text-title">
                                            <?php echo e(translate('messages.Status')); ?>                                    
                                        </span>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <div class="w-100 d-flex align-items-center gap-2 flex-wrap justify-content-between">
                                    <h3 class="mb-0"><?php echo e(translate('4th Card')); ?></h3>
                                    <label class="toggle-switch h--45px toggle-switch-sm d-flex justify-content-between gap-4">
                                        <span class="w-auto switch--label text-nowrap fs-14 text-title">
                                            <?php echo e(translate('messages.Status')); ?>                                    
                                        </span>
                        ...
                        <div class="row g-xl-20 g-1">
                            <div class="col-xl-4 col-lg-6 col-6">
                                <div class="bg-ECEEF1 w-100 gallery-thumb-h-450 rounded-10">
                                    <img src="<?php echo e(asset('/assets/admin/img/400x400/ract-gallery1.jpg')); ?>" alt="" class="rounded-10 w-100 h-100">
                                </div>
                            </div>
                                ...
                                <div class="row g-xl-20 g-1">
                                    <div class="col-xl-6 col-6">
                                        <div class="bg-ECEEF1 w-100 gallery-thumb-h-220 rounded-10">
                                            <img src="<?php echo e(asset('/assets/admin/img/400x400/ract-gallery2.jpg')); ?>" alt="" class="rounded-10 w-100 h-100">
                                        </div>
                                    </div>
                                    <div class="col-xl-6 col-6">
                                        <div class="bg-ECEEF1 w-100 gallery-thumb-h-220 rounded-10">
                                            <img src="<?php echo e(asset('/assets/admin/img/400x400/ract-gallery3.jpg')); ?>" alt="" class="rounded-10 w-100 h-100">
                                        </div>
                                    </div>
                                    <div class="col-xl-12">
                                        <div class="bg-ECEEF1 w-100 gallery-thumb-h-220 rounded-10">
                                            <img src="<?php echo e(asset('/assets/admin/img/400x400/ract-gallery4.jpg')); ?>" alt="" class="rounded-10 w-100 h-100">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\test\React_Landing\gallery-section.blade.php ENDPATH**/ ?>