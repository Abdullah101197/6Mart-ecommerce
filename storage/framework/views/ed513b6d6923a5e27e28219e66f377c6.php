                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    <?php if(\App\CentralLogics\Helpers::module_permission_check('settings')): ?>
                        ...
                        <li
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li
                                    ...
                                    <a class="nav-link "
                                        href="<?php echo e(route('admin.business-settings.admin-landing-page-settings', 'setup')); ?>"
                        ...
                        <li
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display:<?php echo e(Request::is('admin/business-settings/third-party*') || Request::is('admin/business-settings/fcm*') || Request::is('admin/business-settings/login-url-setup*') || Request::is('admin/business-settings/offline-payment*')|| Request::is('admin/business-settings/marketing/*') || Request::is('admin/business-settings/open-ai') || Request::is('admin/business-settings/open-ai-settings') ? 'block' : 'none'); ?>">
                                <li
                                    class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/business-settings/third-party*') && !Request::is('admin/business-settings/third-party/payment-method*') ? 'active' : ''); ?>">
                                    <a class="nav-link "
                                        href="<?php echo e(route('admin.business-settings.third-party.sms-module')); ?>"
                                ...
                                <li
                                        class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/business-settings/third-party/payment-method') || Request::is('admin/business-settings/offline-payment') ? 'active' : ''); ?>">
                                        <a class="nav-link " href="<?php echo e(route('admin.business-settings.third-party.payment-method')); ?>"
                                            title="<?php echo e(translate('Payment Setup')); ?>">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span
                                                class="text-truncate"><?php echo e(translate('Payment Setup')); ?></span>
                                        </a>
                                </li>
                                

                                <li class="nav-item <?php echo $__env->yieldContent('analytics_Script'); ?>">
                                    <a class="nav-link " href="<?php echo e(route('admin.business-settings.marketing.analytic')); ?>"
                                        title="<?php echo e(translate('Analytics_Script')); ?>">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate"><?php echo e(translate('Analytics_Script')); ?></span>
                                    </a>
                                </li>

                                <li class="nav-item <?php echo $__env->yieldContent('openAI'); ?>">
                                    <a class="nav-link " href="<?php echo e(route('admin.business-settings.openAI')); ?>"
                                        title="<?php echo e(translate('AI_Setup')); ?>">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate"><?php echo e(translate('AI_Setup')); ?></span>
                                    </a>
                                </li>
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/business-settings/language*') ?'active':''); ?>">
                            <a class="nav-link " href="<?php echo e(route('admin.business-settings.language.index')); ?>"
                                title="<?php echo e(translate('Language Setup')); ?>">
                                <span class="tio-keyboard nav-icon"></span>
                                <span class="text-truncate"><?php echo e(translate('Language Setup')); ?></span>
                            </a>
                        </li>
                        <li
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/business-settings/page-meta-data*') || Request::is('admin/business-settings/login-url-setup*') ? 'active' : ''); ?>">
                            <a class="nav-link " href="<?php echo e(route('admin.business-settings.seo-settings.pageMetaData')); ?>"
                                title="<?php echo e(translate('messages.page_meta_data')); ?>">
                                <span class="tio-share-message nav-icon"></span>
                                <span
                                    class="text-truncate text-capitalize"><?php echo e(translate('messages.page_meta_data')); ?></span>
                            </a>
                        </li>
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/business-settings/websocket') ? 'active' : ''); ?>">
                            <a class="nav-link " href="<?php echo e(route('admin.business-settings.websocket')); ?>"
                                title="<?php echo e(translate('messages.websocket')); ?>">
                                <span class="tio-link nav-icon"></span>
                                <span class="text-truncate"><?php echo e(translate('messages.websocket')); ?></span>
                            </a>
                        </li>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\layouts\admin\partials\_sidebar_settings.blade.php ENDPATH**/ ?>