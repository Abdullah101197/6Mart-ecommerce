            ...
            <div class="row g-2">
                <div class="col-lg-12">
                        ...
                        <div class="card-body">
                            ...
                            <div class="fs-12 text-dark px-3 py-2 bg-opacity-10 rounded bg-info mt-20">
                                <div class="d-flex align-items-center gap-2 mb-0">
                                    ...
                                    <span>
                                        <?php echo e(translate('You may setup')); ?> <strong><?php echo e(translate(' Registration Form ')); ?></strong> <?php echo e(translate('from')); ?> <strong class="text-primary"><?php echo e(translate('Deliveryman Registration Form')); ?></strong> <?php echo e(translate('page to work properly.')); ?>
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        ...
                                        <div class="form-label mb-0">
                                            <label class="d-flex text-capitalize"
                                                ...
                                                <span class="line--limit-1">
                                                    <?php echo e(translate('Cash In hand Max Amount($)')); ?> (<?php echo e(\App\CentralLogics\Helpers::currency_symbol()); ?>)
                                                </span>
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        ...
                                        <div class="form-label mb-0">
                                            <label class="text-capitalize"
                                                ...
                                                <span>
                                                    <?php echo e(translate('Minimum Payable Amount($)')); ?> (<?php echo e(\App\CentralLogics\Helpers::currency_symbol()); ?>)
                    ...
                    <div class="btn--container justify-content-end mt-4">
                        ...
                        <button type="submit" id="submit" class="btn min-w-120px btn--primary"><i class="tio-save"></i> <?php echo e(translate('messages.save_information')); ?></button>
                    </div>
                </div>
            </div>
        </form>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\test\business-setting\deliveryman-index.blade.php ENDPATH**/ ?>