        ...
        <?php if(isset($data['1']) && count($data['1'])): ?>
            ...
            <div class="d-inline-flex align-items-center">
                <span class="start--time">
                    ...
                    <span class="info">
                        <span><?php echo e(translate('messages.opening_time')); ?></span>
                ...
                <span class="end--time">
                    ...
                    <span class="info">
                        <span><?php echo e(translate('messages.closing_time')); ?></span>
                        <?php echo e(date(config('timeformat'), strtotime($day['end_time']))); ?>

                    </span>
                </span>
                <span class="dismiss--date delete-schedule"
                      data-url="<?php echo e(route('vendor.business-settings.remove-schedule',['store_schedule'=>$day['id']])); ?>"
                      ><i class="tio-clear-circle-outlined"></i></span>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php else: ?>
            <span class="btn btn-sm btn-outline-danger m-1 disabled"><?php echo e(translate('messages.Off_day')); ?></span>
        <?php endif; ?>
...
<?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\vendor-views\business-settings\partials\_schedule.blade.php ENDPATH**/ ?>