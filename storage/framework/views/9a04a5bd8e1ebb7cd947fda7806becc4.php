<?php use App\CentralLogics\Helpers;use App\Models\DataSetting; ?>
    ...
    <div class="content container-fluid">
        ...
        <div class="card py-3 px-xxl-4 px-3 mb-20">
            <div class="d-flex flex-sm-nowrap flex-wrap gap-3 align-items-center justify-content-between">
                <div class="">
                    <h3 class="mb-1"><?php echo e(translate('Gallery Section')); ?></h3>
                    <p class="mb-0 gray-dark fs-12">
                        <?php echo e(translate('See how your Gallery Section will look to customers.')); ?>
        ...
        <div class="card py-3 px-xxl-4 px-3 mb-15 mt-4">
            <div class="row g-3 align-items-center justify-content-between">
                <div class="col-xxl-9 col-lg-8 col-md-7 col-sm-6">
                    <div class="">
                        <h3 class="mb-1"><?php echo e(translate('Show Gallery Section')); ?></h3>
                        <p class="mb-0 gray-dark fs-12">
                ...
                <div class="col-xxl-3 col-lg-4 col-md-5 col-sm-6">
                    <div class="py-2 px-3 rounded d-flex justify-content-between border align-items-center w-300">
                        ...
                        <form
                            action="<?php echo e(route('admin.business-settings.statusUpdate', ['type' => 'react_landing_page', 'key' => 'gallery_section_status'])); ?>"
                        ...
                        <label class="toggle-switch toggle-switch-sm" for="CheckboxStatus">
                            <input type="checkbox" data-id="CheckboxStatus" data-type="status"
                                ...
                                <?php echo e($gallery_section_status?->value ? 'checked' : ''); ?>>
        ...
        <div class="card mb-20">
            <form action="<?php echo e(route('admin.business-settings.react-landing-page-settings', 'gallery-section')); ?>"
                  method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="card-body">
                    <div class="mb-20">
                        <h3 class="mb-1"><?php echo e(translate('messages.Gallery Content')); ?></h3>
                        <p class="m-0 fs-12 color-656566"><?php echo e(translate('Showcase high-quality food images to attract users visually.')); ?></p>
                    </div>
                            ...
                            <?php if($language): ?>
                                    ...
                                    <div class="row g-1">
                                        <div class="col-12">
                                            ...
                                            <input id="gallery_content_title" type="text" maxlength="50"
                                                   ...
                                                   value="<?php echo e($gallery_content_title?->getRawOriginal('value') ?? ''); ?>"
                                                   class="form-control"
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input id="gallery_content_sub_title" type="text" maxlength="200"
                                                   ...
                                                   value="<?php echo e($gallery_content_sub_title?->getRawOriginal('value') ?? ''); ?>"
                                                   class="form-control"
                                ...
                                <?php $__currentLoopData = json_decode($language); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="col-md-12 d-none lang_form" id="<?php echo e($lang); ?>-form">
                                        <div class="row g-1">
                                            <div class="col-12">
                                                <label for="gallery_content_title<?php echo e($lang); ?>"
                                                       class="form-label"><?php echo e(translate('Title')); ?>
                                                ...
                                                <input id="gallery_content_title<?php echo e($lang); ?>" type="text" maxlength="50"
                                                       name="gallery_content_title[]"
                                                       value="<?php echo e($gallery_content_title_translate[$lang]['value'] ?? ''); ?>"
                                                       class="form-control"
                                                       placeholder="<?php echo e(translate('messages.title_here...')); ?>">
                                                <span
                                                    class="text-right text-counting color-A7A7A7 d-block mt-1">0/50</span>
                                            ...
                                            <div class="col-12">
                                                <label for="gallery_content_sub_title<?php echo e($lang); ?>"
                                                       class="form-label"><?php echo e(translate('Sub Title')); ?>
                                                ...
                                                <input id="gallery_content_sub_title<?php echo e($lang); ?>" type="text"
                                                       maxlength="200"
                                                       name="gallery_content_sub_title[]"
                                                       value="<?php echo e($gallery_content_sub_title_translate[$lang]['value'] ?? ''); ?>"
                                                       class="form-control"
                                                       placeholder="<?php echo e(translate('messages.sub_title_here...')); ?>">
                                                <span
                                                    class="text-right text-counting color-A7A7A7 d-block mt-1">0/200</span>
        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="">
                    <h3 class="mb-0"><?php echo e(translate('Gallery Section Image')); ?></h3>
                </div>
            </div>
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <?php for($i = 1; $i<=4;$i++): ?>
                        ...
                        <div class="col-md-6">
                            <form class="custom-validation"
                                  action="<?php echo e(route('admin.business-settings.react-landing-page-settings', 'gallery-section-images')); ?>"
                                  method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" value="<?php echo e($i); ?>" name="gallery_tab">
                                <div class="card">
                                    <div class="card-header">
                                        <div
                                            class="w-100 d-flex align-items-center gap-2 flex-wrap justify-content-between">
                                            <h3 class="mb-0"><?php echo e($label); ?></h3>
                                            <label
                                        ...
                                        <span class="w-auto switch--label text-nowrap fs-14 text-title">
                                            <?php echo e(translate('messages.Status')); ?>
                                                ...
                                                <input type="checkbox" class="status toggle-switch-input" value="1"
                                                       name="gallery_image_<?php echo e($i); ?>_status"
                                                       id="" <?php echo e($status?->value ? 'checked' : ''); ?>>
                                                <span class="toggle-switch-label text">
                                            <span class="toggle-switch-indicator"></span>
                                        </span>
                                            </label>
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="text-center py-1">
                                                <div class="mx-auto text-center error-wrapper">
                                                    <div class="mb-4">
                                                        ...
                                                        <p class="mb-0 fs-12 gray-dark"><?php echo e(translate('Upload ') . $label); ?></p>
                                                    </div>
                                                    <div class="upload-file_custom">
                                                        <input type="file" id="gallery_image_input_<?php echo e($i); ?>"
                                                               name="gallery_image_<?php echo e($i); ?>"
                                                               class="upload-file__input single_file_input"
                                                               accept=".webp, .jpg, .jpeg, .png, .gif" <?php echo e($image?->value ? '': 'required'); ?>>
                                                        <label class="upload-file__wrapper ratio-1 m-0">
                                                            ...
                                                            <img class="upload-file-img" loading="lazy"
                                                                 ...
                                                                 data-default-src="<?php echo e($imageUrl ??''); ?>"
                                                                 alt=""
                                                            >
                                                        </label>
                                                        <div class="overlay">
                                                            <div
                                                                ...
                                                                <input type="hidden"
                                                                       name="gallery_image_<?php echo e($i); ?>_remove"
                                                                       id="gallery_image_<?php echo e($i); ?>"
                                                                       value="1"
                                                                       disabled>

                                                                <button type="button"
                                                                        class="remove_btn btn icon-btn"
                                                                        data-card="<?php echo e($i); ?>">
                                        ...
                                        <div class="btn--container justify-content-end mt-20">
                                            <button type="reset"
                                                    class="btn btn--reset mb-2"><?php echo e(translate('Reset')); ?></button>
                                            <button type="submit"
        ...
        <form action="<?php echo e(route('taxvat.store')); ?>" method="post">
            <div>
                <div
                    ...
                    <div class="py-1">
                        <h3 class="mb-0 line--limit-1"><?php echo e(translate('messages.Gallery Section Preview')); ?></h3>
                    </div>
                    <button type="button"
                    ...
                    <section class="common-section-view bg-white border rounded-10">
                        <div class="mb-4 text-center">
                            <h2 class="mb-lg-1 mb-1 fs-24">
                                <?php echo Helpers::highlightWords($gallery_content_title?->value ?? 'See $6amMart$ in Action'); ?>

                            </h2>
                            <p class="text-title fs-14 m-0">
                                <?php echo e($gallery_content_sub_title?->value ?? 'Explore how customers use our services, vendors grow their business'); ?>
                            ...
                            <div class="row g-xl-20 g-1">
                                <div class="col-xl-4 col-lg-6 col-6">
                                    <div class="bg-ECEEF1 w-100 gallery-thumb-h-450 rounded-10">
                                        <img src="<?php echo e($gallery_image_1?->value
                                ? Helpers::get_full_url(
                                    'gallery_section',
                                    ...
                                    <div class="row g-xl-20 g-1">
                                        <div class="col-xl-6 col-6">
                                            <div class="bg-ECEEF1 w-100 gallery-thumb-h-220 rounded-10">
                                                <img
                                                    src="<?php echo e($gallery_image_2?->value
                                ? Helpers::get_full_url(
                                    'gallery_section',
                                ...
                                :asset('/assets/admin/img/400x400/ract-gallery2.jpg')); ?>"
                                        ...
                                        <div class="col-xl-6 col-6">
                                            <div class="bg-ECEEF1 w-100 gallery-thumb-h-220 rounded-10">
                                                <img
                                                    src="<?php echo e($gallery_image_3?->value
                                ? Helpers::get_full_url(
                                    'gallery_section',
                                ...
                                :asset('/assets/admin/img/400x400/ract-gallery3.jpg')); ?>"
                                        ...
                                        <div class="col-xl-12">
                                            <div class="bg-ECEEF1 w-100 gallery-thumb-h-220 rounded-10">
                                                <img
                                                    src="<?php echo e($gallery_image_4?->value
                                ? Helpers::get_full_url(
                                    'gallery_section',
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\business-settings\landing-page-settings\react-landing-page-gallery.blade.php ENDPATH**/ ?>