...
<?php $__env->startSection('content'); ?>
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="<?php echo e(asset('assets/admin/img/firebase_auth.png')); ?>" class="w--26" alt="">
                </span>
                <span>
        ...
        <form
            action="<?php echo e(env('APP_MODE')!='demo'?route('admin.business-settings.third-party.firebase_otp_update',['recaptcha']):'javascript:'); ?>"
            method="post">
            <?php echo csrf_field(); ?>
            <div class="row g-3">
                <div class="col-lg-12">
                                        ...
                                        <label
                                            ...
                                            <span class="pr-1 d-flex align-items-center switch--label">
                                                <span class="line--limit-1">
                                                    <?php echo e(translate('Firebase_OTP_Verification_Status')); ?>

                                                </span>
                                                <span class="form-label-secondary text-danger d-flex"
                                                      data-toggle="tooltip" data-placement="right"
                                                      data-original-title="<?php echo e(translate('If_this_field_is_active_customers_get_the_OTP_through_Firebase.')); ?>"><img
                                                        src="<?php echo e(asset('/assets/admin/img/info-circle.svg')); ?>"
                                                        alt="<?php echo e(translate('messages.firebase_otp_verification')); ?>"> *
                                                </span>
                                            </span>
                                            <input type="checkbox"
                                                   ...
                                                   data-title-on="<strong><?php echo e(translate('Want to enable Firebase OTP Verification?')); ?></strong>"
                                                   data-title-off="<strong><?php echo e(translate('Want to disable Firebase OTP Verification?')); ?></strong> "
                                                   data-text-on="<p><?php echo e(translate('With Firebase OTP enabled, verification codes will be sent through Firebase.') .' </p>' .'  <p>   <strong>
                                            Note: ' . translate('Enable Firebase OTP means users will not receive verification codes through Email or SMS Although those methods are activated.') .'</strong>'); ?></p>"
                                                   data-text-off="<p><?php echo e(translate('If you disable Firebase OTP, users will no longer receive verification codes via Firebase. You must activate Email or SMS verification as an alternative')); ?></p>"
                                                   class="status toggle-switch-input dynamic-checkbox-toggle"
                                                   value="1"
                                                   name="firebase_otp_verification" id="firebase_otp_verification"
                                                <?php echo e($firebase_otp_verification == 1 ? 'checked' : ''); ?>>
                                ...
                                <div class="col-lg-6 col-sm-6">
                                    ...
                                    <div class="form-group mb-0">
                                        <label class=" input-label text-capitalize"
                                            ...
                                            <span>
                                                <?php echo e(translate('Web_API_key')); ?>
                                        ...
                                        <input type="text" name="firebase_web_api_key" class="form-control"
                                               ...
                                               value="<?php echo e($firebase_web_api_key ? $firebase_web_api_key->value : ''); ?>"  required>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="text-center my-5">
                        <img src="<?php echo e(asset('assets/admin/img/modal/bell.png')); ?>">
                    </div>

                    <h5 class="modal-title my-3" id="instructionsModalLabel"><?php echo e(translate('Instructions')); ?></h5>
                    <p><?php echo e(translate('For configuring OTP in the Firebase, you must create a Firebase project first.If you haven’t created any project for your application yet, please create a project first.')); ?>

                    </p>
                    <p><?php echo e(translate('Now go the')); ?> <a href="https://console.firebase.google.com/" target="_blank">Firebase console </a><?php echo e(translate('and follow the instructions below')); ?> -</p>
                    <ol class="d-flex flex-column __gap-5px __instructions">
                        <li><?php echo e(translate('Go to your Firebase project.')); ?></li>
                        <li><?php echo e(translate('Navigate to the Build menu from the left sidebar and select Authentication.')); ?></li>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\business-settings\firebase-otp-index.blade.php ENDPATH**/ ?>