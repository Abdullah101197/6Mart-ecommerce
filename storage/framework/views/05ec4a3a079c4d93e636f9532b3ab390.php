    ...
    <div class="content container-fluid">
        ...
        <div class="card py-3 px-xxl-4 px-3 mb-20">
            <div class="d-flex flex-sm-nowrap flex-wrap gap-3 align-items-center justify-content-between">
                <div class="">
                    <h3 class="mb-1"><?php echo e(translate('Available zone section')); ?></h3>
                    <p class="mb-0 gray-dark fs-12">
                        <?php echo e(translate('See how your Available zone Section will look to customers.')); ?>
        ...
        <div class="card shadow-none border-0 bg-opacity-primary-10 mb-20">
            <div class="card-body d-flex gap-2 align-items-center">
                ...
                <p class="fs-12 color-656566 m-0">
                    <?php echo e(translate('Customize the section by adding a title, short description, and images in the')); ?> <a
                        href="<?php echo e(route('admin.business-settings.zone.home')); ?>" target="_blank"
                        class="text--underline text-006AE5"><?php echo e(translate('Zone Setup')); ?></a> <?php echo e(translate('section. All created zones will be automatically displayed on the React Landing Page. The zones will be based on the Zone Display Name.')); ?>
            ...
            <div class="card py-3 px-xxl-4 px-3 mb-15 mt-4">
                <div class="row g-3 align-items-center justify-content-between">
                    <div class="col-xxl-9 col-lg-8 col-md-7 col-sm-6">
                        <div>
                            <h3 class="mb-1"><?php echo e(translate('messages.Show available zone')); ?></h3>
                            <p class="m-0 fs-12 color-656566"><?php echo e(translate('To view a list of all active zones on your React Landing Page Enable the')); ?>  <?php echo e(translate('')); ?> <?php echo e(translate('`Available Zones`')); ?> <?php echo e(translate('feature')); ?></p>
                        </div>
                    </div>
                    <div class="col-xxl-3 col-lg-4 col-md-5 col-sm-6">
                        <div class="py-2 px-3 rounded d-flex justify-content-between border align-items-center w-300">
                            ...
                            <form
                                action="<?php echo e(route('admin.business-settings.statusUpdate', ['type' => 'react_landing_page', 'key' => 'available_zone_status'])); ?>"
                            ...
                            <label class="toggle-switch toggle-switch-sm" for="CheckboxStatus">
                                <input type="checkbox" data-id="CheckboxStatus" data-type="status"
                                    ...
                                    <?php echo e($available_zone_status ? 'checked' : ''); ?>>
        ...
        <form id="zone-setup-form"
              action="<?php echo e(route('admin.business-settings.react-landing-page-settings', 'available-zone-section')); ?>"
            ...
            <div class="row g-3">
                <div class="col-lg-12">
                    <div class="card shadow--card-2">
                        <div class="card-body">
                            <div class="mb-20">
                                <h3 class="mb-1"><?php echo e(translate('Available Zone Content ')); ?></h3>
                                <p class="mb-0 fs-12"><?php echo e(translate('Manage delivery zones or cities available for your service.')); ?></p>
                            </div>
                                    ...
                                    <div class="lang_form"
                                        ...
                                        <div class="form-group mb-2">
                                            ...
                                            <input type="text" name="available_zone_title[]" maxlength="50"
                                                   id="default_title"
                                                   class="form-control" placeholder="<?php echo e(translate('messages.title')); ?>"
                                                   value="<?php echo e($available_zone_title?->getRawOriginal('value')); ?>">
                                        ...
                                        <div class="form-group mb-0">
                                            ...
                                            <textarea type="text" name="available_zone_short_description[]"
                                                      ...
                                                      class="form-control min-h-90px ckeditor"><?php echo e($available_zone_short_description?->getRawOriginal('value')); ?></textarea>
                                        </div>
                                    </div>
                                    <?php $__currentLoopData = json_decode($language); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                        ...
                                        <div class="d-none lang_form"
                                            ...
                                            <div class="form-group mb-2">
                                                ...
                                                <input type="text" name="available_zone_title[]" maxlength="50"
                                                       id="<?php echo e($lang); ?>_title"
                                                       class="form-control"
                                                       value="<?php echo e($available_zone_title_translate[$lang]['value']??''); ?>"
                                            ...
                                            <div class="form-group mb-0">
                                                <label class="input-label"
                                                    ...
                                                    (<?php echo e(strtoupper($lang)); ?>)<span class="form-label-secondary"
                                                                                   data-toggle="tooltip"
                                                                                   data-placement="right"
                                                                                   data-original-title="<?php echo e(translate('Write_the_short_description_within_200_characters')); ?>">
                                                    <i class="tio-info color-A7A7A7"></i>
                                                </span></label>
                                                <textarea type="text" name="available_zone_short_description[]"
                                                          maxlength="1000"
                                                          placeholder="<?php echo e(translate('messages.short_description')); ?>"
                                                          class="form-control min-h-90px ckeditor"><?php echo e($available_zone_short_description_translate[$lang]['value']??''); ?></textarea>
                                            </div>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php else: ?>
                                    <div id="default-form">
                                        <div class="form-group">
                                            <label class="input-label"
                                                   for="exampleFormControlInput1"><?php echo e(translate('messages.title')); ?>
        ...
        <form action="<?php echo e(route('taxvat.store')); ?>" method="post">
            <div>
                <div
                    ...
                    <div class="py-1">
                        <h3 class="mb-0 line--limit-1"><?php echo e(translate('messages.Available zone section Preview')); ?></h3>
                    </div>
                    <button type="button"
                        ...
                        <div
                            ...
                            <div class="max-w-400px">
                                <h2 class="mb-xl-2 mb-1 fs-24">
                                    <?php echo \App\CentralLogics\Helpers::highlightWords(text:$available_zone_title?->value ?? 'Available Delivery $Areas / Zone$'); ?>

                                </h2>
                                <?php if($available_zone_short_description?->value): ?>
                                    <p class="text-title fs-12 mb-20">
                                        <?php echo nl2br($available_zone_short_description?->value); ?>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\business-settings\landing-page-settings\react-landing-available-zone.blade.php ENDPATH**/ ?>