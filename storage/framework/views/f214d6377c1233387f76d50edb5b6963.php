            ...
            <tr>
                <td class="main-table-td">
                    ...
                    <div class="mb-1" >
                        ...
                        <h6>
                            <?php echo e(translate('messages.Email')); ?> : <?php echo e($email); ?>

                        </h6>
                        <h6>
                            <?php echo e(translate('messages.Password')); ?> : <?php echo e($password); ?>

                        </h6>


                    </div>
                    <div class="mb-1" id="mail-body2"><?php echo $body_2; ?></div>
                    <hr>
