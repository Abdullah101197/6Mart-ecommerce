...
<div class="content container-fluid">
    ...
    <div class="card py-3 px-xxl-4 px-3 mb-20">
        <div class="d-flex flex-sm-nowrap flex-wrap gap-3 align-items-center justify-content-between">
            <div class="">
                <h3 class="mb-1"><?php echo e(translate('Banner Section')); ?></h3>
                <p class="mb-0 gray-dark fs-12">
                    <?php echo e(translate('See how your Banner Section will look to customers.')); ?>
    ...
    <div class="card py-3 px-xxl-4 px-3 mb-15 mt-4">
        <div class="row g-3 align-items-center justify-content-between">
            <div class="col-xxl-9 col-lg-8 col-md-7 col-sm-6">
                <div class="">
                    <h3 class="mb-1"><?php echo e(translate('Show Banner Section')); ?></h3>
                    <p class="mb-0 gray-dark fs-12">
            ...
            <div class="col-xxl-3 col-lg-4 col-md-5 col-sm-6">
                <div class="py-2 px-3 rounded d-flex justify-content-between border align-items-center w-300">
                    ...
                    <form
                        action="<?php echo e(route('admin.business-settings.statusUpdate', ['type' => 'react_landing_page', 'key' => 'banner_section_status'])); ?>"
                    ...
                    <label class="toggle-switch toggle-switch-sm" for="CheckboxStatus">
                        <input type="checkbox" data-id="CheckboxStatus" data-type="status"
                            ...
                            <?php echo e($banner_section_status?->value ? 'checked' : ''); ?>>
    ...
    <div class="card">
    <form class="custom-validation" action="<?php echo e(route('admin.business-settings.react-landing-page-settings', 'banner')); ?>"
          method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="card-body">
            <div class="mb-4">
                <h3 class="mb-1"><?php echo e(translate('Banner')); ?></h3>
                <p class="mb-0 fs-12 gray-dark">
                    <?php echo e(translate('Upload an image that represents your brand and makes users want to order immediately.')); ?>
                ...
                <div class="col-12">
                    <div class="bg--secondary h-100 rounded p-md-4 p-3">
                        <div class="text-center py-2">
                            <div class="mb-4">
                                <h5 class="mb-1"><?php echo e(translate('Upload Banner Image')); ?></h5>
                                <p class="mb-0 fs-12 gray-dark"><?php echo e(translate('Upload your Banner Image')); ?></p>
                            </div>
                            ...
                            <div class="mx-auto text-center error-wrapper">
                                <div class="upload-file_custom ratio-8-1 h-100px">
                                    <input type="file" name="banner"
                                           ...
                                           <?php echo e($banner?->value ? '' : 'required'); ?>>

                                    <label class="upload-file__wrapper w-100 h-100 m-0">
                                        <div class="upload-file-textbox text-center"
                                             style="<?php echo e($banner?->value ? 'display: none;' : ''); ?>">
                                        ...
                                        <img class="upload-file-img"
                                             src="<?php echo e($banner?->value
                                                 ? \App\CentralLogics\Helpers::get_full_url('banner_section', $banner->value, $banner->storage[0]?->value ?? 'public', 'aspect_1')
                                                 : ''); ?>"
                                             data-default-src="<?php echo e($banner?->value
                                                 ? \App\CentralLogics\Helpers::get_full_url('banner_section', $banner->value, $banner->storage[0]?->value ?? 'public', 'aspect_1')
                                                 : ''); ?>"
                                             style="<?php echo e($banner?->value ? 'display:block;' : 'display:none;'); ?>">
                                    </label>
                            ...
                            <p class="fs-10 text-center mb-0 mt-lg-4 mt-3">
                                ...
                                <span class="font-medium text-title"><?php echo e(translate('(8:1)')); ?></span>
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <form action="<?php echo e(route('taxvat.store')); ?>" method="post">
        <div>
            <div
                ...
                <div class="py-1">
                    <h3 class="mb-0 line--limit-1"><?php echo e(translate('messages.Banner Section Preview')); ?></h3>
                </div>
                <button type="button"
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\business-settings\landing-page-settings\react-landing-page-banner-section.blade.php ENDPATH**/ ?>