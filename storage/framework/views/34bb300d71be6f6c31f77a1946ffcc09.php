    ...
    <div class="content container-fluid config-inline-remove-class">
        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="<?php echo e(asset('assets/admin/img/config.png')); ?>" class="w--30" alt="">
                </span>
                <span>
            ...
            <div class="card-body py-3">
                <div class="d-flex flex-row justify-content-between align-items-center">
                    <h4 class="card-title align-items-center d-flex">
                        <img src="<?php echo e(asset('assets/admin/img/store.png')); ?>" class="w--20 mr-1" alt="">
        ...
        <div class="card mb-3">
            <div class="card-header">
                <h5 class="card-title">
                    <span class="card-header-icon">
                        <img class="w--22" src="<?php echo e(asset('assets/admin/img/store.png')); ?>" alt="">
                    </span>
...
<?php echo $__env->make('layouts.vendor.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\vendor-views\business-settings\restaurant-index.blade.php ENDPATH**/ ?>