...
<?php $__env->startSection('title',translate('messages.Edit Surge Price')); ?>
...
<div class="content container-fluid">
    ...
    <h3 class="mb-20"><?php echo e(translate('Edit Surge Price')); ?></h3>
      <form action="<?php echo e(route('admin.business-settings.zone.surge-price.update', $surge->id)); ?>" method="post" id="surge_form">
        <?php echo csrf_field(); ?>
        <div class="card mb-20">
            <div class="card-header">
                <h4 class="mb-0"><?php echo e(translate('Basic Setup')); ?></h4>
            </div>
            <div class="card-body">
                <?php if($language): ?>
                ...
                <div class="lang_form" id="default-form">
                    <div class="form-group">
                        <label class="input-label" for="surgePrice_default"><?php echo e(translate('messages.Surge Price name')); ?> ( <?php echo e(translate('messages.Default')); ?>)
                            <span class="text-danger">*</span>
                        </label>
                        <input autocomplete="off" type="text" name="surge_price_name[]" placeholder="Type surge price name" class="form-control" value="<?php echo e($surge?->getRawOriginal('surge_price_name')); ?>">
                    </div>
                    <div class="form-group mb-0">
                        <div class="d-flex align-items-center gap-1 flex-wrap justify-content-between mb-2">
                            <label class="input-label mb-0" for="surgePrice_default"><?php echo e(translate('messages.Note for Customer')); ?> ( <?php echo e(translate('messages.Default')); ?>)
                            </label>
                            <label class="toggle-switch toggle-switch-sm" for="customerDefault">
                                <input autocomplete="off" type="checkbox" name="customer_note_status" class="toggle-switch-input" id="customerDefault" value="1" <?php echo e($surge?->customer_note_status ? 'checked' : ''); ?>>
                                <span class="toggle-switch-label">
                                    <span class="toggle-switch-indicator"></span>
                                </span>
                            </label>
                        </div>
                        <input autocomplete="off" type="text" name="customer_note[]" placeholder="Type note for customer" class="form-control" value="<?php echo e($surge?->getRawOriginal('customer_note')); ?>">
                        <span class="text-right d-block mt-1"><?php echo e(translate('Character count')); ?> 0/50</span>
                    </div>
                ...
                <?php $__currentLoopData = $language; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="d-none lang_form" id="<?php echo e($lang); ?>-form">
                        <div class="form-group">
                            <label class="input-label" for="surgePrice_default"><?php echo e(translate('messages.Surge Price name')); ?> (<?php echo e(strtoupper($lang)); ?>)
                                <span class="text-danger">*</span>
                            </label>
                            <input autocomplete="off" type="text" name="surge_price_name[]" placeholder="Type surge price name" class="form-control" value="<?php echo e($translate[$lang]['surge_price_name']??''); ?>">
                        </div>
                        <div class="form-group mb-0">
                            <div class="d-flex align-items-center gap-1 flex-wrap justify-content-between mb-2">
                                <label class="input-label mb-0" for="surgePrice_default"><?php echo e(translate('messages.Note for Customer')); ?> (<?php echo e(strtoupper($lang)); ?>)
                                </label>
                            </div>
                            <input autocomplete="off" type="text" name="customer_note[]" placeholder="Type note for customer" class="form-control" value="<?php echo e($translate[$lang]['customer_note']??''); ?>">
                            <span class="text-right d-block mt-1"><?php echo e(translate('Character count')); ?> 0/50</span>
                        </div>
                        <input autocomplete="off" type="hidden" name="lang[]" value="<?php echo e($lang); ?>">
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
        <div class="card mb-20">
            <div class="card-header">
                <h4 class="mb-0"><?php echo e(translate('Module & Surge Price Setup')); ?></h4>
            </div>
            <div class="card-body">
                <div class="row g-4">
                    <div class="col-md-6">
                        <div>
                            <label class="mb-2 d-block title-clr fw-normal"><?php echo e(translate('Module')); ?> <span class="text-danger">*</span></label>
                            ...
                            <select name="module_ids[]" id="module_selected" class="form-control h--45px js-select2-custom" multiple="multiple" placeholder="Module Select" data-placeholder="Module">
                                ...
                                <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($module->id); ?>" <?php echo e(in_array($module->id, $surge->module_ids) ? 'selected' : ''); ?>><?php echo e(translate($module->module_name)); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group mb-0">
                            <label class="mb-2 d-block title-clr fw-normal"><?php echo e(translate('Price Increase Rate')); ?> <span class="text-danger">*</span></label>
                            <div class="custom-group-btn border">
                                <div class="flex-sm-grow-1 w-100">
                                    <input autocomplete="off" id="price" type="number" name="price" class="form-control border-0 pl-unset"
                                            placeholder="Ex: 5" min="0" step="0.001" value="<?php echo e($surge->price); ?>">
                                </div>
                                <div class="flex-shrink-0">
                                    <select name="price_type" id="price_type" class="custom-select ltr border-0">
                                        <option value="percent" <?php echo e($surge->price_type == 'percent' ? 'selected' : ''); ?>>%</option>
                                        <option value="amount" <?php echo e($surge->price_type == 'amount' ? 'selected' : ''); ?>>
        ...
        <div class="card mb-20 shedule-checkbox_wrapper">
            <div class="card-header">
                <h4 class="mb-0"><?php echo e(translate('Duration Setup')); ?></h4>
            </div>
            <div class="card-body">
                <div class="form-group w-100 mb-20">
                    <label class="input-label" for=""><?php echo e(translate('Surge Price Schedule Type')); ?> <span class="text-danger">*</span></label>
                    <div class="resturant-type-group shedule-checkbox-inner flex-md-nowrap border">
                        <label class="form-check w-100 form--check mr-2 mr-md-4">
                            <input autocomplete="off" class="form-check-input" type="radio" value="daily" name="duration_type" <?php echo e($surge->duration_type == 'daily' ? 'checked' : ''); ?>>
                            <span class="form-check-label"><?php echo e(translate('Daily Schedule')); ?></span>
                        </label>
                        <label class="form-check w-100 form--check mr-2 mr-md-4">
                            <input autocomplete="off" class="form-check-input" type="radio" value="weekly" name="duration_type" <?php echo e($surge->duration_type == 'weekly' ? 'checked' : ''); ?>>
                            <span class="form-check-label"><?php echo e(translate('Weekly Schedule')); ?></span>
                        </label>
                        <label class="form-check w-100 form--check mr-2 mr-md-4">
                            <input autocomplete="off" class="form-check-input" type="radio" value="custom" name="duration_type" <?php echo e($surge->duration_type == 'custom' ? 'checked' : ''); ?>>
                            <span class="form-check-label"><?php echo e(translate('Custom Schedule')); ?></span>
                        </label>
                    </div>
                </div>
                <div class="bg-light p-20 p-mobile-0 bg-mobile-transparent">
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div>
                                <h5 class="mb-1"><?php echo e(translate('Duration Setup')); ?></h5>
                                <p class="fs-12 m-0"><?php echo e(translate('Select your suitable time within a time range you want add surge price')); ?></p>
                            </div>
                            ...
                            <div class="change-shedule-wrapper">
                                ...
                                <div class="shedule_item">
                                    <div class="bg-white p-sm-3 d-flex flex-column gap-3">
                                        ...
                                        <div>
                                            <label class="form-label"><?php echo e(translate('Date Range')); ?> <span class="text-danger">*</span></label>
                                            <div class="position-relative date-range__custom">
                                                <i class="tio-calendar-month icon-absolute-on-right"></i>
                                                <input autocomplete="off" type="text" class="form-control h-45 position-relative bg-transparent no-type"  name="daily_date_range" placeholder="<?php echo e(translate('messages.Select_Date')); ?>" value="<?php echo e($surge->duration_type == 'daily' ? $dateRange : ''); ?>">
                                            </div>
                                        </div>
                                        <?php ($timeRange = \Carbon\Carbon::parse($surge->start_time)->format('g:i A') . ' - ' . \Carbon\Carbon::parse($surge->end_time)->format('g:i A')); ?>
                                        <div class="time-range-wrapper">
                                            <label class="form-label"><?php echo e(translate('Time Range')); ?> <span class="text-danger">*</span></label>
                                            <div class="position-relative cursor-pointer">
                                                <i class="tio-time icon-absolute-on-right"></i>
                                                <input autocomplete="off" type="text" class="form-control h-45 position-relative bg-transparent time-range-picker no-type" name="daily_time_range" placeholder="<?php echo e(translate('messages.Select_Time')); ?>" value="<?php echo e($surge->duration_type == 'daily' ? $timeRange : ''); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                     ...
                                     <div class="bg-white p-sm-3 d-flex flex-column gap-3">
                                         ...
                                         <div class="cursor-pointer" data-toggle="modal" data-target="#weeklySelectDays_btn">
                                             ...
                                             <div class="position-relative date-range__custom">
                                                 ...
                                                 <input autocomplete="off" type="text" class="form-control h-45 position-relative bg-transparent date-range-input-demo no-type"
                                                     name="weekly_date_range" placeholder="<?php echo e(translate('messages.Select_Date')); ?>" value="<?php echo e($surge->duration_type == 'weekly' && !$surge->is_permanent ? $weeklyDateRange : ''); ?>">
                                             </div>
                                         </div>
                                        <?php
                                        ...
                                        <?php if($days): ?>
                                            <p class="fs-12 m-0 weekly-summary">
                                                <?php echo e(translate('Every week from')); ?> <span class="font-semibold" id="selected-weekdays-text"><?php echo e($days); ?></span>
                                            </p>
                                        <?php else: ?>
                                            <p class="fs-12 m-0 weekly-summary d-none">
                                                <?php echo e(translate('Every week from')); ?> <span class="font-semibold" id="selected-weekdays-text"></span>
                                            </p>
                                        <?php endif; ?>
                                        <?php ($weeklyTimeRange = \Carbon\Carbon::parse($surge->start_time)->format('g:i A') . ' - ' . \Carbon\Carbon::parse($surge->end_time)->format('g:i A')); ?>
                                         <div class="time-range-wrapper">
                                             ...
                                             <div class="position-relative cursor-pointer">
                                                 <i class="tio-time icon-absolute-on-right"></i>
                                                  <input autocomplete="off" type="text" class="form-control h-45 position-relative bg-transparent time-range-picker no-type" name="weekly_time_range" placeholder="<?php echo e(translate('messages.Select_Time')); ?>" value="<?php echo e($surge->duration_type == 'weekly' ? $weeklyTimeRange : ''); ?>">
                                             </div>
                                         </div>
                                         <input autocomplete="off" type="hidden" name="weekly_days" id="weekly_days" value="<?php echo e(implode(',', $surge->weekly_days??[])); ?>">
                                         <input autocomplete="off" type="hidden" name="is_permanent" id="is_permanent" value="<?php echo e($surge->is_permanent ? 1 : 0); ?>">
                                     </div>
                                 </div>
                                <!-- Custom Schedule -->
                                 <div class="shedule_item">
                                     <div class="bg-white p-sm-3 d-flex flex-column gap-3">
                                         <div class="cursor-pointer" data-toggle="modal" data-target="#surgeCustom_sheduleBtn">
                                             <label class="form-label"><?php echo e(translate('Date & Time Select')); ?> <span class="text-danger">*</span></label>
                                             <div class="position-relative">
                                                ...
                                                ?>
                                                 <i class="tio-calendar-month icon-absolute-on-right"></i>
                                                 <input autocomplete="off" type="text" id="custom_schedule_input" class="form-control h-45 position-relative bg-transparent no-type" name="" placeholder="<?php echo e($placeholderText); ?>">
                                             </div>
                                         </div>
                                         <input autocomplete="off" type="hidden" name="custom_days" id="custom_days" value="<?php echo e(implode(',', array_map('trim', $surge->custom_days?? []))); ?>">
                                         <input autocomplete="off" type="hidden" name="custom_times" id="custom_times" value="<?php echo e(implode(',', array_map('trim', $surge->custom_times?? []))); ?>">
                                        <?php if($surge->duration_type == 'custom' && $surge->details->count() > 0): ?>
                                            <p class="fs-12 m-20" id="custom-date-range-text">
                                                <?php echo e(translate('messages.Date_range')); ?> <span class="font-semibold" id="custom-date-min"><?php echo e($minDate->format('M d, Y')); ?></span> - <span class="font-semibold" id="custom-date-max"><?php echo e($maxDate->format('M d, Y')); ?></span>
                                            </p>
                                        <?php else: ?>
                                           <p class="fs-12 m-20 d-none" id="custom-date-range-text">
                                                <?php echo e(translate('messages.Date_range')); ?> <span class="font-semibold" id="custom-date-min"></span> - <span class="font-semibold" id="custom-date-max"></span>
                                            </p>
                                        <?php endif; ?>
                                        <?php if($surge->duration_type == 'custom' && $surge->details->count() > 0): ?>
                                                ...
                                                <table id="columnSearchDatatable" class="table m-0 table-borderless table-thead-bordered table-align-middle">
                                                    <thead class="thead-light border-0">
                                                        <tr>
                                                            ...
                                                            <th class="border-0 fs-14"><?php echo e(translate('messages.Title')); ?></th>
                                                            <th class="border-0 fs-14 text-center"><?php echo e(translate('messages.Action')); ?></th>
                                                        </tr>
                                                    </thead>
                                                    <tbody id="customScheduleTableBody">
                                                        <?php $__currentLoopData = $surge->details->unique('applicable_date')->values(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $schedule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <tr data-index="<?php echo e($key); ?>">
                                                            <td class="pl-4"><?php echo e($key + 1); ?></td>
                                                            <td>
                                                                <span class="d-block max-w-220px min-w-176px">
                                                                    <span class="d-block text-title"><?php echo e(\Carbon\Carbon::parse($schedule->applicable_date)->format('D, M d')); ?></span>
                                                                    <span><?php echo e($scheduleTimeRange); ?></span>
                                                                </span>
                                                            </td>
                                                            <td>
        ...
        <div class="btn--container justify-content-end mt-20">
            ...
            <button type="submit" class="btn btn--primary min-w-120px"><?php echo e(translate('messages.Submit')); ?></button>
        </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content pb-1">
      <div class="modal-header">
        <div>
            <h3 class="title-clr mb-0"><?php echo e(translate('messages.Select_Days')); ?></h3>
            <p class="fz-12 m-0"><?php echo e(translate('messages.Your_Surge_price_active_date')); ?></p>
        </div>
        ...
        <div class="modal-body-inner">
            <div class="resturant-type-group bg-light rounded p-3 mb-3 gap-4">
                <label class="form-check form--check mr-2 mr-md-4">
                    <input autocomplete="off" class="form-check-input rounded" type="checkbox" value="1" name="days" <?php echo e(in_array('Saturday', $surge->weekly_days??[]) ? 'checked' : ''); ?>>
                    <span class="form-check-label"><?php echo e(translate('messages.Saturday')); ?></span>
                </label>
                <label class="form-check form--check mr-2 mr-md-4">
                    <input autocomplete="off" class="form-check-input rounded" type="checkbox" value="0" name="days" <?php echo e(in_array('Sunday', $surge->weekly_days??[]) ? 'checked' : ''); ?>>
                    <span class="form-check-label"><?php echo e(translate('messages.Sunday')); ?></span>
                </label>
                <label class="form-check form--check mr-2 mr-md-4">
                    <input autocomplete="off" class="form-check-input rounded" type="checkbox" value="0" name="days" <?php echo e(in_array('Monday', $surge->weekly_days??[]) ? 'checked' : ''); ?>>
                    <span class="form-check-label"><?php echo e(translate('messages.Monday')); ?></span>
                </label>
                <label class="form-check form--check mr-2 mr-md-4">
                    <input autocomplete="off" class="form-check-input rounded" type="checkbox" value="0" name="days" <?php echo e(in_array('Tuesday', $surge->weekly_days??[]) ? 'checked' : ''); ?>>
                    <span class="form-check-label"><?php echo e(translate('messages.Tuesday')); ?></span>
                </label>
                <label class="form-check form--check mr-2 mr-md-4">
                    <input autocomplete="off" class="form-check-input rounded" type="checkbox" value="0" name="days" <?php echo e(in_array('Wednesday', $surge->weekly_days??[]) ? 'checked' : ''); ?>>
                    <span class="form-check-label"><?php echo e(translate('messages.Wednesday')); ?></span>
                </label>
                <label class="form-check form--check mr-2 mr-md-4">
                    <input autocomplete="off" class="form-check-input rounded" type="checkbox" value="0" name="days" <?php echo e(in_array('Thursday', $surge->weekly_days??[]) ? 'checked' : ''); ?>>
                    <span class="form-check-label"><?php echo e(translate('messages.Thursday')); ?></span>
                </label>
                <label class="form-check form--check mr-2 mr-md-4">
                    <input autocomplete="off" class="form-check-input rounded" type="checkbox" value="0" name="days" <?php echo e(in_array('Friday', $surge->weekly_days??[]) ? 'checked' : ''); ?>>
                    <span class="form-check-label"><?php echo e(translate('messages.Friday')); ?></span>
                </label>
            </div>
            <div class="bg-light rounded p-3">
                <div class="mb-20">
                    <h5 class="title-clr mb-0"><?php echo e(translate('messages.Date_Range')); ?></h5>
                    <p class="fz-12"><?php echo e(translate('messages.Select_the_date_range_you_want_to_repeat_this_cycle_every_week')); ?></p>
                </div>
                <div class="mb-20">
                    <label class="form-label"><?php echo e(translate('messages.Date_Range')); ?> <span class="text-danger">*</span></label>
                    <div class="position-relative date-range__custom">
                        <i class="tio-calendar-month icon-absolute-on-right"></i>
                        <input autocomplete="off" type="text" class="form-control h-45 position-relative <?php echo e($surge->is_permanent ? 'bg-transparent' : ''); ?> no-type"  name="dates" placeholder="<?php echo e(translate('messages.Select_Date')); ?>" value="<?php echo e($surge->duration_type && !$surge->is_permanent == 'weekly' ? $weeklyDateRange : ''); ?>" id="weekly_modal_date" <?php echo e($surge->is_permanent ? 'disabled' : ''); ?>>
                    </div>
                </div>
                <label class="form-check form--check mr-2 mr-md-4">
                    <input autocomplete="off" class="form-check-input rounded" type="checkbox" value="1" name="assign" <?php echo e($surge->is_permanent ? 'checked' : ''); ?> id="weekly_is_permanent">
                    <span class="form-check-label"><?php echo e(translate('messages.Assign_this_surge_price_permanently')); ?></span>
                </label>
            </div>
        </div>
      </div>
      <div class="modal-footer justify-content-end border-0 pt-0 gap-2">
        ...
        <button type="button" class="btn min-w-120px btn--primary yes_date"><?php echo e(translate('messages.Yes')); ?></button>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="modal-dialog modal-dialog modal-lg" modal-dialog-centered>
    <div class="modal-content">
      <div class="modal-header px-4 pt-4">
        <div>
            <h3 class="title-clr mb-0"><?php echo e(translate('messages.Select_Date')); ?></h3>
            <p class="fz-12 m-0"><?php echo e(translate('messages.Your_Surge_price_active_date')); ?></p>
        </div>
        <button type="button" class="close bg-light w-30px h-30 rounded-circle" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <div class="selected-listall">
                    <h5 class="mb-20"><?php echo e(translate('messages.Selected_Days_List')); ?></h5>
                    <div class="d-flex align-items-center justify-content-md-start justify-content-between gap-1 mb-2">
                        <span class="fs-12 text-title opacity-50 text-uppercase min-w-110px"><?php echo e(translate('messages.Date')); ?></span>
                        <span class="fs-12 text-title opacity-50 text-uppercase pe-30 me-3"><?php echo e(translate('messages.Time')); ?></span>
                    </div>
      ...
      <div class="modal-footer justify-content-end border-0 pt-0 pb-4 gap-2">
        ...
        <button type="button" class="btn min-w-120px btn--primary"><?php echo e(translate('messages.Submit')); ?></button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal shedule-modal fade" id="timeRange_btn" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content pb-1">
      <div class="modal-header">
        <div>
            <h3 class="title-clr mb-0" id="edit-time-date-label"><?php echo e(translate('messages.Selected_Date')); ?></h3>
        </div>
        <button type="button" class="close bg-light w-30px h-30 rounded-circle" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      ...
      <div class="modal-body">          
        <div class="bg-light rounded p-3">
            <div class="time-range-wrapper">
                <label class="form-label"><?php echo e(translate('Change Time')); ?></label>
                <div class="position-relative cursor-pointer">
                    <i class="tio-time icon-absolute-on-right"></i>  
                    <input autocomplete="off" type="text" class="form-control h-45 position-relative bg-transparent time-range-picker no-type" id="edit-time-range-input" placeholder="<?php echo e(translate('messages.Select_Time')); ?>">
                </div>
            </div>
        </div>
      </div>
      <div class="modal-footer justify-content-end border-0 pt-0 gap-2">
        <button type="button" class="btn min-w-120px btn--reset" data-dismiss="modal"><?php echo e(translate('messages.Cancel')); ?></button>
        <button type="button" class="btn min-w-120px btn--primary" id="update-time-btn"><?php echo e(translate('messages.Update')); ?></button>
      </div>
    </div>
  </div>
</div>
                ...
                <div class="max-349 mx-auto mb-20">
                    <div>
                        <div class="text-center">
                            <img id="toggle-image" alt="" src="<?php echo e(asset('assets/admin/img/modal-error.png')); ?>" class="mb-20">
                            <h5 class="modal-title" id="toggle-title"><?php echo e(translate('Surge Price setup Overlap!')); ?></h5>
                        </div>
                        <div class="text-center" id="toggle-message">
                            <p><?php echo e(translate('This surge price overlaps with another. Please change the module or reschedule to fix it.')); ?></p>
                        </div>
                    </div>
                    <div class="btn--container justify-content-center">
                        <button type="button" id="toggle-ok-button" class="btn btn--primary min-w-120" data-dismiss="modal" ><?php echo e(translate('Okay')); ?></button>
                    </div>
                </div>
            </div>
        </div>
...
<?php $__env->startPush('script_2'); ?>
    <script>
        ...
        $(function() {
            ...
            <?php if($surge->duration_type === 'custom' && is_array($surge->custom_days)): ?>
                <?php $__currentLoopData = $surge->custom_days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    selectedDates.add("<?php echo e($day); ?>");
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php endif; ?>
            ...
            const customSelectedDates = <?php echo json_encode($surge->custom_days ?? []); ?>;
            const selectTimes = <?php echo json_encode($surge->custom_times ?? []); ?>;
            ...
            $(document).on('click', '.btn-remove-schedule', function (e) {
                ...
                const placeholderText = selectedCount > 0
                    ? selectedCount + ' day' + (selectedCount > 1 ? 's' : '') + ' selected'
                    : '<?php echo translate("messages.Select Date & Time"); ?>';
            ...
            $('#update-time-btn').on('click', function () {
                ...
                if (currentEditIndex !== null) {
                   ...
                   // Update the visible time input
                    ...
                    const placeholderText = selectedCount > 0
                        ? selectedCount + ' day' + (selectedCount > 1 ? 's' : '') + ' selected'
                        : '<?php echo e(translate("messages.Select Date & Time")); ?>';
                    $('#custom_schedule_input').attr('placeholder', placeholderText);
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        if (res.status) {
                            ...
                            setTimeout(() => {
                                window.location.href = "<?php echo e(route('admin.business-settings.zone.surge-price.list', [$surge['zone_id']])); ?>";
                            }, 1500);
                        }
                    },
                    error: function (xhr) {
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\zone\surge-price\edit.blade.php ENDPATH**/ ?>