...
<?php $__env->startSection('title',translate('messages.Low_Stock_List')); ?>
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-filter-list"></i> <?php echo e(translate('messages.Low_Stock_List')); ?><span class="badge badge-soft-dark ml-2" id="itemCount"><?php echo e($items->total()); ?></span></h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
            ...
            <div class="card-header py-2  border-0">
                <div class="search--button-wrapper justify-content-end">
                    ...
                    <div class="col-sm-auto mb-1 mb-sm-0">
                        <select name="type" data-url="<?php echo e(url()->full()); ?>" data-filter="type" data-placeholder="<?php echo e(translate('messages.all')); ?>" class="form-control h--37px set-filter">
                    ...
                    <div class="hs-unfold  min--250">
                        <select name="category_id" id="category" data-url="<?php echo e(url()->full()); ?>" data-filter="category_id" data-placeholder="<?php echo e(translate('messages.select_category')); ?>" class="js-data-example-ajax form-control set-filter">
                            <?php if($category): ?>
                        ...
                        <div id="showHideDropdown" class="hs-unfold-content dropdown-unfold dropdown-menu dropdown-menu-right dropdown-card">
                            <div class="card card-sm">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <span class="mr-2"><?php echo e(translate('messages.stock')); ?></span>
            ...
            <div class="table-responsive datatable-custom">
                <table id="datatable" class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table"
                    ...
                    <tr>
                        ...
                        <th class="border-0 text-center"><?php echo e(translate('messages.stock')); ?></th>
                            ...
                            <td>
                                <div class="btn--container justify-content-center">
                                    <a class="btn btn-sm btn--primary btn-outline-primary action-btn update_quantity"
                                        href="javascript:" title="<?php echo e(translate('messages.edit_quantity')); ?>" data-id="<?php echo e($item->id); ?>" data-toggle="modal" data-target="#update-quantity"><i class="tio-edit"></i>
                                    </a>
                                </div>
                            </td>
                        </tr>
...
<script>
    ...
    $('.update_quantity').on('click', function (){
        ...
        $.get({
            url: '<?php echo e(url('/')); ?>/vendor-panel/item/get-variations?id='+val,
            dataType: 'json',
...
<?php echo $__env->make('layouts.vendor.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\vendor-views\product\stock_limit_list.blade.php ENDPATH**/ ?>