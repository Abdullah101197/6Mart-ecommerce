    ...
    <div class="card-body">
        <div class="scroll-down">
            <?php $__currentLoopData = $convs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $con): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($con->sender_id != $vendor->id): ?>
                    <div class="pt1 pb-1">
    ...
    <div class="card-footer border-0 conv-reply-form">
        ...
        <form action="javascript:" method="post" id="reply-form-vnd" enctype="multipart/form-data" class="conv-txtarea">
            ...
            <div class="quill-custom_">
                ...
                <textarea id="conv-textarea" class="form-control pr--180"  rows = "1" name="reply" placeholder="<?php echo e(translate('Start a new message')); ?>"></textarea>
...
<script>
    ...
    $(function() {
        $("#coba").spartanMultiImagePicker({
            ...
            maxFileSize: '',
            placeholderImage: {
                image: '<?php echo e(asset('assets/admin/img/attatchments.png')); ?>',
                width: '100%'
            },
    ...
    $('#reply-form-vnd').on('submit', function() {
        $('button[type=submit], input[type=submit]').prop('disabled',true);
            ...
            $.post({
                url: '<?php echo e(route('vendor.message.store', ['user_id'=>$user->id,'user_type'=>$user_type])); ?>',
...
<?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\vendor-views\messages\partials\_conversations.blade.php ENDPATH**/ ?>