                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-15">
                    ...
                    <div class="hs-unfold mr-2 hungar-export">
                        ...
                        <div id="usersExportDropdown4"
                            ...
                            <a id="export-csv" class="dropdown-item" href="<?php echo e(route('admin.transactions.report.getTaxDetailsExport',['source'=> $taxSource ,'export_type' => 'csv', request()->getQueryString()])); ?>">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <div class="bg-white p-12 w-100 rounded d-flex align-items-center justify-content-between">
                            <?php echo e(translate('Total_Orders')); ?> <h4 class="theme-clr fw-bold mb-0"><?php echo e($total_count); ?>
                    ...
                    <div class="col-md-6">
                        <div class="bg-white p-12 w-100 rounded d-flex align-items-center justify-content-between">
                            <?php echo e(translate('Total_Order_Amount')); ?> <h4 class="theme-clr fw-bold mb-0">
                                <?php echo e(\App\CentralLogics\Helpers::format_currency($total_order_amount)); ?></h4>
                        </div>
                    </div>
                    <?php endif; ?>
                    <div class="col-md-6">
                        <div class="bg-white p-12 w-100 rounded d-flex align-items-center justify-content-between">
                            <?php echo e(translate('Total_Commission')); ?> <h4 class="cus-warning-light-clr fw-bold mb-0">
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $taxData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <h6><?php echo e(\App\CentralLogics\Helpers::format_currency($item->order_amount)); ?></h6>
                                        <a href="<?php echo e(route($item->order->order_type == 'parcel' ? 'admin.parcel.order.details' : 'admin.order.details', ['id' => $item->order_id])); ?>">
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\report\tax-report\admin-tax-report-details.blade.php ENDPATH**/ ?>