...
<div class="content container-fluid">
    <div class="d-flex align-items-center mb-20 gap-2">
        <img width="22" height="22" src="<?php echo e(asset('assets/admin/img/d-withdraw.png')); ?>"
                        ...
                        <td class="px-3 py-4">
                            <div>
                                <a href="javascript:void(0)" class="d-flex align-items-center gap-2">
                                    <img width="40" height="40" src="<?php echo e(asset('assets/admin/img/160x160/img1.jpg')); ?>" alt="img" class="w-40px h-40px rounded-circle">
                                    <div class="info">
...
<div id="transaction_quick_view" class="custom-offcanvas custom-offcanvas__xs d-flex flex-column justify-content-between">
    ...
    <div class="offcanvas-footer py-3 px-sm-4 px-3 d-flex align-items-center justify-content-center gap-3">
        <button type="reset" class="btn w-100 bg--soft-danger-10 text-danger fs-14 fw-medium h--40px"><?php echo e(translate('messages.Deny')); ?></button>
        <button type="submit" class="btn w-100 btn--primary h--40px"><?php echo e(translate('messages.Approve')); ?></button>
    </div>
    </form>
</div>
        ...
        <div class="modal-content pb-2 max-w-500">
            ...
            <div class="modal-body">
                <div class="text-center max-w-320 mx-auto">
                    <img src="<?php echo e(asset('assets/admin/img/feature-status-on.png')); ?>" alt="icon" class="mb-3">
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\test\deliveryman-withdraw-transaction.blade.php ENDPATH**/ ?>