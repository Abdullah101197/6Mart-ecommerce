...
<div class="modal-body">
    <div class="d-flex flex-row align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-center active h-9rem">
            <img class="img-responsive img-responsive-1 onerror-image" src="<?php echo e($product['image_full_url']); ?>"
        ...
        <div class="details pl-2">
            <a href="<?php echo e(route('vendor.item.view', $product->id)); ?>"
                        ...
                        <div class="d-flex justify-content-left flex-wrap">
                            <?php $__currentLoopData = $choice->options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <input class="btn-check" type="radio" id="<?php echo e($choice->name); ?>-<?php echo e($option); ?>"
                                    ...
                                    <?php echo e(trim($option) == $cart_item[$choice->name] ? 'checked' : ''); ?>
                    ...
                    <div class="product-quantity d-flex align-items-center">
                        <div class="input-group input-group--style-2 pr-3 w-160px">
                            ...
                            <input type="text" name="quantity"
                                ...
                                value="<?php echo e($cart_item['quantity']); ?>" min="1" max="<?php echo e($product->maximum_cart_quantity?? '9999999999'); ?>">
                            <span class="input-group-btn">
                    ...
                    <div class="d-flex justify-content-left flex-wrap">
                        ...
                        <?php $__currentLoopData = \App\Models\AddOn::whereIn('id', $add_ons)->active()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $add_on): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex-column pb-2">
                                ...
                                <input class="btn-check addon-chek addon-quantity-input-toggle" type="checkbox" id="addon<?php echo e($key); ?>" name="addon_id[]"
                                ...
                                <label class="input-group addon-quantity-input mx-1 shadow bg-white rounded px-1"
                                    ...
                                    <?php if(in_array($add_on->id, $cart_item['add_ons'])): ?> style="visibility:visible;" <?php endif; ?>>
                                    <button class="btn btn-sm h-100 text-dark px-0 decrease-button" type="button"
                                            data-id="<?php echo e($add_on->id); ?>"><i
...
<?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\vendor-views\pos\_quick-view-cart-item.blade.php ENDPATH**/ ?>