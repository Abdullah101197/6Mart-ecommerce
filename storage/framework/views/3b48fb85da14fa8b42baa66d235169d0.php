...
<?php $__env->startSection('title',translate('messages.Store_Subscription')); ?>
            ...
            <div class="card-header border-0 align-items-center">
                <h4 class="card-title align-items-center gap-2">
                    <span class="card-header-icon">
                        <img src="<?php echo e(asset('assets/admin/img/store-3.png')); ?>" alt="">
                    </span>
                    <span class="text-title"><?php echo e(translate('Store_Info')); ?></span>
                </h4>
            </div>
            <div class="card-body">
                <div class="row">
                        ...
                        <div class="card h-100">
                            <div class="card-body">
                                <div class="resturant--info-address">
                                    <div class="logo">
                                        <a href="<?php echo e(route('admin.store.view', $store->id)); ?>">

                                            <img class="onerror-image"
                                            src="<?php echo e($store->logo_full_url ?? asset('assets/admin/img/100x100/1.png')); ?>">
                                    </div>
                                        </a>
                            ...
                            <div class="card-body">
                                <div class="resturant--info-address">
                                    <ul class="address-info list-unstyled list-unstyled-py-3 text-dark pl-0">
                                        <li>
                                            <h5 class="name">
                                                <?php echo e(translate('Owner Info')); ?>
                                        ...
                                        <li>
                                            <i class="tio-call-talking nav-icon"></i>
                                            <span class="pl-1">
                                               <a href="tel:<?php echo e($store?->vendor?->phone); ?>">
                                        ...
                                        <li>
                                            <i class="tio-email nav-icon"></i>
                                            <span class="pl-1">
                                            <a href="mailto: <?php echo e($store?->vendor?->email); ?>"></a>
                                            <?php echo e($store?->vendor?->email); ?>
                    ...
                    <div class="check--grid-wrapper mt-3 max-w-850px">
                        ...
                        <div>
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <?php else: ?>
                                <span class="form-check-label text-dark"> <?php echo e($store?->store_sub_update_application?->max_product); ?> <?php echo e($store?->module->module_type == 'rental' && addon_published_status('Rental') ? translate('messages.Upload') :
                                    translate('messages.product_Upload')); ?> <small>(<?php echo e($store?->store_sub_update_application?->max_product  - $store->items_count > 0 ? $store?->store_sub_update_application?->max_product  - $store->items_count : 0); ?> <?php echo e(translate('left')); ?>) </small></span>
                                <?php endif; ?>
                            </div>
                        </div>
                                ...
                                <div class="__plan-item hover <?php echo e($store->store_business_model == 'commission'  ? 'active' : ''); ?> ">
                                    <div class="inner-div">
                                        ...
                                        <div class="py-5 mt-4">
                                            ...
                                            <?php echo e(translate('Store will pay')); ?> <?php echo e($store->comission > 0 ?  $store->comission :  $admin_commission); ?>% <?php echo e(translate('commission to')); ?> <?php echo e($business_name); ?> <?php echo e(translate('from each order. You will get access of all the features and options  in store panel , app and interaction with user.')); ?>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\subscription\subscriber\vendor-subscription.blade.php ENDPATH**/ ?>