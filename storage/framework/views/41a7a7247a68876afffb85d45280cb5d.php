    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                    ...
                    <div class="card-body">
                        <div class="maintainance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                <?php echo e(translate('Receive_Mail_on_‘Advertisement_update_Request’')); ?>

                                <span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('If_a_store_adds_an_adversement,_the_admin_will_receive_an_automated_email_on_Advertisement_update_Request.')); ?>">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                ...
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-title-on="<?php echo e(translate('Want_to_enable_Advertisement_update_Request?')); ?>"
                                       data-title-off="<?php echo e(translate('Want_to_disable_Advertisement_update_Request?')); ?>"
                                       data-text-on="<p><?php echo e(translate('If_enabled,_the_admin_will_receive_an_automated_email_on_Advertisement_update_Request')); ?></p>"
                                       data-text-off="<p><?php echo e(translate('If_disabled,_the_admin_won\'t_receive_an_automated_email_on_Advertisement_update_Request.')); ?></p>"
                        ...
                        <form action="<?php echo e(route('admin.business-settings.email-status',['admin','update-advertisement',$mail_status == '1'?0:1])); ?>" method="get" id="mail-status_form">
                        </form>
                    </div>
                </div>
                ...
                <form action="<?php echo e(route('admin.business-settings.email-setup', ['admin','update-advertisement'])); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                                ...
                                <div class="right-content">
                                            ...
                                            <div class="row g-3">
                                                <div class="col-sm-6">
                                                    <?php if($language): ?>
                                                        <div class="form-group m-0 lang_form default-form">
                                                            <label class="form-label text-capitalize">
                                                                <?php echo e(translate('Button_Name')); ?>(<?php echo e(translate('messages.default')); ?>)
                                                    ...
                                                    if($data && count($data['translations'])){
                                                        ...
                                                        <div class="form-group m-0 d-none lang_form" id="<?php echo e($lang); ?>-form1">
                                                            ...
                                                            <input type="text" maxlength="15" name="button_name[]"  placeholder="<?php echo e(translate('Ex:_Order_now')); ?>" class="form-control h--45px" value="<?php echo e($translate[$lang]['button_name']??''); ?>">
                                                        </div>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php else: ?>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group m-0">
                                                        ...
                                                        <input type="url" name="button_url" placeholder="<?php echo e(translate('messages.Please_contact_us_for_any_queries_we_are_always_happy_to_help')); ?>"  class="form-control" value="<?php echo e($data['button_url']??''); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div>
                                         <h5 class="card-title mb-3">
                                            ...
                                            <span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('Banner_Image_ratio_must_be_2:1.')); ?>">
                                                <i class="tio-info-outined"></i>
                                            </span>
                                        </h5>
                                        <label class="custom-file">
                                        ...
                                        <div class="__bg-F8F9FC-card">
                                            ...
                                            <div class="form-group mb-0">
                                                <?php if($language): ?>
                                                       <div class="form-group lang_form default-form">
                                                            ...
                                                            <input type="text" maxlength="50" data-id="mail-copyright" name="copyright_text[]"  placeholder="<?php echo e(translate('Ex:_Copyright_2023_Stackfood._All_right_reserved')); ?>" class="form-control" value="<?php echo e($data?->getRawOriginal('copyright_text')); ?>">
                                                        </div>
                                                    <?php $__currentLoopData = json_decode($language); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php
                                           $translate = [];
                                           if($data && count($data['translations'])){
                                                        ...
                                                        <div class="form-group d-none lang_form" id="<?php echo e($lang); ?>-form3">
                                                            ...
                                                            <input type="text" maxlength="50" name="copyright_text[]"  placeholder="<?php echo e(translate('Ex:_Copyright_2023_Stackfood._All_right_reserved')); ?>" class="form-control" value="<?php echo e($translate[$lang]['copyright_text']??''); ?>">
                                                        </div>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php else: ?>
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" maxlength="50"  placeholder="<?php echo e(translate('Ex:_Copyright_2023_Stackfood._All_right_reserved')); ?>"class="form-control" name="copyright_text[]" value="">
                                                </div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\business-settings\email-format-setting\admin-email-formats\update-advertisement-format.blade.php ENDPATH**/ ?>