...
<head>
    ...
    <title><?php echo e(translate('Delivery Man Loyalty Earning Report Invoice')); ?></title>
    <style>
...
<div class="invoice-body">
    <div class="invoice-space">
                    ...
                    <div class="text-left header-info-right header-info-inner">
                        ...
                        <table class="fs-10">
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <span class="datas"><?php echo e(\App\CentralLogics\Helpers::format_currency($earnings->sum('converted_amount'))); ?></span>
                                </td>
                            </tr>
                        </table>
                    </div>
        ...
        <table dir="<?php echo e($site_direction); ?>" class="table w-100 main-table">
            <thead>
            <tr>
                <th class="fs-10 text-left"><?php echo e(translate('Date')); ?></th>
                <th class="fs-10 text-left"><?php echo e(translate('Transection')); ?></th>
                <th class="fs-10 text-center"><?php echo e(translate('Converted_Points')); ?></th>
                <th class="fs-10 text-right"><?php echo e(translate('Converted_Amount')); ?></th>
            </tr>
            </thead>
            <tbody>
            ...
            <tr>
                <td class="text-left">
                    <span><?php echo e(\App\CentralLogics\Helpers::date_format($earning->created_at)); ?></span>
                </td>

                <td class="text-left">
                    <span class="secondary-clr">
                        <?php echo e(translate('TrxID :')); ?> <span class="text-clr"><?php echo e($earning->transaction_id); ?></span>
                    </span>
                </td>
                <td class="text-center">
                    <span><?php echo e($earning->point); ?></span>
                </td>
                <td class="text-right">
                    <span><?php echo e(\App\CentralLogics\Helpers::format_currency($earning->converted_amount)); ?></span>
                </td>
...
<?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\invoice-pdf\loyalty-earning-report-invoice.blade.php ENDPATH**/ ?>