...
<div class="content container-fluid">
    ...
    <div class="tab-content">
        <div class="tab-pane fade show active">
            <form action="<?php echo e(route('admin.business-settings.flutter-criteria-update',[$criteria['id']])); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="card mb-3">
                    <div class="card-body">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6 lang_form default-form">
                                    ...
                                    <input type="text" id="title" maxlength="30" name="title[]" value="<?php echo e($criteria?->getRawOriginal('title')??''); ?>" class="form-control" placeholder="<?php echo e(translate('messages.title_here...')); ?>">
                                </div>
                                ...
                                <input type="text" id="title<?php echo e($lang); ?>" maxlength="30" name="title[]" value="<?php echo e($translate[$lang]['title']??''); ?>" class="form-control" placeholder="<?php echo e(translate('messages.title_here...')); ?>">
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <label class="upload-img-3 m-0">
                                        ...
                                        <div class="img">
                                            ...
                                            src="<?php echo e($criteria['image_full_url'] ?? asset('/assets/admin/img/aspect-1.png')); ?>"  data-onerror-image="<?php echo e(asset('/assets/admin/img/aspect-1.png')); ?>" alt="" class="img__aspect-1 min-w-187px max-w-187px onerror-image">
                                        </div>
                                          <input type="file"  name="image" hidden>
                                            <?php if(isset($criteria['image'])): ?>
                ...
                <form  id="fixed_header_image_form" action="<?php echo e(route('admin.remove_image')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="id" value="<?php echo e($criteria?->id); ?>" >
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\business-settings\landing-page-settings\flutter-landing-page-special-criteria-edit.blade.php ENDPATH**/ ?>