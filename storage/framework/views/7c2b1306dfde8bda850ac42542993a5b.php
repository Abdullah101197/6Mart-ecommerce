...
<?php $__env->startSection('content'); ?>
    <div class="content container-fluid">
        ...
        <!--- Tax Report -->
        <h2 class="mb-20"><?php echo e(translate('Tax Report')); ?></h3>
                    ...
                    <div class="row g-lg-4 g-3 align-items-end justify-content-between">
                        <div class="col-lg-4 col-md-6">
                            ...
                            <div class="position-relative">
                                ...
                                <input type="text" data-title="<?php echo e(translate('Select_Date_Range')); ?>" name="dates"
                                    value="<?php echo e($dataRange ?? null); ?>" class="form-control">
                            </div>
                        </div>
                ...
                <div class="row g-lg-4 g-3">
                    <div class="col-md-6 col-xl-3">
                        <div class="bg-opacity-warning-5 h-100 rounded p-24">
                            <img src="<?php echo e(asset('/assets/admin/img/tax/1.png')); ?>" alt="img" class="mb-20">
                            <h2 class="cus-warning-clr mb-1"><?php echo e($totalOrders); ?></h2>
                            <span class="font-medium mb-0"><?php echo e(translate('Total Orders')); ?></span>
                        </div>
                    </div>
                    <div class="col-md-6 col-xl-3">
                        <div class="bg-opacity-primary-5 h-100 rounded p-24">
                            <img src="<?php echo e(asset('/assets/admin/img/tax/2.png')); ?>" alt="img" class="mb-20">
                            <h2 class="theme-clr mb-1"> <?php echo e(\App\CentralLogics\Helpers::format_currency($totalOrderAmount)); ?>

                            </h2>
                            <span class="font-medium mb-0"><?php echo e(translate('Total Order Amount')); ?></span>
                        </div>
                    </div>
                    <div class="col-lg-12 col-xl-6">
                        <div class="bg-opacity-warning-5 h-100 rounded p-24 d-flex flex-sm-nowrap flex-wrap gap-3">
                            <div class="w-xxl-100 w-sm-50">
                                <img src="<?php echo e(asset('/assets/admin/img/tax/3.png')); ?>" alt="img" class="mb-20">
                                <h2 class="text-success mb-1"><?php echo e(\App\CentralLogics\Helpers::format_currency($totalTax)); ?>

                                </h2>
                                <span class="font-medium mb-0"><?php echo e(translate('Total Tax Amount')); ?></span>
                            </div>
                            <div class="tax-report-vat w-100">
                                <div class="d-flex flex-column gap-1">
                                    <?php $__currentLoopData = $taxSummary; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $taxdata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div
                                            class="d-content-between gap-2 bg-white-n rounded py-2 px-2 fz-12px font-semibold">
                                            <?php echo e($taxdata->tax_name); ?> <span
                                                class="title-clr"><?php echo e(\App\CentralLogics\Helpers::format_currency($taxdata->total_tax)); ?></span>
                                        </div>
            ...
            <div class="card p-20">
                <div class="d-flex align-items-center justify-content-between gap-2 flex-wrap mb-20">
                    <h4 class="mb-0"><?php echo e(translate('All Taxes')); ?>
                        ...
                        <div class="hs-unfold mr-2">
                            ...
                            <div id="usersExportDropdown"
                                ...
                                <a id="export-excel" class="dropdown-item"
                                    href="<?php echo e(route('vendor.report.vendorTaxExport', ['export_type' => 'excel', request()->getQueryString()])); ?>">
                                ...
                                <a id="export-csv" class="dropdown-item"
                                    href="<?php echo e(route('vendor.report.vendorTaxExport', ['export_type' => 'csv', request()->getQueryString()])); ?>">
                                    <img class="avatar avatar-xss avatar-4by3 mr-2"
                            ...
                            <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo e(route('vendor.order.details', ['id' => $order['id']])); ?>">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a class="btn btn-sm mx-auto btn--primary action-btn btn-outline-primary offcanvas-trigger"
                                            ...
                                            data-order_status="<?php echo e(translate($order['order_status'])); ?>"
                                            data-payment_status="<?php echo e(translate($order['payment_status'])); ?>"
                                            data-order_date="<?php echo e(\App\CentralLogics\Helpers::date_format($order['created_at'])); ?>"
                                            data-order_amount="<?php echo e(\App\CentralLogics\Helpers::format_currency($order['order_amount'])); ?>"
                                            data-order_tax_amount="<?php echo e(\App\CentralLogics\Helpers::format_currency($order['total_tax_amount'])); ?>"
                                            data-tax_type="<?php echo e($order['tax_type']); ?>"
                                            data-order_taxes='<?php echo json_encode($order->orderTaxes, 15, 512) ?>' href="#0"
    ...
    <div id="offcanvas__customBtn__adminDetails" class="custom-offcanvas d-flex flex-column justify-content-between">
        <div>
            <div class="custom-offcanvas-header bg--secondary d-flex justify-content-between align-items-center px-3 py-3">
                <h3 class="mb-0"><?php echo e(translate('Details')); ?></h2>
                    <button type="button"
                ...
                <div class="bg--secondary rounded p-20 mb-20 w-100">
                    <div class="mb-15">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <span class="fz--14px title-clr"><?php echo e(translate('Payment Status')); ?>: </span> <span
                    ...
                    <div class="bg-white-n rounded p-12">
                        ...
                        <div class="d-flex align-items-center fz--14px border-top pt-2 justify-content-between">
                            <?php echo e(translate('messages.Total_Tax_Amount')); ?>
...
<?php $__env->startPush('script_2'); ?>
    <script src="<?php echo e(asset('assets/admin')); ?>/js/offcanvas.js"></script>
    <script>
        "use strict";
...
<?php echo $__env->make('layouts.vendor.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\vendor-views\report\tax-report\vendor-tax-detail-report.blade.php ENDPATH**/ ?>