...
<div class="content">
    <form class="validate-form" action="<?php echo e(route('admin.business-settings.update-setup')); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-xxl-9 col-lg-8 col-md-7 col-sm-6">
                            <div>
                                <h3 class="mb-1">
                                    <?php echo e(translate('Maintenance Mode')); ?>

                                </h3>
                                <p class="mb-0 fs-12">
                                    <?php echo e(translate('Turn on the Maintenance Mode will temporarily deactivate your selected systems as of your chosen date and time.')); ?>
                        ...
                        <div class="col-xxl-3 col-lg-4 col-md-5 col-sm-6">
                            <div
                                ...
                                <label class="toggle-switch toggle-switch-sm">
                                    ...
                                    data-title-on="<?php echo e(translate('Are you sure to enable Maintenance Mode?')); ?>"
                                    data-title-off="<?php echo e(translate('Are you sure to disable Maintenance Mode?')); ?>"
                                    data-text-on="<?php echo e(translate('This will temporarily disable the selected systems at the scheduled date and time. You can turn it off anytime after maintenance is complete.')); ?>"
                                    data-text-off="<?php echo e(translate('This will make your app and website live. Customers will be able to browse your services and place orders again.')); ?>"
                                    data-footer-text-on="<div class='text-info'><?php echo e(translate('Note : Don’t forget to save the information before leaving this page.')); ?></div>"
                                    data-footer-text-off="<div class='text-info'><?php echo e(translate('Note : Don’t forget to save the information before leaving this page.')); ?></div>"
                    ...
                    <div class="card" id="basic_information_section">
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="p-xxl-20 p-xl-3 p-2 bg-white">
                                        <div class="row g-3">
                                            <div class="col-sm-6 col-md-6">
                                                <div class="form-group mb-0">
                                                    <label class="form-label"
                                                        for="business_name"><?php echo e(translate('Business Name')); ?> <span
                                                            class="text-danger">*</span></label>
                                                    <input id="business_name" type="text" name="business_name"
                                                        value="<?php echo e($name->value ?? ''); ?>" class="form-control"
                                                        placeholder="<?php echo e(translate('Type your business name')); ?>" required>
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-md-6">
                                                <?php ($email_address = \App\Models\BusinessSetting::where('key', 'email_address')->first()); ?>
                                                <div class="form-group mb-0">
                                                    <label class="form-label" for="email_address"><?php echo e(translate('Email')); ?>

                                                        <span class="text-danger">*</span></label>
                                                    <input id="email_address" type="email" value="<?php echo e($email_address->value ?? ''); ?>"
                                                        name="email_address" class="form-control"
                                                        placeholder="<?php echo e(translate('Type your email')); ?>"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-md-6">
                                                ...
                                                <div class="form-group mb-0">
                                                    <label class="form-label" for="phone"><?php echo e(translate('Phone')); ?>

                                                    </label>
                                                    <input type="tel" value="<?php echo e($phone->value ?? ''); ?>" id="phone"
                                                        name="phone" class="form-control"
                                                        placeholder="<?php echo e(translate('Ex: +3264124565')); ?>" required>
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-md-6">
                                                ...
                                                <div class="form-group mb-0">
                                                    <label class="form-label text-capitalize"
                                                        for="country"><?php echo e(translate('Country')); ?> <span
                                                            class="text-danger">*</span></label>
                                                    <select id="country" name="country"
                                                        class="form-control  js-select2-custom">
                                                        <?php $__currentLoopData = \App\CentralLogics\Helpers::getCountries(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $countryCode => $countryName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($countryCode); ?>"
                                                                <?php echo e($countryCode == $country->value ? 'selected' : ''); ?>>
                                            ...
                                            <div class="col-sm-12 col-md-12">
                                                ...
                                                <div class="form-group mb-0">
                                                    <label class="form-label"
                                                        for="address"><?php echo e(translate('address')); ?> <span
                                                    ...
                                                    <textarea type="text" id="address" name="address" class="form-control"
                                                        placeholder="<?php echo e(translate('Ex: address')); ?>" rows="1"
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="form-group mb-0">
                                                                <input type="text" name="longitude"
                                                                    class="w-auto border-0 p-0 m-0 text-center"
                                                                    placeholder="<?php echo e(translate('Ex:')); ?> 103.344322"
                                                                    id="longitude"
                                ...
                                <div class="col-lg-4 shadow-sm">
                                    <div class="d-flex flex-column gap-4 shadow-sm h--37px">
                                        <div class="bg-light2 rounded p-20">
                                            <div class="mb-15">
                                                <h4 class="mb-1"><?php echo e(translate('Upload Logo')); ?> <span class="text-danger">*</span> </h4>
                                                <p class="mb-0 fs-12 gray-dark">
                                                    <?php echo e(translate('Upload your business logo')); ?>
                                        ...
                                        <div class="bg-light2 rounded p-20">
                                            <div class="text-start">
                                                <div class="mb-15">
                                                    <h4 class="mb-1"><?php echo e(translate('Favicon')); ?> <span class="text-danger">*</span> </h4>
                                                    <p class="mb-0 fs-12 gray-dark">
                                                        <?php echo e(translate('Upload your website favicon')); ?>
                            ...
                            <div class="info-notes-bg px-3 py-2 rounded fz-11  gap-2 align-items-center d-flex mt-20">
                                ...
                                <span>
                                    <?php echo e(translate('For the address setup you can simply drag the map to pick for the perfect')); ?>

                                    <strong class="text-title"> <?php echo e(translate('Lat(Latitude) & Log(Longitude)')); ?></strong>
                    ...
                    <div class="card " id="general_settings_section">
                        ...
                        <div class="card-body py-xxl-4 py-3 px-xxl-4 px-lg-3 px-0">
                            <div class="shadow-sm p-xxl-20 p-xl-3 p-2 bg-white mb-20">
                                <div class="mb-20">
                                    <h4 class="mb-1">
                                        <?php echo e(translate('Time Setup')); ?>
                                        ...
                                        <div class="col-sm-6 col-md-4 col-xl-4">
                                            ...
                                            <div class="form-group mb-0">
                                                <label class="input-label d-flex align-items-center gap-1">
                                                    <?php echo e(translate('time_zone')); ?>
                                                ...
                                                <select name="timezone" class="form-control js-select2-custom">
                                                    <?php $__currentLoopData = timezone_identifiers_list(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        ?>
                                                        <option value="<?php echo e($tz); ?>" <?php echo e(isset($settings_timezone) && $settings_timezone == $tz ? 'selected' : ''); ?>>
                                                            (<?php echo e($gmt); ?>) <?php echo e($tz); ?>

                                                        </option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <option value="US/Central" <?php echo e(isset($settings_timezone) && $settings_timezone == 'US/Central' ? 'selected' :  ''); ?>> (GMT-06:00) Central Time (US & Canada)</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-md-4 col-xl-4">
                                            ...
                                            <div class="form-group mb-0">
                                                <label for="timeformat"
                                                    class="form-label text-capitalize"><?php echo e(translate('time_format')); ?>

                                                    <span class="text-danger">*</span></label>
                                                <div class="resturant-type-group bg-white border">
                                                    <label class="form-check form--check mr-2 mr-md-4">
                                                        <input class="form-check-input" type="radio" value="12"
                                                            name="timeformat" <?php echo e($tf == '12' ? 'checked' : ''); ?>>
                                                        <span class="form-check-label">
                                                            <?php echo e(translate('12 Hours')); ?>

                                                        </span>
                                                    </label>
                                                    <label class="form-check form--check mr-2 mr-md-4">
                                                        <input class="form-check-input" type="radio" value="24"
                                                            name="timeformat" <?php echo e($tf == '24' ? 'checked' : ''); ?>>
                                                        <span class="form-check-label">
                                                            <?php echo e(translate('24 Hours')); ?>
                            ...
                            <div class="shadow-sm p-xxl-20 p-xl-3 p-2 bg-white mb-20" id="currency-setup">
                                ...
                                <div class="mb-20">
                                    <h4 class="mb-1">
                                        <?php echo e(translate('Currency Setup')); ?>

                                    </h4>
                                    <p class="mb-0 fs-12">
                                        <?php echo e(translate('Here you can manage currency settings to match with your business criteria')); ?>
                                ...
                                <div class="bg-light2 rounded p-xxl-20 p-3">
                                    <div class="row g-3">
                                            ...
                                            <div class="form-group mb-0">
                                                ...
                                                <select id="change_currency" name="currency"
                                                    ...
                                                    <?php $__currentLoopData = \App\Models\Currency::orderBy('currency_code')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($currency['currency_code']); ?>" <?php echo e($currency_code ? ($currency_code->value == $currency['currency_code'] ? 'selected' : '') : ''); ?>>
                                                ...
                                                <div class="resturant-type-group bg-white border">
                                                    <label class="form-check form--check mr-2 mr-md-4">
                                                        <input class="form-check-input" type="radio" value="left"
                                                            name="currency_symbol_position" <?php echo e($currency_symbol_position ? ($currency_symbol_position->value == 'left' ? 'checked' : '') : ''); ?>>
                                                        <span class="form-check-label">
                                                    ...
                                                    <label class="form-check form--check mr-2 mr-md-4">
                                                        <input class="form-check-input" type="radio" value="right"
                                                            name="currency_symbol_position" <?php echo e($currency_symbol_position ? ($currency_symbol_position->value == 'right' ? 'checked' : '') : ''); ?>>
                                                        <span class="form-check-label">
                                                            (<?php echo e(\App\CentralLogics\Helpers::currency_symbol()); ?>)
                                        ...
                                        <div class="col-sm-6 col-md-4 col-xl-4">
                                            ...
                                            <div class="form-group mb-0">
                                                <label class="form-label text-capitalize"
                                                    for="digit_after_decimal_point"><?php echo e(translate('Digit after decimal point')); ?>

                                                </label>
                                                <span class="form-label-secondary" data-toggle="tooltip"
                                                        data-placement="right"
                                                        data-original-title="<?php echo e(translate('how_many_fractional_digit_to_show_after_decimal_value')); ?>">
                                                        <i class="tio-info text-muted"></i>
                                                </span>
                                                <input type="number" name="digit_after_decimal_point" class="form-control"
                                                    id="digit_after_decimal_point"
                                                    placeholder="<?php echo e(translate('ex_:_2')); ?>"
                            ...
                            <div class="shadow-sm p-xxl-20 p-xl-3 p-2 bg-white mb-20" id="business_model_section">
                                <div class="mb-20">
                                    <h4 class="mb-1">
                                        <?php echo e(translate('Business Model Setup')); ?>

                                    </h4>
                                    <p class="mb-0 fs-12">
                                        <?php echo e(translate('Setup your business model from here')); ?>
                                ...
                                <div class="bg-light2 rounded p-xxl-20 p-3">
                                    <div class="row g-3">
                                        <div class="col-lg-12">
                                            <label class="form-label" for="footer_text"><?php echo e(translate('Business Model')); ?>

                                                <span class="text-danger">*</span>
                                                <span class="form-label-secondary" data-toggle="tooltip"
                                                    data-placement="right" data-original-title="<?php echo e(translate('Choose the model that decides how you earn money and process orders.')); ?>">
                                                    <i class="tio-info text-muted"></i>
                                                </span>
                                            </label>
                                                ...
                                                <div class="row g-3">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="custom-control custom-checkbox">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    id="subs" name="subscription_business_model" <?php echo e($subscription_business_model ? 'checked' : ''); ?> value="1">
                                                                <label class="custom-control-label" for="subs">
                                                                    <h5 class="mb-1"><?php echo e(translate('Subscription')); ?></h5>
                                                                    <p class="mb-0 fs-12">
                                                                        <?php echo e(translate('By selecting subscription based business model stores can run business with you based on subscription package.')); ?>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p class="fz-12px mb-0">
                                                                            <?php echo e(translate('To active subscription based business model 1st you need to add subscription package from')); ?>

                                                                            <a href="<?php echo e(route('admin.business-settings.subscriptionackage.index')); ?>"
                                                                                class="fz-12px font-semibold info-dark text-underline"><?php echo e(translate('Subscription Packages')); ?></a>
                                                                        </p>
                                                                    </div>
                                                                </label>
                                                            </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <div class="custom-control custom-checkbox">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    id="commission" name="commission_business_model" <?php echo e($commission_business_model ? 'checked' : ''); ?> value="1">
                                                                <label class="custom-control-label" for="commission">
                                                                    <h5 class="mb-1"><?php echo e(translate('Commission')); ?></h5>
                                                                    <p class="mb-0 fs-12">
                                                                        <?php echo e(translate('By selecting commission based business model stores can run business with you based on commission based payment per order.')); ?>

                                                                    </p>
                                                                    <div
                                                                        class="info-notes-bg px-3 py-2 rounded fz-11  gap-2 d-flex mt-20">
                                                                        <img src="<?php echo e(asset('assets/admin/img/info-idea.svg')); ?>"
                                                                            alt="">
                                                                        <span>
                                                                            <?php echo e(translate('To set different commission for commission based stores.')); ?>

                                                                            <?php echo e(translate('Go to')); ?>: <span
                                                                                class="fz-12px font-semibold info-dark"><?php echo e(translate('store List')); ?>

                                                                                > <?php echo e(translate('store Details')); ?> >
                                                                                <?php echo e(translate('Business Plan')); ?></span>
                                                                        </span>
                                                                    </div>
                                                                </label>
                                                            </div>
                                                ...
                                                <div class="col-sm-6 col-lg-6">
                                                    ...
                                                    <div class="form-group mb-0">
                                                        <label class="form-label text-capitalize" for="admin_commission">
                                                            <?php echo e(translate('Default_Commission_Rate_On_Order')); ?> (%)
                                                            <span class="text-danger">*</span>
                                                            <span class="form-label-secondary" data-toggle="tooltip"
                                                                data-placement="right"
                                                                data-original-title="<?php echo e(translate('Set_up_‘Default_Commission_Rate’_on_every_Order._Admin_can_also_set_store-wise_different_commission_rates_from_respective_store_settings.')); ?>">
                                                                <i class="tio-info text-muted"></i>
                                                            </span>
                                                        </label>
                                                        <input type="number" name="admin_commission" class="form-control"
                                                            id="admin_commission"
                                                            placeholder="<?php echo e(translate('Ex:_10')); ?>"
                                                ...
                                                <div class="col-sm-6 col-lg-6">
                                                    ...
                                                    <div class="form-group mb-0">
                                                        <label class="input-label text-capitalize d-flex alig-items-center"
                                                            ...
                                                            <?php echo e(translate('Commission_Rate_On_Delivery_Charge')); ?> (%)
                                                            <span class="text-danger">*</span>
                                                            <span class="form-label-secondary ml-1" data-toggle="tooltip"
                                                                data-placement="right"
                                                                data-original-title="<?php echo e(translate('Set_a_default_‘Commission_Rate’_for_freelance_deliverymen_(under_admin)_on_every_deliveryman. ')); ?>">
                                                                <i class="tio-info text-muted"></i>
                                                            </span>
                                                        </label>
                                                        <input type="number" name="delivery_charge_comission"
                                                            class="form-control" id="delivery_charge_comission"
                                                            placeholder="<?php echo e(translate('Ex:_10')); ?>" min="0"
                                                            max="100" step="<?php echo e(\App\CentralLogics\Helpers::getDecimalPlaces()); ?>"
                                                            value="<?php echo e($delivery_charge_comission ? $delivery_charge_comission->value : 0); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="shadow-sm p-xxl-20 p-xl-3 p-2 bg-white mb-20" id="additional_charge_section">
                                <div class="row g-3">
                                    <div class="col-xxl-9 col-lg-8 col-md-7 col-sm-6">
                                        <div>
                                            <h4 class="mb-1">
                                                <?php echo e(translate('Additional Charge Setup')); ?>

                                            </h4>
                                            <p class="mb-0 fs-12">
                                                <?php echo e(translate('By switching this feature ON, Customer need to pay the amount you set. ')); ?>
                                        ...
                                        <div class="form-group mb-0">
                                            <label
                                                ...
                                                <input type="checkbox" data-id="additional_charge_status" data-type="toggle"
                                                    ...
                                                    data-title-on="<strong><?php echo e(translate('Want_to_enable_additional_charge?')); ?></strong>"
                                                    data-title-off="<strong><?php echo e(translate('Want_to_disable_additional_charge?')); ?></strong>"
                                                    data-text-on="<p><?php echo e(translate('If_you_enable_this,_additional_charge_will_be_added_with_order_amount,_it_will_be_added_in_admin_wallet')); ?></p>"
                                                    data-text-off="<p><?php echo e(translate('If_you_disable_this,_additional_charge_will_not_be_added_with_order_amount.')); ?></p>"
                                                    class="status toggle-switch-input dynamic-checkbox-toggle" value="1"
                                                    name="additional_charge_status" id="additional_charge_status" <?php echo e($additional_charge_status == 1 ? 'checked' : ''); ?>>
                                        ...
                                        <div class="col-sm-6 col-lg-6">
                                            ...
                                            <div class="form-group mb-0">
                                                <label
                                                    ...
                                                    <span
                                                        class="line--limit-1"><?php echo e(translate('additional_charge_name')); ?>
                                                ...
                                                <input type="text" name="additional_charge_name" class="form-control"
                                                    ...
                                                    placeholder="<?php echo e(translate('Ex:_Processing_Fee')); ?>"
                                                    value="<?php echo e($additional_charge_name ? $additional_charge_name->value : ''); ?>"
                                                    <?php echo e(isset($additional_charge_status) ? '' : 'readonly'); ?> required>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-lg-6">
                                            ...
                                            <div class="form-group mb-0">
                                                <label
                                                    ...
                                                    <span class="line--limit-1"><?php echo e(translate('charge_amount')); ?>
                                                ...
                                                <input type="number" name="additional_charge" class="form-control"
                                                    id="additional_charge" placeholder="<?php echo e(translate('Ex:_10')); ?>"
                                                    value="<?php echo e($additional_charge ? $additional_charge->value : 0); ?>" min="0"
                                                    step="<?php echo e(\App\CentralLogics\Helpers::getDecimalPlaces()); ?>" <?php echo e(isset($additional_charge_status) ? '' : 'readonly'); ?>>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div id="additional_charge_note">
                                    <div class="info-notes-bg px-3 py-2 rounded fz-11  gap-2 d-flex mt-20">
                                        <img src="<?php echo e(asset('assets/admin/img/info-idea.svg')); ?>" alt="">
                                        <span>
                                            <?php echo e(translate('Only admin will get the additional amount & customer must pay the amount.')); ?>
                        ...
                        <div class="card-body">
                            <div class="mb-20">
                                <h4 class="mb-1">
                                    <?php echo e(translate('Others Setup')); ?>

                                </h4>
                                <p class="mb-0 fs-12">
                                    <?php echo e(translate('Here you setup your business others setup')); ?>
                                        ...
                                        <div class="form-group mb-0">
                                            <span class="mb-10px d-flex align-items-center">
                                                <span class="text-title">
                                                    <?php echo e(translate('Country Picker')); ?>
                            ...
                            <div class="shadow-sm p-xxl-20 p-xl-3 p-2 bg-white" id="content_setup_section">
                                <div class="mb-20">
                                    <h4 class="mb-1">
                                        <?php echo e(translate('Copyright & Cookies Text')); ?>

                                    </h4>
                                    <p class="mb-0 fs-12">
                                        <?php echo e(translate('Add the necessary texts to display in required sections')); ?>
                                ...
                                <div class="bg-light2 rounded p-xxl-20 p-3">
                                    <div class="row g-3">
                                        <div class="col-md-6 col-xl-6">
                                            ...
                                            <div class="form-group mb-0">
                                                <label class="form-label"
                                                    ...
                                                    <span class="form-label-secondary" data-toggle="tooltip"
                                                        data-placement="right"
                                                        data-original-title="<?php echo e(translate('make_visitors_aware_of_your_business‘s_rights_&_legal_information.')); ?>">
                                                        <i class="tio-info text-muted"></i>
                                                    </span>
                                                </label>
                                                <textarea type="text" id="footer_text" maxlength="100" name="footer_text"
                                                    class="form-control" rows="3"
                                                    placeholder="<?php echo e(translate('Ex_:_Copyright_Text')); ?>"
                                        ...
                                        <div class="col-md-6 col-xl-6">
                                            ...
                                            <div class="form-group mb-0">
                                                <label class="form-label" for="cookies_text"><?php echo e(translate('Cookies Text')); ?>
                                                ...
                                                <textarea type="text" id="cookies_text" maxlength="100" name="cookies_text"
                                                    class="form-control " rows="3"
                                                    placeholder="<?php echo e(translate('Ex_:_Cookies_Text')); ?>"
                                                    required><?php echo e($cookies_text->value ?? ''); ?></textarea>
                                                <span
                                                    class="text-right text-counting color-A7A7A7 d-block mt-1">0/100</span>
                                            </div>
                                        </div>
                ...
                <div class="max-349 mx-auto mb-20">
                    <div>
                        <div class="text-center">
                            <img width="80" src="<?php echo e(asset('assets/admin/img/modal/currency.png')); ?>"
                                class="mb-20">
                        ...
                        <div class="text-center">
                            ...
                            <div>
                                <p><?php echo e(translate('If_you_enable_this_currency,_you_must_active_at_least_one_digital_payment_method_that_supports_this_currency._Otherwise_customers_cannot_pay_via_digital_payments_from_the_app_and_websites._And_Also_stores_cannot_pay_you_digitally')); ?>
                        ...
                        <div class="text-center mb-4">
                            <a class="text--underline"
                                ...
                                <?php echo e(translate('Go_to_payment_method_settings.')); ?></a>
                        </div>
                    </div>

                    <div class="btn--container justify-content-center">
                        <button data-dismiss="modal" id="confirm-currency-change"
                            class="btn btn--cancel min-w-120"><?php echo e(translate("Cancel")); ?></button>
                        <button data-dismiss="modal" type="button"
                            class="btn btn--primary min-w-120"><?php echo e(translate('OK')); ?></button>
...
<div id="global_guideline_offcanvas" class="custom-offcanvas d-flex flex-column justify-content-between global_guideline_offcanvas">
    <div>
        <div class="custom-offcanvas-header bg--secondary d-flex justify-content-between align-items-center px-3 py-3">
            <h3 class="mb-0"><?php echo e(translate('Business Settings Guideline')); ?></h3>
            ...
            <div class="py-3 px-3 bg-light rounded mb-3 mb-sm-20">
                <div class="d-flex gap-2 align-items-center justify-content-between overflow-hidden">
                    <button class="btn-collapse d-flex gap-2 align-items-center bg-transparent border-0 p-0 collapsed" type="button" data-toggle="collapse" data-target="#maintenance_mode_guide" aria-expanded="true">
                        ...
                        <span class="font-semibold text-left fs-14 text-title"><?php echo e(translate('Maintenance mode')); ?></span>
                    </button>
                    <a href="#maintenance_mode_section" class="text-info text-underline fs-12 text-nowrap offcanvas-close offcanvas-close-btn"><?php echo e(translate('messages.Let’s Setup')); ?></a>
                </div>
                <div class="collapse mt-3 show" id="maintenance_mode_guide">
                    <div class="card card-body">
                        <div class="">
                            <h5 class="mb-3"><?php echo e(translate('Maintenance mode')); ?></h5>
                            <ul class="fs-12">
                                <li><?php echo e(translate('Turning on Maintenance mode will temporarily close your online store. Use this when you need to make updates or fix issues.')); ?></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="py-3 px-3 bg-light rounded mb-3 mb-sm-20">
                <div class="d-flex gap-2 align-items-center justify-content-between overflow-hidden">
                    <button class="btn-collapse d-flex gap-2 align-items-center bg-transparent border-0 p-0 collapsed" type="button" data-toggle="collapse" data-target="#basic_information_guide" aria-expanded="true">
                        ...
                        <span class="font-semibold text-left fs-14 text-title"><?php echo e(translate('Basic Information')); ?></span>
                    </button>
                    <a href="#basic_information_section" class="text-info text-underline fs-12 text-nowrap offcanvas-close offcanvas-close-btn"><?php echo e(translate('messages.Let’s Setup')); ?></a>
                </div>
                <div class="collapse mt-3" id="basic_information_guide">
                    <div class="card card-body">
                        <div class="">
                            <h5 class="mb-3"><?php echo e(translate('Basic Information')); ?></h5>
                            <ul class="fs-12">
                                <li><strong><?php echo e(translate('Company Name')); ?>:</strong> <?php echo e(translate('Enter your official company name. This name represents your business and is used across the system.')); ?></li>
                                <li><strong><?php echo e(translate('Email')); ?>:</strong> <?php echo e(translate('Add your company email address. This email is used for business communication and records.')); ?></li>
                                <li><strong><?php echo e(translate('Phone')); ?>:</strong> <?php echo e(translate('Provide a contact phone number so customers and partners can reach your business easily for urgent inquiries, support needs, or quick questions.')); ?></li>
                                <li><strong><?php echo e(translate('Country')); ?>:</strong> <?php echo e(translate('Select your country. This is important for legal, operational, marketing, and payment-related settings.')); ?></li>
                                <li><strong><?php echo e(translate('Address')); ?>:</strong> <?php echo e(translate('This address is used to locate the business’s physical location.')); ?></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="py-3 px-3 bg-light rounded mb-3 mb-sm-20">
                <div class="d-flex gap-2 align-items-center justify-content-between overflow-hidden">
                    <button class="btn-collapse d-flex gap-2 align-items-center bg-transparent border-0 p-0 collapsed" type="button" data-toggle="collapse" data-target="#general_settings_guide" aria-expanded="true">
                        ...
                        <span class="font-semibold text-left fs-14 text-title"><?php echo e(translate('General Settings')); ?></span>
                    </button>
                    <a href="#general_settings_section" class="text-info text-underline fs-12 text-nowrap offcanvas-close offcanvas-close-btn"><?php echo e(translate('messages.Let’s Setup')); ?></a>
                </div>
                <div class="collapse mt-3" id="general_settings_guide">
                    <div class="card card-body">
                        <div class="">
                            <h5 class="mb-3"><?php echo e(translate('General Settings')); ?></h5>
                            <p class="fs-12 mb-0"><?php echo e(translate('General Setup is the foundational step, where you configure essential business details (time zone, available currency) to set up the business.')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="py-3 px-3 bg-light rounded mb-3 mb-sm-20">
                <div class="d-flex gap-2 align-items-center justify-content-between overflow-hidden">
                    <button class="btn-collapse d-flex gap-2 align-items-center bg-transparent border-0 p-0 collapsed" type="button" data-toggle="collapse" data-target="#business_model_guide" aria-expanded="true">
                        ...
                        <span class="font-semibold text-left fs-14 text-title"><?php echo e(translate('Business Model')); ?></span>
                    </button>
                    <a href="#business_model_section" class="text-info text-underline fs-12 text-nowrap offcanvas-close offcanvas-close-btn"><?php echo e(translate('messages.Let’s Setup')); ?></a>
                </div>
                <div class="collapse mt-3" id="business_model_guide">
                    <div class="card card-body">
                        <div class="">
                            <h5 class="mb-3"><?php echo e(translate('Business Model')); ?></h5>
                            <ul class="fs-12">
                                <li><strong><?php echo e(translate('Subscription-based model')); ?>:</strong> <?php echo e(translate('A subscription-based business model allows customers or vendors to access specific features, services, or system functionalities by paying a recurring fee (monthly, quarterly, or yearly). Instead of one-time payments, users remain active as long as their subscription is valid.')); ?></li>
                                <li><strong><?php echo e(translate('Commission-based model')); ?>:</strong> <?php echo e(translate('In the Commission-based model, the platform earns revenue by taking a predefined fixed percentage from each completed order. The commission is automatically deducted from the order value before the remaining amount is settled with the vendor or service provider.')); ?></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="py-3 px-3 bg-light rounded mb-3 mb-sm-20">
                <div class="d-flex gap-2 align-items-center justify-content-between overflow-hidden">
                    <button class="btn-collapse d-flex gap-2 align-items-center bg-transparent border-0 p-0 collapsed" type="button" data-toggle="collapse" data-target="#additional_charge_guide" aria-expanded="true">
                        ...
                        <span class="font-semibold text-left fs-14 text-title"><?php echo e(translate('Additional Charge Setup')); ?></span>
                    </button>
                    <a href="#additional_charge_section" class="text-info text-underline fs-12 text-nowrap offcanvas-close offcanvas-close-btn"><?php echo e(translate('messages.Let’s Setup')); ?></a>
                </div>
                <div class="collapse mt-3" id="additional_charge_guide">
                    <div class="card card-body">
                        <div class="">
                            <h5 class="mb-3"><?php echo e(translate('Additional Charge Setup')); ?></h5>
                            <p class="fs-12 mb-0"><?php echo e(translate('Use this option to add extra fees to customer orders based on specific, predefined conditions. These charges are added automatically at checkout and are visible to both customers and vendors.')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="py-3 px-3 bg-light rounded mb-3 mb-sm-20">
                <div class="d-flex gap-2 align-items-center justify-content-between overflow-hidden">
                    <button class="btn-collapse d-flex gap-2 align-items-center bg-transparent border-0 p-0 collapsed" type="button" data-toggle="collapse" data-target="#others_setup_guide" aria-expanded="true">
                        ...
                        <span class="font-semibold text-left fs-14 text-title"><?php echo e(translate('Others Setup')); ?></span>
                    </button>
                    <a href="#others_setup_section" class="text-info text-underline fs-12 text-nowrap offcanvas-close offcanvas-close-btn"><?php echo e(translate('messages.Let’s Setup')); ?></a>
                </div>
                <div class="collapse mt-3" id="others_setup_guide">
                    <div class="card card-body">
                        <div class="">
                            <h5 class="mb-3"><?php echo e(translate('Others Setup')); ?></h5>
                            <ul class="fs-12">
                                <li><strong><?php echo e(translate('Country Picker')); ?>:</strong> <?php echo e(translate('This option allows users to pick their country code while typing a phone number.')); ?></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="py-3 px-3 bg-light rounded mb-3 mb-sm-20">
                <div class="d-flex gap-2 align-items-center justify-content-between overflow-hidden">
                    <button class="btn-collapse d-flex gap-2 align-items-center bg-transparent border-0 p-0 collapsed" type="button" data-toggle="collapse" data-target="#content_setup_guide" aria-expanded="true">
                        ...
                        <span class="font-semibold text-left fs-14 text-title"><?php echo e(translate('Content Setup')); ?></span>
                    </button>
                    <a href="#content_setup_section" class="text-info text-underline fs-12 text-nowrap offcanvas-close offcanvas-close-btn"><?php echo e(translate('messages.Let’s Setup')); ?></a>
                </div>
                <div class="collapse mt-3" id="content_setup_guide">
                    <div class="card card-body">
                        <div class="">
                            <h5 class="mb-3"><?php echo e(translate('Content Setup')); ?></h5>
                            <ul class="fs-12">
                                <li><strong><?php echo e(translate('Copyright text')); ?>:</strong> <?php echo e(translate('This is a short statement that shows your company owns the content on your website. It usually includes the copyright symbol (©), the year, and your company name.')); ?></li>
                                <li><strong><?php echo e(translate('Cookies Text')); ?>:</strong> <?php echo e(translate('This is a short message shown on the website to let visitors know that the site uses cookies to collect information and improve their browsing experience')); ?></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $('#subs, #commission').on('change', function (e) {
            ...
            if (!$('#subs').is(':checked') && !$('#commission').is(':checked')) {
                e.preventDefault();
                toastr.error('<?php echo e(translate("At least one business model must be selected")); ?>');
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\business-settings\settings\business-index.blade.php ENDPATH**/ ?>