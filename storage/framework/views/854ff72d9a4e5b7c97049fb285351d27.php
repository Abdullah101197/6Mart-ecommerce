                ...
                <div class="newsletter-wrapper">
                    <div class="newsletter-content position-relative">
                        ...
                        <form method="post" action="<?php echo e(route('newsletter.subscribe')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="input--grp">
                                <input type="email" name="email" required class="form-control" placeholder="<?php echo e(translate('Enter your email address')); ?>">
...
<?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\layouts\landing\app.blade.php ENDPATH**/ ?>