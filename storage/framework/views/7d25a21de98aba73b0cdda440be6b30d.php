...
<div class="row">
    <div class="col-md-3 error-wrapper">
        ...
        <input type="text" class="form-control" name="choice[]" value="<?php echo e($choice['title']); ?>"
               placeholder="<?php echo e(translate('messages.choice_title')); ?>" readonly>
    </div>
...
<?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views/admin-views/product/partials/_choices.blade.php ENDPATH**/ ?>