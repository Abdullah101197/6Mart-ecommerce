    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                    ...
                    <div class="card-body">
                        <div class="maintainance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                <?php echo e(translate('Send_Mail_on_Suspend_a_Store')); ?>

                                <span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('If_Admin_suspends_a_store’s_,_the_store_will_get_a_suspend_mail_from_the_system.')); ?>">
                                    <img src="<?php echo e(asset('/assets/admin/img/info-circle.svg')); ?>" alt="<?php echo e(translate('messages.Send_Mail_on_Suspend_a_Store')); ?>">
                                </span>
                            </h5>
                            <label class="toggle-switch toggle-switch-sm">
                                ...
                                data-title-on="<?php echo e(translate('Want_to_enable_Store_suspend_mail?')); ?>"
                                data-title-off="<?php echo e(translate('Want_to_disable_Store_suspend_mail?')); ?>"
                                data-text-on="<p><?php echo e(translate('If_enabled,_Store_will_receive_an_email_for_account_suspension.')); ?></p>"
                                data-text-off="<p><?php echo e(translate('If_disabled,_Store_will_not_receive_an_email_for_account_suspension.')); ?></p>"
                        ...
                        <form action="<?php echo e(route('admin.business-settings.email-status',['store','suspend',$mail_status == '1'?0:1])); ?>" method="get" id="mail-status_form">
                        </form>
                    </div>
                </div>
                ...
                <form action="<?php echo e(route('admin.business-settings.email-setup', ['store','suspend'])); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\business-settings\email-format-setting\store-email-formats\suspend-format.blade.php ENDPATH**/ ?>