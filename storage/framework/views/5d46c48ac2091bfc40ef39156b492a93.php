...
<div class="content container-fluid">
    ...
    <div class="info-notes-bg px-2 py-2 rounded fs-12  gap-2 align-items-center d-flex mb-15">
       <img width="14" height="18" src="<?php echo e(asset('assets/admin/img/info-idea.svg')); ?>" class="w--20" alt="">
        <span>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\test\marketing-tools.blade.php ENDPATH**/ ?>