                            ...
                            <div class="col-12 d-flex justify-content-between">
                                <span class="d-flex g-1">
                                    ...
                                    <h3 class="form-label d-block mb-2">
                                        <?php echo e(translate('Best_Reviewed_Items')); ?>
                                ...
                                <label class="__upload-img aspect-235-375 m-auto d-block position-relative">
                                    ...
                                    <?php if(isset($best_reviewed_section_banner?->value)): ?>
                                        <span id="best_reviewed_section_banner" class="remove_image_button dynamic-checkbox"
                                            ...
                                            data-image-on='<?php echo e(asset('/assets/admin/img/modal')); ?>/mail-success'
                        ...
                        <div class="row g-3">
                            <div class="col-12 d-flex justify-content-between">
                                <span class="d-flex g-1">
                                    <img src="<?php echo e(asset('assets/admin/img/other-banner.png')); ?>" class="h-85"
                                        alt="">
                                    <h3 class="form-label d-block mb-2">
                                        <?php echo e(translate('New Arrivals')); ?>
                            ...
                            <div class="col-12">
                                ...
                                <label class="__upload-img aspect-235-375 m-auto d-block position-relative">
                                    <div class="img">
                                        <img class="onerror-image"
                                            src="<?php echo e(\App\CentralLogics\Helpers::get_full_url('promotional_banner', $new_arrival_section_banner?->value ?? '', $new_arrival_section_banner?->storage[0]?->value ?? 'public', 'upload_placeholder')); ?>"
                                            data-onerror-image="<?php echo e(asset('/assets/admin/img/upload-placeholder.png')); ?>"
                                            alt="">
                                    </div>
                                    <div class="">
                                    ...
                                    <?php if(isset($new_arrival_section_banner?->value)): ?>
...
<form id="new_arrival_section_banner_form" action="<?php echo e(route('admin.remove_image')); ?>" method="post">
    <?php echo csrf_field(); ?>
    <input type="hidden" name="id" value="<?php echo e($new_arrival_section_banner?->id); ?>">
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\other-banners\ecommerce-index.blade.php ENDPATH**/ ?>