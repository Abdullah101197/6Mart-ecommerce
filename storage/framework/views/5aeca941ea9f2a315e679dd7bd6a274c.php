    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                    ...
                    <div class="card-body">
                        <div class="maintainance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                <?php echo e(translate('Receive_Mail_On_New_Customer_Registration_on_POS')); ?>

                                <span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('If_a_user_added_through_POS,_they_will_receive_an_automated_confirmation_mail_with_their_email_&_password.')); ?>">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                ...
                                data-title-on="<?php echo e(translate('Want_to_enable_User_POS_Registration_mail?')); ?>"
                                data-title-off="<?php echo e(translate('Want_to_disable_User_POS_Registration_mail?')); ?>"
                                data-text-on="<p><?php echo e(translate('If_enabled,_customers_will_receive_a_confirmation_email_that_their_registration_was_successfull_and_get_the_email_and_password_in_the_mail.')); ?></p>"
                                data-text-off="<p><?php echo e(translate('If_disabled,_customers_won’t_receive_any_registration_confirmation_email.')); ?></p>"
                        ...
                        <form action="<?php echo e(route('admin.business-settings.email-status',['user','pos-registration',$mail_status == '1'?0:1])); ?>" method="get" id="mail-status_form">
                        </form>
                    </div>
                </div>
                ...
                <form action="<?php echo e(route('admin.business-settings.email-setup', ['user','pos-registration'])); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                            ...
                            <div class="email-format-wrapper">
                                ...
                                <div class="right-content">
                                    ...
                                    <div class="__bg-F8F9FC-card default-form lang_form" id="default-form">
                                        ...
                                        <div class="form-group mb-0">
                                            <label class="form-label">
                                                <?php echo e(translate('Mail_2nd_Body_Message')); ?>(<?php echo e(translate('messages.default')); ?>)
                                                <span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('Write_the_mail_body_message_within_75_words')); ?>">
                                                    <i class="tio-info-outined"></i>
                                                </span>
                                            </label>
                                            <textarea class="form-control" id="ckeditor2" data-id="mail-body2" name="body_2[]">
                                                <?php echo $data?->getRawOriginal('body_2'); ?>
                                    ...
                                    if($data && count($data['translations'])){
                                        ...
                                        ?>
                                        <div class="__bg-F8F9FC-card d-none lang_form" id="<?php echo e($lang); ?>-form1">

                                            <div class="form-group mb-0">
                                               <label class="form-label">
                                                    <?php echo e(translate('Mail_2nd_Body_Message')); ?>(<?php echo e(strtoupper($lang)); ?>)
                                                    <span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('Write_the_mail_body_message_within_75_words')); ?>">
                                                        <i class="tio-info-outined"></i>
                                                    </span>
                                                </label>
                                                <textarea class="ckeditor form-control" name="body_2[]">
                                                   <?php echo $translate[$lang]['body_2']??''; ?>
                                ...
                                <?php else: ?>
                                    <div class="__bg-F8F9FC-card default-form">
                                        ...
                                        <div class="form-group mb-0">
                                              <label class="form-label">
                                                <?php echo e(translate('Mail_2nd_Body_Message')); ?>
                                            ...
                                            <textarea class="ckeditor form-control" name="body_2[]">
                                                <?php echo e(translate('Your_account_credential:')); ?>,
                                            </textarea>
                                        </div>
                                    </div>
                                <?php endif; ?>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\business-settings\email-format-setting\user-email-formats\pos-registration-format.blade.php ENDPATH**/ ?>