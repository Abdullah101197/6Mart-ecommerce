    ...
    <div class="card mt-4">
        <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
                   ...
                   target="_blank">
                    ...
                    <span data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip"
                          data-bs-title="Follow our documentation">
                                ...
                                <img src="<?php echo e(asset('assets/installation')); ?>/assets/img/svg-icons/info.svg"
                                     class="svg" alt="">
                            </span>
                </a>
            </div>
                    ...
                    <div class="row g-4 g-md-5">
                        <div class="col-md-6">
                            <div class="d-flex gap-3 align-items-center">
                                <img
                                    src="<?php echo e(asset('assets/installation')); ?>/assets/img/svg-icons/php-version.svg"
                                    alt="">
                                <div
                                    ...
                                    <?php if($phpVersion >= 8.2): ?>
                                        <img width="20"
                                             src="<?php echo e(asset('assets/installation')); ?>/assets/img/svg-icons/check.png"
                                             alt="">
                                    <?php else: ?>
                                        <span class="cursor-pointer" data-bs-toggle="tooltip"
                                              ...
                                              data-bs-title="Your php version in server is lower than 8.2 version
                                                ...
                                                <img
                                                    src="<?php echo e(asset('assets/installation')); ?>/assets/img/svg-icons/info.svg"
                        ...
                        <?php $__currentLoopData = $permission; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($key != 'db_file_write_perm' && $key != 'routes_file_write_perm' && $key != 'config_file_write_perm'): ?>
                                <div class="col-md-6">
                                    <div class="d-flex gap-3 align-items-center">
                                        <img src="<?php echo e(asset('assets/installation')); ?>/assets/img/svg-icons/curl-enabled.svg" alt="">
                                        <div class="d-flex align-items-center gap-2 justify-content-between flex-grow-1">
                                            <?php echo e(translate($key) . ' ' . translate('Enabled')); ?>


                                            <?php if($item): ?>
                                                <img width="20" src="<?php echo e(asset('assets/installation')); ?>/assets/img/svg-icons/check.png" alt="">
                                            <?php else: ?>
                                                <span class="cursor-pointer" data-bs-toggle="tooltip"
                                                      data-bs-placement="top" data-bs-custom-class="custom-tooltip"
                                                      data-bs-html="true" data-bs-delay='{"hide":1000}'
                                                      data-bs-title="<?php echo e(translate($key)); ?> extension is not enabled in your server. To enable go to PHP version > extensions and select <?php echo e(translate($key)); ?>.">
                            <img src="<?php echo e(asset('assets/installation')); ?>/assets/img/svg-icons/info.svg"
                                 class="svg text-danger" alt="">
                        </span>
                                            <?php endif; ?>
                        ...
                        <div class="col-md-6">
                            <div class="d-flex gap-3 align-items-center">
                                <img
                                    src="<?php echo e(asset('assets/installation')); ?>/assets/img/svg-icons/route-service.svg"
                                    alt="">
                                <div
                                    class="d-flex align-items-center gap-2 justify-content-between flex-grow-1">
                                    .env File Permission
                        ...
                        <div class="col-md-6">
                            <div class="d-flex gap-3 align-items-center">
                                ...
                                <div
                                    ...
                                    <?php if($permission['config_file_write_perm']): ?>
                                        <img width="20"
                                             src="<?php echo e(asset('assets/installation')); ?>/assets/img/svg-icons/check.png"
                                             alt="">
                                    <?php else: ?>
            ...
            <div class="text-center">
                ...
                <?php if($permission['curl_enabled'] == 1 && $permission['db_file_write_perm'] == 1 &&  $permission['config_file_write_perm'] == 1 && $permission['routes_file_write_perm'] == 1 && $phpVersion >= 8.2): ?>
                    <a href="<?php echo e(route('step2',['token'=>bcrypt('step_2')])); ?>" class="btn btn-dark px-sm-5">Proceed
                        Next</a>
                <?php endif; ?>
            </div>
        </div>
...
<?php echo $__env->make('layouts.blank', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\installation\step1.blade.php ENDPATH**/ ?>