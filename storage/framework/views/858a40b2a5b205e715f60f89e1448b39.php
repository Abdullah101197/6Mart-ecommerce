    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                <?php echo e(translate('Send_Mail_on_Product_Deny’?')); ?>

                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('If_Admin_rejects_a_Store’s_product,_the_store_will_get_an_automatic_disapproval_mail_from_the_system.')); ?>">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                ...
                                data-title-on="<?php echo e(translate('Want_to_enable_Store_product_deny_mail?')); ?>"
                                data-title-off="<?php echo e(translate('Want_to_disable_Store_product_deny_mail?')); ?>"
                                data-text-on="<p><?php echo e(translate('If_enabled,_stores_will_receive_a_confirmation_email_when_the_Admin_rejects_their_product.')); ?></p>"
                                data-text-off="<p><?php echo e(translate('If_disabled,_stores_will_not_get_a_product_rejection_mail.')); ?></p>"
                        ...
                        <form action="<?php echo e(route('admin.business-settings.email-status',['store','product-deny',$mail_status == '1'?0:1])); ?>" method="get" id="mail-status_form">
                        </form>
                    </div>
                </div>
                ...
                <form action="<?php echo e(route('admin.business-settings.email-setup', ['store','product-deny'])); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\business-settings\email-format-setting\store-email-formats\product-deny-format.blade.php ENDPATH**/ ?>