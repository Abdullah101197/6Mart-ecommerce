                ...
                <div class="row g-2" id="order_stats">
                    <div class="col-sm-6 col-lg-3">
                        <div class="__dashboard-card-2">
                            <img src="<?php echo e(asset('/assets/admin/img/dashboard/pharmacy/items.svg')); ?>" alt="dashboard/pharmacy">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="__dashboard-card-2">
                            <img src="<?php echo e(asset('/assets/admin/img/dashboard/pharmacy/orders.svg')); ?>" alt="dashboard/pharmacy">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="__dashboard-card-2">
                            <img src="<?php echo e(asset('/assets/admin/img/dashboard/pharmacy/stores.svg')); ?>" alt="dashboard/pharmacy">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="__dashboard-card-2">
                            <img src="<?php echo e(asset('/assets/admin/img/dashboard/pharmacy/customers.svg')); ?>" alt="dashboard/pharmacy">
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\dashboard-pharmacy.blade.php ENDPATH**/ ?>