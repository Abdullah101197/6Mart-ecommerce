...
<?php $__env->startSection('content'); ?>
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title mr-3">
                <span class="page-header-icon">
                    <img src="<?php echo e(asset('assets/admin/img/user-edit.png')); ?>" class="w--26" alt="">
                </span>
                <span>
                    <?php echo e(translate('customer_settings')); ?>
        ...
        <!-- End Page Header -->
        <form action="<?php echo e(route('admin.users.customer.update-settings')); ?>" method="post" enctype="multipart/form-data"
            id="update-settings">
            <?php echo csrf_field(); ?>
            <div class="row g-2">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">
                                ...
                                <span>
                                    <?php echo e(translate('wallet_settings')); ?>
                                    ...
                                    <div class="form-group mb-0">
                                        <label
                                            ...
                                            <span class="pr-2"><?php echo e(translate('messages.refund_to_wallet')); ?><span
                                                    ...
                                                    data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('messages.refund_to_wallet_hint')); ?>"><img
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">
                                ...
                                <span>
                                    <?php echo e(translate('messages.customer_loyalty_point_settings')); ?>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">
                                ...
                                <span>
                                    <?php echo e(translate('customer_referrer_settings')); ?>
...
<?php $__env->startPush('script_2'); ?>
    <script src="<?php echo e(asset('assets/admin')); ?>/js/view-pages/customer-wallet-settings.js"></script>
    <script>
        "use strict";
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\customer\settings.blade.php ENDPATH**/ ?>