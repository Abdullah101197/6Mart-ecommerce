...
<?php $__env->startSection('title',  translate('Create Withdraw Method')); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="content container-fluid">
        ...
        <div class="mb-4 withdraw-header-sticky z-2">
            <div class="page-title-wrap d-flex justify-content-between flex-wrap align-items-center gap-3">
                <h2 class="page-title m-0">
                    ...
                    <?php echo e(translate('Create Withdraw Method')); ?>
        ...
        <div class="row">
            <div class="col-md-12">
                <form action="<?php echo e(route('admin.transactions.withdraw-method.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="card card-body">
                        <div class="bg-1079801A p--20 rounded">
                            <div class="form-floating">
                                <label class="text-title">
                                    <?php echo e(translate('messages.method_name')); ?>
                                        ...
                                        <div class="col-md-4 col-12">
                                            <div class="form-floating">
                                                ...
                                                <input type="text" class="form-control" name="field_name[]"
                                                        placeholder="<?php echo e(translate('messages.Ex:_Account_name')); ?> " value="" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-12">
                                            <div class="form-floating">
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\withdraw-method\withdraw-methods-create.blade.php ENDPATH**/ ?>