                    ...
                    <div class="row gy-sm-5 g-4">
                        <div class="col-sm-6">
                            <div class="d-flex gap-4 align-items-center flex-wrap">
                                <img
                                    src="<?php echo e(asset('assets/installation')); ?>/assets/img/svg-icons/database-name.svg"
                                    alt="">
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex gap-4 align-items-center flex-wrap">
                                <img
                                    src="<?php echo e(asset('assets/installation')); ?>/assets/img/svg-icons/database-password.svg"
                                    alt="">
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex gap-4 align-items-center flex-wrap">
                                <img
                                    src="<?php echo e(asset('assets/installation')); ?>/assets/img/svg-icons/database-username.svg"
                                    alt="">
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex gap-4 align-items-center flex-wrap">
                                <img
                                    src="<?php echo e(asset('assets/installation')); ?>/assets/img/svg-icons/database-hostname.svg"
                                    alt="">
...
<?php echo $__env->make('layouts.blank', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\installation\step0.blade.php ENDPATH**/ ?>