            ...
            <div class="col-sm-6">
                <div class="text-center text-sm-right mr-sm-4 mb-5 mb-sm-0">
                    <img class="w-60 w-sm-100 mx-auto mw-15rem"
                         src="<?php echo e(asset('assets/admin')); ?>/svg/illustrations/think.svg" alt="Image Description">
                </div>
            </div>
...
<?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\errors\404.blade.php ENDPATH**/ ?>