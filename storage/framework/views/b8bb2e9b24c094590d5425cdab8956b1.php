              ...
              <thead class="thead-light">
                  <tr>
                      ...
                      <th class="border-0"><?php echo e(translate('messages.deliverymen')); ?></th>
                        <th class="border-0 text-center"><?php echo e(translate('Default_Status')); ?></th>
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                            <?php if($zone->is_default): ?>
                                <button
                                    class="btn btn-sm btn-ghost-success"><?php echo e(translate('messages.default_zone')); ?>

                                    <span data-toggle="tooltip" data-placement="right"
                                        data-original-title="<?php echo e(translate('This zone is set as the default for customers who visit the app or website without choosing a location.')); ?>"
                            ...
                            <?php else: ?>
                              ...
                              <form
                                  action="<?php echo e(route('admin.business-settings.zone.default-status',[$zone['id']])); ?>"
                                  method="get" id="default-status-<?php echo e($zone['id']); ?>_form">
                              </form>

                                <button data-id="default-status-<?php echo e($zone['id']); ?>" data-type="status"
                                      data-image-off='<?php echo e(asset('/assets/admin/img/modal')); ?>/zone-status-on.png'
                                      data-title-off="<?php echo e(translate('Want_to_make_this_as_default_zone?')); ?>"
                                      data-text-off="<p><?php echo e(translate('When enabled, customers who visit the app or website without choosing a location will be assigned to this zone.')); ?></p>"
                                    id="default-status-<?php echo e($zone['id']); ?>"
                                class="btn border btn-soft-secondary dynamic-checkbox rounded py-2 px-3"><?php echo e(translate('messages.make_default')); ?></button>
                            <?php endif; ?>
                        </td>
                          ...
                          <td>
                              <label class="toggle-switch toggle-switch-sm" for="status-<?php echo e($zone['id']); ?>">
                                  <input type="checkbox" class="toggle-switch-input dynamic-checkbox"
                                      data-id="status-<?php echo e($zone['id']); ?>" data-type="status"
                              ...
                              <form
                                  action="<?php echo e(route('admin.business-settings.zone.status', [$zone['id'], $zone->status ? 0 : 1])); ?>"
                                  method="get" id="status-<?php echo e($zone['id']); ?>_form">
                              </form>
                          </td>
                          ...
                          <td>
                              <div class="btn--container justify-content-center">
                                  ...
                                  <div class="popover-wrapper <?php echo e($non_mod == 1 ? 'active' : ''); ?>">
                                      ...
                                      <a href="<?php echo e(route('admin.business-settings.zone.module-setup', [$zone['id']])); ?>"
                                          class="btn action-btn btn-outline-theme-dark " data-toggle="tooltip"
                                          data-placement="bottom"
                                          data-original-title="<?php echo e(translate('messages.connect_module')); ?>">
                                  ...
                                  <a href="<?php echo e(route('admin.business-settings.zone.surge-price.list', [$zone['id']])); ?>"
                                      class="btn action-btn btn-outline-theme-light" data-toggle="tooltip"
                                      data-placement="bottom"
                                      data-original-title="<?php echo e(translate('messages.surge_price')); ?>">
                                  ...
                                  <div class="btn-group">
                                      <button type="button"
                                          ...
                                          <i class="tio-more-vertical" data-toggle="tooltip" data-placement="bottom"
                                              data-original-title="<?php echo e(translate('messages.menu')); ?>"></i>
                                      </button>
                                      <div class="dropdown-menu dropdown-menu-right">
                                          <a href="<?php echo e(route('admin.business-settings.zone.edit', [$zone['id']])); ?>"
                                              title="<?php echo e(translate('messages.edit_zone')); ?>"
                                              class="dropdown-item  px-3 border-bottom fs-14 d-flex align-items-center gap-1 justify-content-between">
                                              <?php echo e(translate('Edit')); ?> <i class="tio-edit theme-clr-dark"></i>
                                          </a>
                                          <a href="javascript:" data-id="zone-<?php echo e($zone['id']); ?>"
                                              data-title="<?php echo e(translate('Want_to_Delete_this_Zone?')); ?>"
                                              data-message="<?php echo e(translate('If_yes,_all_its_modules,_stores,_and_products_will_be_DELETED_FOREVER.')); ?>"
                                              title="<?php echo e(translate('messages.delete_zone')); ?>"
                                              class="dropdown-item px-3 border-bottom fs-14 d-flex align-items-center gap-1 justify-content-between status_form_alert">
                                              <?php echo e(translate('Delete')); ?> <i class="tio-delete-outlined text-danger"></i>
                                          </a>
                                          <?php if($digital_payment && $digital_payment['status'] == 1): ?>
                                              <div
                                                  ...
                                                  <label class="toggle-switch toggle-switch-sm"
                                                      for="digital_paymentCheckbox<?php echo e($zone->id); ?>">
                                                      <input type="checkbox"
                                                          data-id="digital_payment-<?php echo e($zone['id']); ?>"
                                                          data-title="<?php echo e($zone->digital_payment ? translate('Want_to_disable_‘Digital_Payment’?') : translate('Want_to_enable_‘Digital_Payment’?')); ?>"
                                                          data-message="<?php echo e($zone->digital_payment ? translate('If_yes,_the_digital_payment_option_will_be_hidden_during_checkout.') : translate('If_yes,_Customers_can_choose_the_‘Digital_Payment’_option_during_checkout.')); ?>"
                                                          class="toggle-switch-input status_form_alert"
                                                          id="digital_paymentCheckbox<?php echo e($zone->id); ?>"
                                                          <?php echo e($zone->digital_payment ? 'checked' : ''); ?>>
                                                      <span class="toggle-switch-label">
                                                          <span class="toggle-switch-indicator"></span>
                                                      </span>
                                                  </label>
                                                  <form
                                                      action="<?php echo e(route('admin.business-settings.zone.digital-payment', [$zone['id'], $zone->digital_payment ? 0 : 1])); ?>"
                                                      method="get" id="digital_payment-<?php echo e($zone['id']); ?>">
                                                  </form>
                                              </div>
                                          <?php endif; ?>
                                          <?php if($offline_payment && $offline_payment == 1): ?>
                                              <div
                                                  ...
                                                  <label class="toggle-switch toggle-switch-sm"
                                                      for="offline_paymentCheckbox<?php echo e($zone->id); ?>">
                                                      <input type="checkbox"
                                                          data-id="offline_payment-<?php echo e($zone['id']); ?>"
                                                          data-title="<?php echo e($zone->offline_payment ? translate('Want_to_disable_‘offline_Payment’?') : translate('Want_to_enable_‘offline_Payment’?')); ?>"
                                                          data-message="<?php echo e($zone->offline_payment ? translate('If_yes,_the_offline_payment_option_will_be_hidden_during_checkout.') : translate('If_yes,_Customers_can_choose_the_‘offline_Payment’_option_during_checkout.')); ?>"
                                                          class="toggle-switch-input status_form_alert"
                                                          id="offline_paymentCheckbox<?php echo e($zone->id); ?>"
                                                          <?php echo e($zone->offline_payment ? 'checked' : ''); ?>>
                                                      <span class="toggle-switch-label">
                                                          <span class="toggle-switch-indicator"></span>
                                                      </span>
                                                  </label>
                                                  <form
                                                      action="<?php echo e(route('admin.business-settings.zone.offline-payment', [$zone['id'], $zone->offline_payment ? 0 : 1])); ?>"
                                                      method="get" id="offline_payment-<?php echo e($zone['id']); ?>">
                                                  </form>
                                              </div>
                                          <?php endif; ?>
                                          <?php if($config && $config['status'] == 1): ?>
                                              <div
                                                  ...
                                                  <label class="toggle-switch toggle-switch-sm"
                                                      for="cashOnDeliveryCheckbox<?php echo e($zone->id); ?>">
                                                      <input type="checkbox"
                                                          data-id="cash_on_delivery-<?php echo e($zone['id']); ?>"
                                                          data-title="<?php echo e($zone->cash_on_delivery ? translate('Want_to_disable_‘Cash_On_Delivery’?') : translate('Want_to_enable_‘Cash_On_Delivery’?')); ?>"
                                                          data-message="<?php echo e($zone->cash_on_delivery ? translate('If_yes,_the_Cash_on_Delivery_option_will_be_hidden_during_checkout.') : translate('If_yes,_Customers_can_choose_the_‘Cash_On_Delivery’_option_during_checkout.')); ?>"
                                                          class="toggle-switch-input status_form_alert"
                                                          id="cashOnDeliveryCheckbox<?php echo e($zone->id); ?>"
                                                          <?php echo e($zone->cash_on_delivery ? 'checked' : ''); ?>>
                                                      <span class="toggle-switch-label">
                                                          <span class="toggle-switch-indicator"></span>
                                                      </span>
                                                  </label>
                                                  <form
                                                      action="<?php echo e(route('admin.business-settings.zone.cash-on-delivery', [$zone['id'], $zone->cash_on_delivery ? 0 : 1])); ?>"
                                                      method="get" id="cash_on_delivery-<?php echo e($zone['id']); ?>">
                                                  </form>
                                              </div>
                                          <?php endif; ?>
                                      </div>
                                  </div>
                                  <form action="<?php echo e(route('admin.business-settings.zone.delete', [$zone['id']])); ?>"
                                      method="post" id="zone-<?php echo e($zone['id']); ?>">
      ...
      <?php endif; ?>
<?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\zone\partials\_table.blade.php ENDPATH**/ ?>