        ...
        <div class="card mb-20">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <label class="input-label" for="surgePrice_default"><?php echo e(translate('messages.Surge Price name (Default)')); ?>

                        <span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right"
                            data-original-title="<?php echo e(translate('Surge Price name (Default)')); ?>">
                ...
                <div class="form-group mb-0">
                    <div class="d-flex align-items-center gap-1 flex-wrap justify-content-between mb-2">
                        <label class="input-label mb-0" for="surgePrice_default"><?php echo e(translate('messages.Note for Customer (Default)')); ?>

                            <span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right"
                                data-original-title="<?php echo e(translate('Note for Customer (Default)')); ?>">
                                <i class="tio-info fs-14 text-muted"></i>
                            </span>
                        </label>
        ...
        <div class="card mb-20">
            ...
            <div class="card-body">
                <div class="row g-4">
                    <div class="col-md-6">
                        <div>
                            <label class="mb-2 d-block title-clr fw-normal"><?php echo e(translate('Module')); ?></label>
                            <select name="" id="module_selected" class="form-control h--45px js-select2-custom" multiple="multiple" placeholder="Module Select" data-placeholder="Module">
                                <option></option>
                                <option><?php echo e(translate('messages.Food')); ?></option>
                                <option><?php echo e(translate('messages.Pharmacy')); ?></option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group mb-0">
                            <label class="mb-2 d-block title-clr fw-normal"><?php echo e(translate('Price Increase Rate')); ?></label>
                            <div class="custom-group-btn border">
                                ...
                                <div class="flex-shrink-0">
                                    <select name="price_ncreaseRate" id="price_ncreaseRate" class="custom-select ltr border-0">
                                        <option value="percent" <?php echo e(old('price_ncreaseRate') == 'percent' ? 'selected' : ''); ?>>%</option>
                                        <option value="amount" <?php echo e(old('price_ncreaseRate') == 'amount' ? 'selected' : ''); ?>>
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                ...
                                <div class="bg--3 rounded px-3 py-2 d-inline-flex align-items-start gap-2 flex-wrap mt-20">
                                    ...
                                    <p class="m-0 max-w-353px"><?php echo e(translate('This surge price overlaps with another. Please change the module or reschedule to fix it.')); ?></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                        ...
                                        <div class="bg-white p-sm-3 d-flex flex-column gap-3">
                                            <div>
                                                ...
                                                <div class="position-relative date-range__custom">
                                                    ...
                                                    <input type="text" class="form-control h-45 position-relative bg-transparent"   name="dates-top" placeholder="<?php echo e(translate('messages.Select_Date')); ?>">
                                                </div>
                                            </div>
                                            <div class="time-range-wrapper">
                                                <label class="form-label"><?php echo e(translate('Time Range')); ?></label>
                                                <div class="position-relative cursor-pointer">
                                                    <i class="tio-time icon-absolute-on-right"></i>  
                                                     <input type="text" class="form-control h-45 position-relative bg-transparent time-range-picker" name="time_range[]" placeholder="<?php echo e(translate('messages.Select_Time')); ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                     ...
                                     <div class="shedule_item">
                                         <div class="bg-white p-sm-3 d-flex flex-column gap-3">
                                             <div class="cursor-pointer" data-toggle="modal" data-target="#surgeCustom_sheduleBtn">
                                                 <label class="form-label"><?php echo e(translate('Date & Time Select')); ?></label>
                                                 <div class="position-relative">
                                                     <i class="tio-calendar-month icon-absolute-on-right"></i>
                                                     <input type="text" class="form-control h-45 position-relative bg-transparent"
                                                         name="" placeholder="<?php echo e(translate('messages.5 Days Repeated')); ?>">
                                                 </div>
                                             </div>
        ...
        <div class="modal-body-inner">
            ...
            <div class="bg-light rounded p-3">
                ...
                <div class="mb-20">
                    ...
                    <div class="position-relative date-range__custom">
                        <i class="tio-calendar-month icon-absolute-on-right"></i>
                        <input type="text" class="form-control h-45 position-relative bg-transparent"  name="dates" placeholder="<?php echo e(translate('messages.Select_Date')); ?>">
                    </div>
                </div>
                <label class="form-check form--check mr-2 mr-md-4">
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\test\surgeprice-setup\daily-schedule.blade.php ENDPATH**/ ?>