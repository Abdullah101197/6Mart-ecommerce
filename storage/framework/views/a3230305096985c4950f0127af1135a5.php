...
<div class="content container-fluid">
    ...
    <div class="mb-20 mt-2">
     ...
     <form id="zone-setup-form" action="<?php echo e(route('admin.business-settings.admin-landing-page-settings', 'meta-data')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\business-settings\landing-page-settings\admin-meta-data.blade.php ENDPATH**/ ?>