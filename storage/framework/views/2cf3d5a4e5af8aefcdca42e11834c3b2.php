    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                <?php echo e(translate('Receive_Login_Notification_via_Mail?')); ?>

                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('If_a_user_login_from_their_respective_system,_the_Admin_gets_notified_via_email.')); ?>">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-title-on="<?php echo e(translate('Want_to_enable_Login_mail?')); ?>"
                                       data-title-off="<?php echo e(translate('Want_to_disable_Login_mail?')); ?>"
                                       data-text-on="<p><?php echo e(translate('If_enabled,_Admin_will_receive_an_automated_email_on_every_login_from_all_users')); ?></p>"
                                       data-text-off="<p><?php echo e(translate('If_disabled,_Admin_will_not_receive_an_automated_email_on_every_login_of_users')); ?></p>"
                        ...
                        <form action="<?php echo e(route('admin.business-settings.email-status',['admin','login',$mail_status == '1'?0:1])); ?>" method="get" id="mail-status_form">
                        </form>
                    </div>
                </div>
                ...
                <form action="<?php echo e(route('admin.business-settings.email-setup', ['admin','login'])); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\business-settings\email-format-setting\admin-email-formats\login-format.blade.php ENDPATH**/ ?>