...
<div class="content container-fluid">
    ...
    <div class="card py-3 px-xxl-4 px-3 mb-20">
        <div class="d-flex flex-sm-nowrap flex-wrap gap-3 align-items-center justify-content-between">
            <div class="">
                <h3 class="mb-1"><?php echo e(translate('Deliveryman App Download Section')); ?></h3>
                <p class="mb-0 gray-dark fs-12">
                    <?php echo e(translate('See how your Deliveryman App Download Section will look to customers.')); ?>
    ...
    <div class="card mb-20">
        <form action="#0">
            <div class="card-body">
                <div class="mb-20">
                    <h3 class="mb-1"><?php echo e(translate('Deliveryman App Download Section Content ')); ?></h3>
                    <p class="mb-0 fs-12"><?php echo e(translate('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam odio tellus, laoreet ')); ?></p>
                </div>
                <div class="row g-3">
                    <div class="col-lg-8">
                                ...
                                <div class="col-md-12 lang_form default-form">
                                    <div class="row g-1">
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <textarea type="text" name="available_zone_short_description[]" placeholder="<?php echo e(translate('messages.subtitle')); ?>" class="form-control min-h-90px ckeditor"></textarea>
                                        </div>
                                        <div class="col-12">
                                            ...
                                            <input id="download_button_name" type="text"  maxlength="20" name="download_button_name[]" value="<?php echo e($download_user_app_sub_title?->getRawOriginal('value')??''); ?>" class="form-control" placeholder="<?php echo e(translate('messages.Selling Start...')); ?>">
                    ...
                    <div class="col-lg-4">
                        <div class="bg--secondary h-100 rounded p-md-4 p-3 d-center">
                            <div class="text-center">
                                <div class="mb-4">
                                    <h5 class="mb-1"><?php echo e(translate('Upload Zone Section Image')); ?></h5>
                                    <p class="mb-0 fs-12 gray-dark"><?php echo e(translate('Upload your Zone Section  Image')); ?></p>
                                </div>
                                ...
                                <p class="fs-10 text-center mb-0 mt-lg-4 mt-3">
                                    <?php echo e(translate('JPG, JPEG, PNG, Gif Image size : Max 2 MB')); ?> <span class="font-medium text-title"><?php echo e(translate('(1:1)')); ?></span>
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="tab-pane fade show active">
            ...
            <form action="<?php echo e(route('admin.business-settings.react-landing-page-settings', 'download-app-section')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="mb-20">
                            <h3 class="mb-1"><?php echo e(translate('Deliveryman App Download Section Button ')); ?></h3>
                            <p class="mb-0 fs-12"><?php echo e(translate('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam odio tellus, laoreet ')); ?></p>
                        </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="hidden" name="lang[]" value="default">
                                        ...
                                        <div class="col-md-12 d-none lang_form" id="<?php echo e($lang); ?>-form1">
                                            <div class="row g-1">
                                                <div class="col-12">
                                                    <label for="download_user_app_title<?php echo e($lang); ?>" class="form-label"><?php echo e(translate('Title')); ?> (<?php echo e(strtoupper($lang)); ?>)<span class="form-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('Write_the_title_within_100_characters')); ?>">
                                                    <i class="tio-info color-A7A7A7"></i>
                                                </span></label>
                                        ...
                                        <span class="text-right text-counting color-A7A7A7 d-block mt-1">0/100</span>
                                                ...
                                                <div class="col-12">
                                                    <label for="download_user_app_sub_title<?php echo e($lang); ?>" class="form-label"><?php echo e(translate('Sub Title')); ?> (<?php echo e(strtoupper($lang)); ?>)<span class="form-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('Write_the_title_within_200_characters')); ?>">
                                                    <i class="tio-info color-A7A7A7"></i>
                                                </span></label>
    ...
    <form action="<?php echo e(route('taxvat.store')); ?>" method="post">
        <div>
            <div class="custom-offcanvas-header bg--secondary d-flex justify-content-between align-items-center px-3 py-3">
                <div class="py-1">
                    <h3 class="mb-0 line--limit-1"><?php echo e(translate('messages.Deliveryman App Download Section Preview')); ?></h3>
                </div>
                    ...
                    <div class="common-section-inner bg-fafafa p-xxl-4 p-3 d-flex flex-xl-nowrap justify-content-lg-between justify-content-center flex-wrap align-items-center gap-xxl-20">                        
                        <div class="d-flex align-items-center justify-content-xl-start justify-content-center flex-xl-nowrap flex-wrap gap-xxl-20 max-w-650 mb-xxl-0 mb-3">
                            <div class="selling-thumb min-w-176px max-w-250">
                                <img width="180" src="<?php echo e(asset('/assets/admin/img/400x400/deliveryman-dirver.png')); ?>" alt="Google Play" class="object-contain w-100 h-100">
                            </div>
                           <div class="mt-xl-0 mt-2 max-w-353px">
                                ...
                                <ul class="list-checked d-flex flex-column gap-1 mb-xxl-4 mb-xl-3 mb-3">
                                    <li class="d-flex fs-14 align-items-center gap-2 text-title fw-medium">
                                        <img width="16" src="<?php echo e(asset('assets/admin/img/icons/6check.png')); ?>" alt="check" class="svg">
                        ...
                        <div>
                            <div class="bg-white py-3 px-sm-5 px-1 rounded-10">
                                <div class="mb-20 text-center">
                                    <h3 class="mb-1"><?php echo e(translate('messages.Download the Driver App')); ?></h3>
                                    <p class="mb-0 fs-12"><?php echo e(translate('messages.Take control of your rides anywhere.')); ?></p>
                                </div>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\test\React_Landing\deliveryman-app-download.blade.php ENDPATH**/ ?>