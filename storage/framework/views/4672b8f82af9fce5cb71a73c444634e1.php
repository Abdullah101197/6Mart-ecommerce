...
<div class="content container-fluid">
    ...
    <div class="tab-content">
        <div class="tab-pane fade show active">
            <form action="<?php echo e(route('admin.business-settings.criteria-update',[$criteria['id']])); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6 lang_form default-form">
                                    <label for="title" class="form-label"><?php echo e(translate('Title')); ?> (<?php echo e(translate('messages.default')); ?>)<span
                                                ...
                                                <input required id="title" type="text" maxlength="40" name="title[]" value="<?php echo e($criteria['title']??''); ?>" class="form-control" placeholder="<?php echo e(translate('messages.title_here...')); ?>">
                                </div>
                                ...
                                ?>
                                    <div class="col-sm-6 d-none lang_form" id="<?php echo e($lang); ?>-form1">
                                        <label for="title<?php echo e($lang); ?>" class="form-label"><?php echo e(translate('Title')); ?> (<?php echo e(strtoupper($lang)); ?>)</label>
                                        <input id="title<?php echo e($lang); ?>" type="text" name="title[]" value="<?php echo e($translate[$lang]['title']??''); ?>" class="form-control" placeholder="<?php echo e(translate('messages.title_here...')); ?>">
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <label class="upload-img-3 m-0">
                                        ...
                                        <div class="img">
                                            <img
                                            src="<?php echo e($criteria['image_full_url'] ?? asset('/assets/admin/img/aspect-1.png')); ?>"
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\business-settings\landing-page-settings\admin-landing-why-choose-edit.blade.php ENDPATH**/ ?>