            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    <?php if(\App\CentralLogics\Helpers::module_permission_check('category')||
                        ...
                        <?php endif; ?>
                        <!-- End Unit -->
                        <?php if(\App\CentralLogics\Helpers::module_permission_check('common_condition')): ?>
                            <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/common-condition*') ? 'active' : ''); ?>">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                   href="<?php echo e(route('admin.common-condition.add')); ?>"
                                   title="<?php echo e(translate('messages.Common_Conditions')); ?>">
                                    <i class="tio-ruler nav-icon"></i>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate text-capitalize">
                            <?php echo e(translate('messages.Common_Conditions')); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\layouts\admin\partials\_sidebar_pharmacy.blade.php ENDPATH**/ ?>