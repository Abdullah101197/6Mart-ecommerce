...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <form action="<?php echo e(env('APP_MODE')!='demo'?route('vendor.profile.update'):'javascript:'); ?>" method="post" enctype="multipart/form-data" id="vendor-settings-form">
                <?php echo csrf_field(); ?>
                <!-- Card -->
                    <div class="card mb-3 mb-lg-5" id="generalDiv">
                        ...
                        <label
                            ...
                            <img id="viewer"
                                 ...
                                 src="<?php echo e(\App\CentralLogics\Helpers::get_loggedin_user()?->image_full_url ?? asset('assets/admin/img/160x160/img1.jpg')); ?>"
                                 alt="Image">
                    ...
                    <div class="card mb-3 mb-lg-5">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-sm-down-break">
                                        <input type="text" class="form-control" name="f_name" id="firstNameLabel"
                                               ...
                                               value="<?php echo e(auth('vendor')->check()?auth('vendor')->user()->f_name:auth('vendor_employee')->user()->f_name); ?>">
                                        <input type="text" class="form-control" name="l_name" id="lastNameLabel"
                                               ...
                                               value="<?php echo e(auth('vendor')->check()?auth('vendor')->user()->l_name:auth('vendor_employee')->user()->l_name); ?>">
                                    </div>
                                </div>
                            </div>
                            <!-- End Form Group -->
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="js-masked-input form-control" name="phone" id="phoneLabel"
                                           ...
                                           value="<?php echo e(auth('vendor')->check()?auth('vendor')->user()->phone:auth('vendor_employee')->user()->phone); ?>"
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="email" class="form-control" name="email" id="newEmailLabel"
                                           value="<?php echo e(auth('vendor')->check()?auth('vendor')->user()->email:auth('vendor_employee')->user()->email); ?>"
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="button" data-id="vendor-settings-form" data-message="<?php echo e(translate('you_want_to_update_user_info')); ?>" class="btn btn-primary <?php echo e(env('APP_MODE')!='demo'?'form-alert':'call-demo'); ?>"><?php echo e(translate('messages.Save_changes')); ?></button>
                            </div>
                ...
                <div id="passwordDiv" class="card mb-3 mb-lg-5">
                    ...
                    <div class="card-body">
                        ...
                        <form id="changePasswordForm"
                            action="<?php echo e(env('APP_MODE') != 'demo' ? route('vendor.profile.settings-password') : 'javascript:'); ?>"
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="button" data-id="changePasswordForm"
                                    ...
                                    class="btn btn-primary <?php echo e(env('APP_MODE') != 'demo' ? 'form-alert' : 'call-demo'); ?>"><?php echo e(translate('messages.save')); ?></button>
                            </div>
                        </form>
                        <!-- End Form -->
                    </div>
...
<?php $__env->startPush('script_2'); ?>
    <script src="<?php echo e(asset('assets/admin')); ?>/js/view-pages/vendor/profile-index.js"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.vendor.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\vendor-views\profile\index.blade.php ENDPATH**/ ?>