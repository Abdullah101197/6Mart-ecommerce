<div class="row">
    <div class="col-lg-12 text-center "><h1 ><?php echo e(translate('messages.store_withdraw_transactions')); ?></h1></div>
    <div class="col-lg-12">
    ...
    <table>
        <thead>
            ...
            <tr>
                ...
                <th><?php echo e(translate('messages.owner_name')); ?></th>
        ...
        <?php $__currentLoopData = $data['withdraw_requests']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $wr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td>
                    <?php if($wr->vendor): ?>
                    <?php echo e($wr->vendor->stores[0]->name); ?>
                ...
                <td><?php echo e($wr->vendor->f_name); ?> <?php echo e($wr->vendor->l_name); ?></td>
                <td><?php echo e($wr->vendor->phone); ?></td>
                <td><?php echo e($wr->vendor->email); ?></td>
                <td><?php echo e($wr->vendor && $wr->vendor->account_no ? $wr->vendor->account_no : 'No Data found'); ?></td>
                <td>
...
<?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\file-exports\store-withdraw-transaction.blade.php ENDPATH**/ ?>