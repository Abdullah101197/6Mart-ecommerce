    ...
    <div class="card">
        <div class="card-header flex-wrap justify-content-between gap-3">
            ...
            <div class="d-flex flex-wrap align-items-center gap-2">
                ...
                <div class="w-16rem">
                    <select name="delivery_man_id" data-url="<?php echo e(url()->current()); ?>" data-filter="delivery_man_id"
                            data-placeholder="<?php echo e(translate('messages.select_delivery_man')); ?>"
                            class="js-select2-custom form-control set-filter">

                        <option value="all"><?php echo e(translate('messages.all_delivery_man')); ?></option>
                        <?php $__currentLoopData = \App\Models\DeliveryMan::where('type' ,'zone_wise')->where('earning' ,1)->active()->get(['id','f_name','l_name']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($dm['id']); ?>"
                                    <?php echo e(isset($delivery_man_id) && is_numeric($delivery_man_id) && ($delivery_man_id  == $dm['id']) ? 'selected' : ''); ?>>
        ...
        <div class="card-header border-0 py-2">
            <div class="search--button-wrapper">
                <h2 class="card-title">
                    <?php echo e(translate('Total_Disbursements')); ?> <span class="badge badge-soft-secondary ml-2" id="countItems"><?php echo e($disbursement_delivery_mans->total()); ?></span>
                </h2>
                <form class="search-form">
                    <!-- Search -->
                    <div class="input--group input-group input-group-merge input-group-flush">
                        <input class="form-control" value="<?php echo e(request()?->search  ?? null); ?>" placeholder="<?php echo e(translate('search_by_delivery_man_info')); ?>" name="search">
                ...
                <div class="hs-unfold ml-3">
                    ...
                    <div id="usersExportDropdown"
                        ...
                        <a id="export-excel" class="dropdown-item" href="<?php echo e(route('admin.transactions.dm-disbursement.export', ['id'=>$disbursement->id,'type'=>'excel',request()->getQueryString()])); ?>">
                        ...
                        <a id="export-csv" class="dropdown-item" href="<?php echo e(route('admin.transactions.dm-disbursement.export', ['id'=>$disbursement->id,'type'=>'csv',request()->getQueryString()])); ?>">
                        ...
                        <a id="export-pdf" class="dropdown-item" href="<?php echo e(route('admin.transactions.dm-disbursement.export', ['id'=>$disbursement->id,'type'=>'pdf',request()->getQueryString()])); ?>">
                            <img class="avatar avatar-xss avatar-4by3 mr-2" src="<?php echo e(asset('assets/admin')); ?>/svg/components/pdf.svg" alt="Image Description">
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-thead-bordered table-align-middle card-table">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $disbursement_delivery_mans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $dm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td>
                                    <label class="form-check form--check mb-14">
                                        <input type="checkbox" name="dm_ids[]" class="form-check-input rest-check" value="<?php echo e($dm->delivery_man_id); ?>">
                                    </label>
                                </td>
                                <td>
                                    <span class="font-weight-bold"><?php echo e($key+$disbursement_delivery_mans->firstItem()); ?></span>
                                </td>
                                <td>
                                    <a href="<?php echo e(route('admin.users.delivery-man.preview', $dm->delivery_man_id)); ?>"
                                       class="table-rest-info">
                                        <div class="info">
                                            <span class="d-block text-body">
                                                <?php echo e($dm->delivery_man->f_name.' '.$dm->delivery_man->l_name); ?>
                                ...
                                <td>
                                    <?php echo e(\App\CentralLogics\Helpers::format_currency($dm['disbursement_amount'])); ?>

                                </td>
                                <td>
                                    <div>
                                        <?php echo e($dm->withdraw_method?->method_name); ?>

                                    </div>
                                </td>
                                <td>
                                    <?php if($dm->status=='pending'): ?>
                                        <label class="badge badge-soft-primary"><?php echo e(translate('pending')); ?></label>
                                ...
                                <td>
                                    <div class="btn--container justify-content-center">
                                        <a class="btn btn-sm btn--primary btn-outline-primary action-btn" data-toggle="modal" data-target="#payment-info-<?php echo e($dm->id); ?>" title="View Details">
                                            <i class="tio-visible"></i>
                                        </a>
                                        <?php if($dm->status == 'completed'): ?>
                                            <a class="btn btn-sm btn--danger btn-outline-danger action-btn action-btn-section" href="<?php echo e(route('admin.transactions.dm-disbursement.change-status', ['id'=>$dm->id,'status'=>'pending'])); ?>" data-toggle="tooltip" title="<?php echo e(translate('revert')); ?>">
                                                <i class="tio-restore"></i>
                                            </a>
                                        <?php else: ?>
                                            <?php if($dm->status != 'canceled'): ?>
                                                <a class="btn btn-sm btn--danger btn-outline-danger action-btn action-btn-section" href="<?php echo e(route('admin.transactions.dm-disbursement.change-status', ['id'=>$dm->id,'status'=>'canceled'])); ?>" data-toggle="tooltip" title="<?php echo e(translate('cancel')); ?>">
                                                    <i class="tio-clear"></i>
                                                </a>
                                            <?php endif; ?>
                                            <a class="btn btn-sm btn--primary btn-outline-primary action-btn action-btn-section" href="<?php echo e(route('admin.transactions.dm-disbursement.change-status', ['id'=>$dm->id,'status'=>'completed'])); ?>" title="<?php echo e(translate('complete')); ?>" data-toggle="tooltip">
                                                <i class="tio-done"></i>
                                            </a>
                                        <?php endif; ?>
                                    </div>
                                </td>
                                <div class="modal fade" id="payment-info-<?php echo e($dm->id); ?>">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header pb-4">
                                                ...
                                                <div class="w-100 text-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <strong>#<?php echo e($dm->disbursement_id); ?></strong>
                                                    </div>
                                                    <div class="mt-2">
                                            ...
                                            <div class="modal-body">
                                                            ...
                                                            <div class="item">
                                                                ...
                                                                <ul class="item-list">
                                                                    <li class="d-flex flex-wrap">
                                                                        ...
                                                                        <span>:</span>
                                                                        <strong><?php echo e($dm->delivery_man->f_name.' '.$dm->delivery_man->l_name); ?></strong>
                                                                    </li>
                                                                    <li class="d-flex flex-wrap">
                                                                        <span class="name"><?php echo e(translate('contact')); ?></span>
                                                                        <span>:</span>
                                                                        <strong><?php echo e($dm?->delivery_man?->phone); ?></strong>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                            <div class="item">
                                                            ...
                                                            <div class="item w-100">
                                                                ...
                                                                <ul class="item-list">
                                                                    <li class="d-flex flex-wrap">
                                                                        ...
                                                                        <strong><?php echo e($dm->withdraw_method?->method_name); ?></strong>
                                                                    </li>
                                                                    <li class="d-flex flex-wrap">
                                                                        <span class="name"><?php echo e(translate('amount')); ?></span>
                                                                        <strong><?php echo e(\App\CentralLogics\Helpers::format_currency($dm['disbursement_amount'])); ?></strong>
                                                                    </li>
                                                                    <?php $__empty_1 = true; $__currentLoopData = json_decode($dm->withdraw_method?->method_fields, true) ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                                        <li class="d-flex flex-wrap">
                                                ...
                                                <div class="mt-3 btn--container justify-content-end">
                                                    <?php if($dm->status =='pending'): ?>
                                                        <a type="button" href="<?php echo e(route('admin.transactions.dm-disbursement.change-status', ['id'=>$dm->id,'status'=>'canceled'])); ?>" class="btn btn--reset" ><?php echo e(translate('cancel')); ?></a>
                                                    <?php endif; ?>
                                                    <?php if($dm->status != 'completed'): ?>
                                                        <a type="button" href="<?php echo e(route('admin.transactions.dm-disbursement.change-status', ['id'=>$dm->id,'status'=>'completed'])); ?>" class="btn btn--primary"><?php echo e(translate('complete')); ?></a>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div>
                ...
                <?php if(count($disbursement_delivery_mans) === 0): ?>
        ...
        <div class="page-area px-4 pb-3">
            <div class="d-flex align-items-center justify-content-end">
                <div>
                    <?php echo $disbursement_delivery_mans->links(); ?>
...
<?php $__env->startPush('script_2'); ?>
    <script>
        ...
        $(document).ready(function() {
            ...
            let delivery_man_ids = <?php echo e($dm_ids); ?>;
            ...
            $('#complete').on('click', function() {
                $.get({
                    url: '<?php echo e(route('admin.transactions.dm-disbursement.status')); ?>',
                    dataType: 'json',
                    data: {
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\dm-disbursement\view.blade.php ENDPATH**/ ?>