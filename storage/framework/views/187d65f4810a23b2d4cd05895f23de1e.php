...
<head>
    ...
    <title><?php echo e(translate('Subscription_Invoice')); ?></title>
        ...
        <div class="first content-position trx-invoice" style="width:732px;margin: 0 auto;">
                    ...
                    <tr>
                        <td style="padding:0;text-align:left">
                            ...
                            <div class="font-normal">
                                <span class="text-dark"><?php echo e(translate('Transaction ID')); ?></span> : #<?php echo e($transaction->id); ?>

                            </div>
                            <div class="font-normal">
                                <span class="text-dark"><?php echo e(translate('invoice_Date')); ?></span> : <?php echo e(App\CentralLogics\Helpers::date_format($transaction->created_at)); ?>

                            </div>
                        </td>
                        <td style="padding:0;text-align:right">
                            <img width="60" height="40"  alt="6amMart"
                            src="<?php echo e(\App\CentralLogics\Helpers::get_full_url('business',$logo?->value,$logo?->storage[0]?->value ?? 'public' )); ?>"
                ...
                <table class="border" style="border-radius:12px;">
                    <tr>
                        <td class="text-left" style="padding:21px 8px;">
                            <div class="fz-11"><?php echo e(translate('Store Owner')); ?></div>
                            <span class="text-dark fz-10"><?php echo e($transaction?->store?->vendor?->f_name. ' '.$transaction?->store?->vendor?->l_name); ?></span>
                        </td>
                        <td class="text-left" style="padding:21px 8px;">
                            <div class="fz-11"><?php echo e(translate('Phone')); ?></div>
                            <div class="font-medium fz-10 mb-2 text-capitalize">
                            <span class="text-dark"><?php echo e($transaction?->store?->vendor?->phone); ?></span></div>
                        </td>
                        <td class="text-left" style="padding:21px 8px;">
                            <div class="fz-11"><?php echo e(translate('Email')); ?></div>
                            <div class="font-medium fz-10 mb-2 text-capitalize">
                            <span class="text-dark"><?php echo e($transaction?->store?->vendor?->email); ?></span></div>
                        </td>
                        <td class="text-right" style="padding:21px 8px;">
                            <div class="mb-1 fz-10" style="white-space: nowrap">
                                <span class="text-dark"><?php echo e(translate('invoice_of')); ?></span> <span class="font-normal">(<?php echo e(App\CentralLogics\Helpers::currency_code()); ?>)</span>
                            </div>
                            <div class="text-right" style="font-size: 24px;font-weight:600;color:#039d55;white-space:nowrap;"><?php echo e(App\CentralLogics\Helpers::format_currency($transaction->paid_amount)); ?></div>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <table>
                                <tr>
                                    <td class="vertical-align-top" style="padding:8px 24px; width:30%">
                                        <div class="fz-11"><?php echo e(translate('payment')); ?></div>
                                        <div class="font-medium fz-10 mb-2 text-capitalize">
                                        <span class="text-dark"><?php echo e(translate($transaction->payment_method)); ?></span></div>
                                    </td>
                                    <td class="fz-10 border-left vertical-align-top" style="padding:8px 24px; width:34%">
                                        <div><?php echo e(translate('Purchased')); ?></div>
                                        <div class="font-bold fz-11"><?php echo e($transaction->package->package_name); ?></div>
                                    </td>
                                    <td class="fz-10 border-left vertical-align-top" style="padding:8px 24px; width:34%">
                                        <div><?php echo e(translate('Duration')); ?></div>
                                        <div class="font-bold fz-11"> <?php echo e($transaction->validity); ?> <?php echo e(translate('Days')); ?> </div>
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table class="table __subscribe-table table-borderless mt-3" style="color: rgb(105, 101, 101)">
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            <span><?php echo e(translate('Package Name')); ?></span>
                                        </th>
                                        <th>
                                            <span><?php echo e(translate('Transaction Time')); ?></span>
                                        </th>
                                        <th>
                                            <span><?php echo e(translate('Validity Time')); ?></span>
                                        </th>
                                        <th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="padding: 18px 10px;">
                                            <span><?php echo e($transaction->package->package_name); ?></span>
                                        </td>
                                        <td style="padding: 18px 10px;">
                                            <span><?php echo e(App\CentralLogics\Helpers::date_format($transaction->created_at)); ?></span>
                                        </td>
                                        <td style="padding: 18px 10px;">
                                            <span><?php echo e($transaction->validity); ?> <?php echo e(translate('Days')); ?></span>
                                        </td>
                                        <td style="padding: 18px 10px;">
                                            <span class="__txt-nowrap">
                                                <?php echo e(App\CentralLogics\Helpers::format_currency($transaction->paid_amount)); ?>
                    ...
                    <tr>
                        <td colspan="4" class="font-semibold fz-12 pt-0" style="text-align: center;padding-bottom: 14px">
                            <?php echo e(translate('Thanks for the Subscription')); ?>
            ...
            <table class="border-0 footer-table" style="text-align:center; background-color: rgba(16, 121, 128, 0.08)">
                <tr>
                    ...
                    <td style="padding: 10px">
                        <?php echo e($BusinessData['email_address']); ?>
...
<?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\subscription-invoice.blade.php ENDPATH**/ ?>