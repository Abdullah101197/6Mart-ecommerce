                ...
                <div class="flex-grow-1">
                    <div class="d-flex align-items-start">
                        ...
                        <div class="w-0 flex-grow pl-2">
                            <h1 class="page-header-title"><?php echo e(translate('Green Mart Subscription')); ?></h1>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-md-6">
                                    <label class="payment-item">
                                        ...
                                        <div class="payment-item-inner">
                                            ...
                                            <span>Bkash</span>
                                            <img class="ml-auto" src="<?php echo e(asset('/assets/admin/img/bkash1.png')); ?>" width="30" alt="">
                                        </div>
                                    </label>
                                </div>
                                <div class="col-md-6">
                                    <label class="payment-item">
                                        ...
                                        <div class="payment-item-inner">
                                            ...
                                            <img class="ml-auto" src="<?php echo e(asset('/assets/admin/img/marcado1.png')); ?>" width="30" alt="">
                                        </div>
                                    </label>
                                </div>
                                <div class="col-md-6">
                                    <label class="payment-item">
                                        ...
                                        <div class="payment-item-inner">
                                            ...
                                            <img class="ml-auto" src="<?php echo e(asset('/assets/admin/img/sslcomz1.png')); ?>" width="60" alt="">
                                        </div>
                                    </label>
                                </div>
                                <div class="col-md-6">
                                    <label class="payment-item">
                                        ...
                                        <div class="payment-item-inner">
                                            ...
                                            <span>PayStack</span>
                                            <img class="ml-auto" src="<?php echo e(asset('/assets/admin/img/paystack1.png')); ?>" width="30" alt="">
                                        </div>
                                    </label>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\subscription\subscription-in-store-details.blade.php ENDPATH**/ ?>