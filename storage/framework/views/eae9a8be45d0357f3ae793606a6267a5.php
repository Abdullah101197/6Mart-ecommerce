...
<?php $__env->startSection('content'); ?>
    <div class="content container-fluid">
        <!--- Admin Tax Report -->
        <h2 class="mb-20"><?php echo e(translate('messages.Generate Tax Report')); ?></h3>
            <div class="card p-20 mb-20">
                <div class="mb-20">
                    <h3 class="mb-1"><?php echo e(translate('messages.Admin Tax Report')); ?></h3>

                    <p class="mb-1 fz-12">
                        <?php echo e(translate('To generate you tax report please select & input following field and submit for the result')); ?>.
                    </p>
                ...
                <span id="info_for_item">
                    <?php echo e(translate('You will get combine tax report in combine. You can view')); ?>

                    <a href="<?php echo e(route('admin.transactions.rental.report.getTaxReport')); ?>"
                        class="font-semibold theme-clr text-decoration-underline"><?php echo e(translate('Tax Report for Rental Module')); ?>.</a>
                    <?php echo e(translate('Separately from here.')); ?>
                        ...
                        <div class="row g-lg-4 g-md-3 g-2">
                            <div class="col-md-6">
                                <div class="d-flex flex-column gap-lg-4 gap-3">
                                    <div>
                                        <span
                                            class="mb-2 d-block title-clr fw-normal"><?php echo e(translate('messages.Date Range Type')); ?></span>
                                        <select name="date_range_type" id="date_range_type"
                                            class="custom-select custom-select-color border rounded w-100">
                                            <option value=""><?php echo e(translate('Select Date Range')); ?></option>
                                            <option value="this_fiscal_year"
                                                <?php echo e($date_range_type == 'this_fiscal_year' ? 'selected' : ''); ?>>
                                                <?php echo e(translate('This Fiscal Year')); ?>

                                            </option>
                                            <option value="custom" <?php echo e($date_range_type == 'custom' ? 'selected' : ''); ?>>
                                                <?php echo e(translate('Custom')); ?>

                                            </option>

                                        </select>
                                    </div>
                                    <div class="<?php echo e($date_range_type == 'custom' ? '' : 'd-none'); ?>" id="date_range">
                                        ...
                                        <div class="position-relative">
                                            ...
                                            <input type="text" class="form-control h-45 position-relative bg-transparent"
                                                name="dates" placeholder="<?php echo e(translate('messages.Select_Date')); ?>">
                                        </div>
                                    </div>

                                    <div>
                                        <span
                                            class="mb-2 d-block title-clr fw-normal"><?php echo e(translate('Select How to calculate tax')); ?></span>
                                        <select name="calculate_tax_on" id="calculate_tax_on" required
                                            class="custom-select custom-select-color border rounded w-100">
                                            <option disabled selected value="">
                                                <?php echo e(translate('Select Calculate Tax')); ?></option>
                                            <option <?php echo e($calculate_tax_on == 'all_source' ? 'selected' : ''); ?>

                                                value="all_source">
                                                <?php echo e(translate('messages.Same Tax for All Income Source')); ?>

                                            </option>
                                            <option <?php echo e($calculate_tax_on == 'individual_source' ? 'selected' : ''); ?>

                                                value="individual_source">
                                                <?php echo e(translate('Different Tax for Different Income Source')); ?>

                                            </option>

                                        </select>
                                    </div>
                                    <div class="<?php echo e($calculate_tax_on == 'individual_source' ? '' : 'd-none'); ?>"
                                        id="calculate_commission_tax">
                                        <span
                                            class="mb-2 d-block title-clr fw-normal"><?php echo e(translate('Tax on Order Commission')); ?></span>
                                    ...
                                    <div class="<?php echo e($calculate_tax_on == 'individual_source' ? '' : 'd-none'); ?>"
                                        ...
                                        <span
                                            class="mb-2 d-block title-clr fw-normal"><?php echo e(translate('Tax on Delivery Charge Commission')); ?></span>
                                        <div class="select-class-closest">
                            ...
                            <div class="col-md-6">
                                <div class="d-flex flex-column gap-lg-4 gap-3">
                                    <div class="<?php echo e($calculate_tax_on == 'individual_source' ? '' : 'd-none'); ?>"
                                        ...
                                        <span
                                            class="mb-2 d-block title-clr fw-normal"><?php echo e(translate('Tax on Service charge')); ?></span>
                                        <div class="select-class-closest">
                                ...
                                <div class="d-flex flex-column gap-lg-4 gap-3 mt-3">
                                    <div class="<?php echo e($calculate_tax_on == 'individual_source' ? '' : 'd-none'); ?>"
                                        ...
                                        <span
                                            class="mb-2 d-block title-clr fw-normal"><?php echo e(translate('Tax on Subscription')); ?></span>
                                        <div class="select-class-closest">
                                ...
                                <div class="d-flex flex-column gap-lg-4 gap-3">
                                    <div class="<?php echo e($calculate_tax_on == 'individual_source' ? 'd-none' : ''); ?>"
                                        ...
                                        <span
                                            class="mb-2 d-block title-clr fw-normal"><?php echo e(translate('Select Tax Rates')); ?></span>
                                        <div class="select-class-closest">
                                            <select <?php echo e($calculate_tax_on == 'individual_source' ? '' : 'required'); ?>
                ...
                <div class="d-flex align-items-center justify-content-end gap-2">
                    <button type="reset" id="reset_button_id"
                        class="btn bg--secondary h--42px title-clr px-4"><?php echo e(translate('Reset')); ?></button>
                    ...
                    <div class="col-md-6">
                        <div class="bg-opacity-primary-10 rounded p-20 d-flex align-items-center gap-2 flex-wrap">
                            ...
                            <h3 class="theme-clr fw-bold mb-0">
                                <?php echo e(\App\CentralLogics\Helpers::format_currency($totalBase)); ?> </h3>
                        </div>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="card p-20 mb-20">
                <div class="d-flex align-items-center justify-content-between gap-2 flex-wrap mb-20">
                    <h4 class="mb-0"><?php echo e(translate('Tax Report List')); ?></h4>
                        ...
                        <div class="hs-unfold mr-2">
                            ...
                            <div id="usersExportDropdown__admin"
                                ...
                                <a id="export-excel" class="dropdown-item"
                                    href="<?php echo e(route('admin.transactions.report.adminTaxReportExport', ['export_type' => 'excel', request()->getQueryString()])); ?>">
                                ...
                                <a id="export-csv" class="dropdown-item"
                                    href="<?php echo e(route('admin.transactions.report.adminTaxReportExport', ['export_type' => 'csv', request()->getQueryString()])); ?>">
                                    <img class="avatar avatar-xss avatar-4by3 mr-2"
                    ...
                    <table id="datatable"
                        ...
                        <tbody>
                            <?php
                                $count = 1;
                            ?>
                            <?php $__empty_1 = true; $__currentLoopData = $combinedResults; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td>
                                        <?php echo e($count++); ?>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex gap-2 justify-content-center">
                                            <a class="btn btn-sm theme-border action-btn theme-hover theme-clr"
                                                target="_blank"
                                                href="<?php echo e(route('admin.transactions.report.getTaxDetails', ['source' => $key, request()->getQueryString()])); ?>">
                                ...
                                <tr>
                                    <td colspan="5" class="py-5">
                                        <div class="text-center max-w-700 mx-auto py-5">
                                            <img src="<?php echo e(asset('/assets/admin/img/tax-error.png')); ?>"
                                                alt="img" class="mb-20">
                                            <h4 class="mb-2"><?php echo e(translate('No Tax Report Generated')); ?></h4>
                                            <p class="mb-0 fz-12px">
                                                <?php echo e(translate('To generate your tax report please select & input above field and submit for the result')); ?>
...
<?php $__env->startPush('script_2'); ?>
    <script>
        ...
        $(document).on('ready', function() {
            const selectedTax = <?php echo json_encode($selectedTax, 15, 512) ?>;
            Object.entries(selectedTax).forEach(([key, taxArray]) => {
                ...
                setTimeout(function() {
                    $select.select2({
                        ...
                        ajax: {
                            url: '<?php echo e(route('admin.transactions.report.getTaxList')); ?>',
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\report\tax-report\admin-tax-report.blade.php ENDPATH**/ ?>