                    ...
                    <th style="width: 100%;">
                        ...
                        <div style="display:inline-block;">
                            <a href="<?php echo e($item->link); ?>" target=”_blank”>
                                <img src="<?php echo e(asset('assets/landing/img/footer/'. $item->name.'.svg')); ?>"  style="height: 14px; width:14px; padding: 0px 3px 0px 5px;" alt="">
                            </a>
                        </div>
...
<?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\email-templates\customer-message.blade.php ENDPATH**/ ?>