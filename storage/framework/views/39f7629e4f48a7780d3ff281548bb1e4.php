                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                <?php echo e(translate('Send_Mail_on_New_Deliveryman_Rejection?')); ?>

                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('If_Admin_rejects_a_Deliveryman’s_self-registration,_the_Deliveryman_will_get_an_automatic_rejection_mail.')); ?>">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-title-on="<?php echo e(translate('Want_to_enable_Delivery_Man_deny_mail?')); ?>"
                                       data-title-off="<?php echo e(translate('Want_to_disable_Delivery_Man_deny_mail?')); ?>"
                                       data-text-on="<p><?php echo e(translate('If_enabled,_Delivery_Men_will_receive_an_email_when_the_admin_rejects_their_registration_request.')); ?></p>"
                                       data-text-off="<p><?php echo e(translate('If_disabled,_Delivery_Men_will_not_receive_any_email_upon_rejection_for_registration.')); ?></p>"
                        ...
                        <form action="<?php echo e(route('admin.business-settings.email-status',['dm','deny',$mail_status == '1'?0:1])); ?>" method="get" id="mail-status_form">
                        </form>
                    </div>
                </div>
                <?php ($data=\App\Models\EmailTemplate::where('type','dm')->where('email_type', 'deny')->first()); ?>
                <?php ($template= $template ?? $data?->email_template ?? 5); ?>
                <form action="<?php echo e(route('admin.business-settings.email-setup', ['dm','deny'])); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\business-settings\email-format-setting\dm-email-formats\deny-format.blade.php ENDPATH**/ ?>