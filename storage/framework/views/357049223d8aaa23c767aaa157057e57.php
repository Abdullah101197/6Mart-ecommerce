    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                    ...
                    <div class="card-body">
                        <div class="maintainance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                <?php echo e(translate('Send_Mail_on_Advertisement_Approval')); ?>

                                <span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('stores_will_receive_an_approval_mail_for_advertisement.')); ?>">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                ...
                                data-title-on="<?php echo e(translate('Want_to_enable_advertisement_approval_mail?')); ?>"
                                data-title-off="<?php echo e(translate('Want_to_disable_advertisement_approval_mail?')); ?>"
                                data-text-on="<p><?php echo e(translate('If_enabled,_stores_will_receive_an_approval_mail_for_advertisement.')); ?></p>"
                                data-text-off="<p><?php echo e(translate('If_disabled,stores_won\'t_receive_an_approval_mail_for_advertisement.')); ?></p>"
                        ...
                        <form action="<?php echo e(route('admin.business-settings.email-status',['store','advertisement-approved',$mail_status == '1'?0:1])); ?>" method="get" id="mail-status_form">
                        </form>
                    </div>
                </div>
                ...
                <form action="<?php echo e(route('admin.business-settings.email-setup', ['store','advertisement-approved'])); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\business-settings\email-format-setting\store-email-formats\advertisement-approved-format.blade.php ENDPATH**/ ?>