                ...
                <div class="single-item-slider owl-carousel">
                    <div class="item">
                        ...
                        <div class="modal-body">
                            <div class="how-it-works">
                                <div class="item">
                                    <img src="<?php echo e(asset('/assets/admin/img/how/how1.png')); ?>" class="h-60px object-contain object-left" alt="">
                                ...
                                <div class="item">
                                    <img src="<?php echo e(asset('/assets/admin/img/how/how2.png')); ?>" class="h-60px object-contain object-left" alt="">
                                ...
                                <div class="item mw-100">
                                    <img src="<?php echo e(asset('/assets/admin/img/how/how3.png')); ?>" class="h-60px object-contain object-left" alt="">
                    ...
                    <div class="item">
                        <div class="modal-body py-0">
                            ...
                            <img src="<?php echo e(asset('/assets/admin/img/zone-settings-popup-arro.gif')); ?>" alt="admin/img" class="w-100 h-unset">
                        </div>
                    </div>
                    <div class="item px-xl-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="col-sm-8">
                                <img src="<?php echo e(asset('/assets/admin/img/module2.png')); ?>" alt="admin/img" class="w-100 h-unset">
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\module\index.blade.php ENDPATH**/ ?>