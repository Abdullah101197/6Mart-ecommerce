...
<?php $__env->startSection('title',translate('messages.shipping_policy')); ?>
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header d-flex flex-wrap justify-content-between">
            <h1 class="d-flex flex-wrap justify-content-between page-header-title">
                <span class="page-header-icon">
                    ...
                    <?php echo e(translate('messages.Shipping Policy')); ?>
            ...
            <h5 class="d-flex flex-wrap justify-content-end">
                <label class="switch--custom-label toggle-switch toggle-switch-sm d-inline-flex">
                    ...
                    <?php echo e($shipping_policy_status?->value == 1?'checked':''); ?>
        ...
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="<?php echo e(route('admin.business-settings.shipping-policy')); ?>" method="post" id="tnc-form">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group lang_form" id="default-form">
                        ...
                        <textarea class="ckeditor form-control" name="shipping_policy[]"><?php echo $shipping_policy?->getRawOriginal('value') ?? ''; ?></textarea>
                    </div>
                    ...
                    <?php if($language): ?>
                        <?php $__empty_1 = true; $__currentLoopData = json_decode($language); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <div class="form-group d-none lang_form" id="<?php echo e($lang); ?>-form">
                                <textarea class="ckeditor form-control" name="shipping_policy[]"><?php echo $translate[$lang]['shipping_policy'] ?? null; ?></textarea>
                            </div>
...
<?php $__env->startPush('script_2'); ?>
    ...
    $(document).ready(function () {
            ...
            $.ajax({
                url: '<?php echo e(url('admin/business-settings/pages/shipping-policy')); ?>/'+status,
                method: 'get',
                success: function() {
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\business-settings\shipping_policy.blade.php ENDPATH**/ ?>