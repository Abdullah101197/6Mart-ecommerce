                            ...
                            <div class="mb-4">
                                <div class="row g-2 justify-content-around">
                                    <div class="col-sm-6 col-12">
                                        <select name="store_id" id="store_select" data-url="<?php echo e(url()->full()); ?>"
                                            data-filter="store_id" data-placeholder="<?php echo e(translate('messages.select_store')); ?>"
                                    ...
                                    <div class="col-sm-6 col-12">
                                        <select name="category" id="category"
                                            ...
                                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($item->id); ?>" <?php echo e($category == $item->id ? 'selected' : ''); ?>>
                                    ...
                                    <div class="col-sm-12 col-12">
                                        <form id="search-form" class="search-form">
                                            ...
                                            <div class="position-relative">
                                                <input id="datatableSearch" type="search" value="<?php echo e($search ?? ''); ?>"
                                                    name="search" class="form-control h--45px pl-5"
                                                    placeholder="<?php echo e(translate('messages.Search_by_product_name')); ?>"
                                                    aria-label="<?php echo e(translate('messages.search_here')); ?>" disabled>
                                                <img width="16" height="16"
                                                    src="<?php echo e(asset('assets/admin/img/icons/search-icon.png')); ?>" alt=""
                                                    class="search-icon">
                            ...
                            <div class="d-flex flex-wrap p-3 add--customer-btn">
                                <select id="customer" name="customer_id"
                                    ...
                                    <?php if(isset($customer)): ?>
                                        <option selected value="<?php echo e($customer->id); ?>">
                                            <?php echo e($customer->f_name . ' ' . $customer->l_name); ?> (<?php echo e($customer->phone); ?>)</option>
                                    <?php endif; ?>
                                </select>
                                        ...
                                        <div class="media align-items-center customer--information-single"
                                            ...
                                            <div class="avatar avatar-circle">
                                                <img class="avatar-img onerror-image" id=customer_image
                                                    src="<?php echo e(isset($customer) ? $customer->image_full_url : ''); ?>"
                                                ...
                                                <ul class="list-unstyled m-0">
                                                    <li class="pb-1">
                                                        <h4> <span id="customer_name"
                                                                class="text--primary"><?php echo e(isset($customer) ? $customer->f_name . ' ' . $customer->l_name : ''); ?></span>,
                                                            <small
                                                                id="customer_phone"><?php echo e(isset($customer) ? $customer->phone : ''); ?></small>
                                                        </h4>
                                                    </li>
                                                    <li>
                                                        <?php echo e(translate('messages.Wallet')); ?> : <strong class="text-dark"
                                                            id="customer_wallet"><?php echo e(isset($customer) ? \App\CentralLogics\Helpers::format_currency($customer->wallet_balance) : ''); ?></strong>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <div class="pos--delivery-options">
                                <div class="d-flex justify-content-between mb-2">
                                    <h5 class="card-title d-flex align-items-center gap-2">
                                        ...
                                        <span><?php echo e(translate('Delivery Information')); ?>

                                            <small>(<?php echo e(translate('Home Delivery')); ?>)</small></span>
                                    </h5>
                                ...
                                <div class="pos--delivery-options-info d-flex flex-wrap" id="del-add">
                                    <?php echo $__env->make('admin-views.pos._address', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                </div>
                            </div>
                            <div class='w-100' id="cart">
                                <?php echo $__env->make('admin-views.pos._cart', ['store' => $store], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="text-center">
                            ...
                            <a href="<?php echo e(url()->previous()); ?>"
                                class="btn btn-danger non-printable"><?php echo e(translate('messages.back')); ?></a>
                        </div>
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input id="f_name" type="text" name="f_name" class="form-control"
                                        value="<?php echo e(old('f_name')); ?>" placeholder="<?php echo e(translate('first_name')); ?>" required>
                                </div>
                            </div>
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input id="l_name" type="text" name="l_name" class="form-control"
                                        value="<?php echo e(old('l_name')); ?>" placeholder="<?php echo e(translate('last_name')); ?>" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input id="email" type="email" name="email" class="form-control"
                                        value="<?php echo e(old('email')); ?>" placeholder="<?php echo e(translate('Ex_:_ex@example.com')); ?>"
                                        required>
                                </div>
                            </div>
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input id="phone" type="tel" name="phone" class="form-control"
                                        value="<?php echo e(old('phone')); ?>" placeholder="<?php echo e(translate('phone')); ?>" required>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\pos\index.blade.php ENDPATH**/ ?>