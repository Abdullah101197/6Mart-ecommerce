                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card_earning-box theme-bg-opacity10 rounded-10 h-100">
                        <div class="box d-flex align-items-center">
                            ...
                            <div>
                                <h3 class="text-006AB4 mb-1 fs-26"><?php echo e(translate('messages.1,000')); ?></h3>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card_earning-box card--bg-3 rounded-10 h-100">
                        <div class="box d-flex align-items-center">
                            ...
                            <div>
                                <h3 class="text-00AA6D mb-1 fs-26"><?php echo e(translate('messages.2,000')); ?></h3>
                                <p class="text-dark fs-14 mb-0"><?php echo e(translate('messages.2,000')); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4">
                    <div class="card_earning-box color-card color-4 rounded-10 h-100">
                        <div class="box d-flex align-items-center">
                            ...
                            <div>
                                <h3 class="title mb-1 fs-26"><?php echo e(translate('messages.200')); ?></h3>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\test\deliveryman-details\loyalty-point.blade.php ENDPATH**/ ?>