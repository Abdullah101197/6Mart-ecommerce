...
<?php $__env->startSection('content'); ?>
    <div class="content container-fluid">
        ...
        <div class="page-header">
            ...
            <?php echo $__env->make('admin-views.business-settings.email-format-setting.partials.dm-email-template-setting-links', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                    ...
                    <div class="card-body">
                        <div class="maintainance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                <?php echo e(translate('Send_Mail_On_Deliveryman’s_Account_Unsuspension')); ?>

                                <span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('If_a_Store_or_Admin_unsuspends_a_Deliveryman’s_account,_he_or_she_will_receive_an_automated_email.')); ?>">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                ...
                                data-title-on="<?php echo e(translate('Want_to_enable_Suspend_mail?')); ?>"
                                data-title-off="<?php echo e(translate('Want_to_disable_Suspend_mail?')); ?>"
                                data-text-on="<p><?php echo e(translate('If_enabled,_deliverymen_will_receive_an_email_for_account_unsuspension')); ?></p>"
                                data-text-off="<p><?php echo e(translate('If_disabled,_deliverymen_will_not_receive_an_email_for_account_unsuspension.')); ?></p>"
                        ...
                        <form action="<?php echo e(route('admin.business-settings.email-status',['dm','unsuspend',$mail_status == '1'?0:1])); ?>" method="get" id="mail-status_form">
                        </form>
                    </div>
                </div>
                ...
                <form action="<?php echo e(route('admin.business-settings.email-setup', ['dm','unsuspend'])); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\business-settings\email-format-setting\dm-email-formats\unsuspend-format.blade.php ENDPATH**/ ?>