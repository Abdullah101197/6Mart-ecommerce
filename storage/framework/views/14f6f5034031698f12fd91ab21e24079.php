                                ...
                                <div class="flex-grow-1 mx-auto pb-2 flex-shrink-0">
                                    ...
                                    <label class="d-inline-block m-0 position-relative error-wrapper">
                                        <img class="img--176 border" id="viewer"
                                            src="<?php echo e(asset('assets/admin/img/upload-img.png')); ?>" alt="thumbnail" />
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\product\index_backup.blade.php ENDPATH**/ ?>