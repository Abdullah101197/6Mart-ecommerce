<?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
    <tr class="" id="row-<?php echo e($item->id); ?>" data-id="<?php echo e($item->id); ?>" data-cost="<?php echo e($item->cost_price); ?>">
        ...
        <td>
            <div class="prod-cell">
                <div class="prod-img">
                    <img src="<?php echo e($item['image_full_url'] ?? asset('public/assets/admin/img/160x160/img2.jpg')); ?>"
                        onerror="this.src='<?php echo e(asset('public/assets/admin/img/160x160/img2.jpg')); ?>'" alt="">
                </div>
                <div>
    ...
    <tr>
        <td colspan="10" class="text-center p-5">
            <div class="empty-state">
                <img src="<?php echo e(asset('public/assets/admin/img/900x400/img1.jpg')); ?>"
...
<?php endif; ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views/admin-views/product/partials/_gallery.blade.php ENDPATH**/ ?>