                                ...
                                <div class="row h-100">
                                    <div class="col-sm-6 mb-4 mb-sm-0">
                                        <div class="form-group m-0 h-100 d-flex align-items-center flex-column justify-content-center pb-lg-2">
                                            ...
                                            <label class="text-center my-auto position-relative">
                                                <img class="img--176 h-unset aspect-ratio-1 image--border" id="viewer" src="<?php echo e(asset('assets/admin/img/upload-img.png')); ?>" alt="image" />
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group m-0 h-100 d-flex flex-column justify-content-center align-items-center pb-lg-2">
                                            ...
                                            <label class="text-center my-auto position-relative">
                                                <img class="img--176 h-unset aspect-ratio-1 image--border" id="viewer2" src="<?php echo e(asset('assets/admin/img/upload-img.png')); ?>" alt="image" />
                                                <div class="icon-file-group">
                                                    <div class="icon-file">
...
<?php $__env->startPush('script_2'); ?>
    ...
    $(document).ready(function () {
        ...
        $('#reset_btn').click(function(){
            ...
            $('#viewer2').attr('src','<?php echo e(asset('assets/admin/img/400x400/img2.jpg')); ?>');
        })
</script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\module\create.blade.php ENDPATH**/ ?>