    ...
    <div class="card">
        <div class="card-body">
            <div class="mb-4">
                ...
                <p class="mb-0 fs-12 gray-dark"><?php echo e(translate('Upload an image that represents your brand and makes users want to order immediately.')); ?></p>
            </div>
            <div class="row g-3">
                <div class="col-12">
                    <div class="bg--secondary h-100 rounded p-md-4 p-3">
                        <div class="text-center py-2">
                            ...
                            <p class="fs-10 text-center mb-0 mt-lg-4 mt-3">
                                <?php echo e(translate('JPG, JPEG, PNG, Gif Image size : Max 5 MB')); ?> <span class="font-medium text-title"><?php echo e(translate('(8:1)')); ?></span>
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                <div class="banner-thumb w-100 h-100 rounded-10">
                                    <img height="80" src="<?php echo e(asset('/assets/admin/img/400x400/react-landing-banner.png')); ?>" alt="" class="rounded-10">
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\6MartAdminpanel\resources\views\admin-views\test\React_Landing\banners-section.blade.php ENDPATH**/ ?>